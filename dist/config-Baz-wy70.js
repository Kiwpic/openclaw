...
import { i as repairCurrentTokenStorageMetaDeviceId } from "./storage-Bm5HpICi.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Bap54Dct.js"), import("./logging-DWNX8YwE.js")]).then(([sdkModule, loggingModule]) => ({
