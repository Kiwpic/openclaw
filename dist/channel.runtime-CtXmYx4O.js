...
import "./runtime-api-Dnhb7RSq.js";
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-DDVT_S_m.js";
import { t as getTlonRuntime } from "./runtime-ln2gtCac.js";
import { t as tlonSetupWizard } from "./setup-surface-BhL1PUPQ.js";
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-DLGBK7Wq.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-YPLStAIT.js").then((m) => /* @__PURE__ */ __toESM(m.default));
		...
		async (awsIdentityProperties) => {
			...
			const { fromTokenFile } = await import("./dist-cjs-KAyCX1-6.js").then((m) => /* @__PURE__ */ __toESM(m.default));
