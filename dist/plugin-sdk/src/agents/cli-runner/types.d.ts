...
import type { CurrentInboundPromptContext, EmbeddedRunTrigger } from "../embedded-agent-runner/run/params.js";
...
export type CliReusableSession = {
    sessionId?: string;
    invalidatedReason?: "auth-profile" | "auth-epoch" | "system-prompt" | "cwd" | "mcp" | "missing-transcript" | "orphaned-tool-use";
};
