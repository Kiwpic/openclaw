...
function createLazyCanvasTool(params) {
	...
	const loadTool = async () => {
		toolPromise ??= import("../../tool-X3B8IU4M.js").then(({ createCanvasTool }) => createCanvasTool({
...
var canvas_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerNodeCliFeature(async ({ program }) => {
			const { createDefaultCanvasCliDependencies, registerNodesCanvasCommands } = await import("../../cli-B1hdPhwo.js");
