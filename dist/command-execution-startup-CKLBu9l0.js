...
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-B0Wok78U.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DX0F1Xlo.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CH_qFUcG.js");
	if (params.argv) {
