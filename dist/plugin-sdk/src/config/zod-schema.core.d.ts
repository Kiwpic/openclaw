...
export declare const SecretProviderSchema: z.ZodUnion<readonly [z.ZodObject<{
    source: z.ZodLiteral<"env">;
...
export declare const MentionPatternsModeSchema: z.ZodUnion<readonly [z.ZodLiteral<"allow">, z.ZodLiteral<"deny">]>;
export declare const MentionPatternsPolicySchema: z.ZodObject<{
