...
import { r as collectUnregisteredConfiguredMemoryEmbeddingProviders } from "./gateway-startup-plugin-ids-D-0_PGuU.js";
...
import { j as listRegisteredEmbeddingProviders } from "./registry-grOnBAqi.js";
import { I as createEmptyPluginRegistry, S as setActivePluginRegistry, o as getActivePluginRegistry } from "./runtime-Dew8HF52.js";
import "./channel-plugin-ids-Du4dMbT9.js";
import { n as loadPluginLookUpTable } from "./plugin-lookup-table-lqQ-41AO.js";
import { l as initSubagentRegistry } from "./subagent-registry-Qzmg2mta.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-PoWtuq-v.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-gNKKCkcA.js");
