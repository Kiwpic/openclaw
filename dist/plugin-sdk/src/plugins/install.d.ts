...
export declare const PLUGIN_INSTALL_ERROR_CODE: {
    ...
    readonly INVALID_PLUGIN_API: "invalid_plugin_api";
    ...
    readonly UNSUPPORTED_PLAIN_FILE_PLUGIN: "unsupported_plain_file_plugin";
};
...
type PluginInstallFailureResult = Extract<InstallPluginResult, {
    ok: false;
}>;
...
export declare function preflightPluginPackageInstallSource(params: {
    packageDir: string;
} & PackageInstallCommonParams): Promise<PluginInstallFailureResult | null>;
