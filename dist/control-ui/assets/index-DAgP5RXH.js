const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./agents-DXW5I9Hu.js","./string-coerce-Dt6Kt5Fx.js","./lit-runtime-BImxIzGR.js","./markdown-runtime-CUzFp-dW.js","./rolldown-runtime-QTnfLwEv.js","./channel-config-extras-MkoBBgM9.js","./skills-shared-CNlkuf6o.js","./activity-DVLaIW6l.js","./channels-B_8sFhoG.js","./cron-BwStiiMe.js","./debug-Di5v5M3S.js","./instances-Xv4bijbt.js","./logs-DIj0cuot.js","./nodes-0GW7Mus7.js","./sessions-C5N2RB5S.js","./skill-workshop-BJBD-vYF.js","./skills-BdpjqgIi.js","./usage-DrSXS5uy.js","./workboard-B6Wkq2cc.js"])))=>i.map(i=>d[i]);
...
...(truncated)...`))),D=C&&!n.isStreaming?zN(C):null,ie=o===`tool`||s,ae=[`chat-bubble`,ie?`chat-bubble--tool-shell`:``,te?`has-copy`:``,te&&!ie?`chat-bubble--has-actions`:``,n.isStreaming?`streaming`:``,`fade-in`].filter(Boolean).join(` `),oe=u&&(n.showToolCalls??!0);if(!C&&!oe&&!h&&v.length===0&&y.length===0&&!g.replyTarget)return d;let se=`toolmsg:${t}`,ce=n.isToolMessageExpanded?.(se)??!1,O=[...new Set(l.map(e=>e.name))],le=l.length===1?l[0]:null,ue=l.some(Zk),k=le?Ik({name:le.name,args:le.args,detailMode:`explain`}):null,de=!ue&&le&&k?vA(le,k.detail):void 0,fe=nA(ue?k?k.label:O.length<=3?O.join(`, `):`${O.slice(0,2).join(`, `)} +${O.length-2} more`:de?le?.outputText?.trim()?`output`:void 0:O.length<=3?O.join(`, `):`${O.slice(0,2).join(`, `)} +${O.length-2} more`),pe=C&&!fe?rA(C)??``:``,me=ue?`Tool error`:de&&!C&&!h?de:k&&!C&&!h?k.label:`Tool output`,he=nA(me)??me,ge=k?q[k.icon]:q.zap,_e=Math.max(1,Math.floor(n.duplicateCount??1));return c`
      ...
      ${ie?c`
          ...
          `:c`
            ...
            ${D?c`<details class="chat-json-collapse">
                  <summary class="chat-json-summary">
                    <span class="chat-json-badge">JSON</span>
                    <span class="chat-json-label">${BN(D.parsed)}</span>
                  </summary>
                  <pre class="chat-json-content"><code>${D.pretty}</code></pre>
                </details>`:C?UN(C,n.isStreaming,ee):d}
  ...
  `}function PP(e){let t=e.realtimeTalkOptions,n=e.onRealtimeTalkOptionsChange;if(!e.realtimeTalkOptionsOpen||!t||!n)return d;let r=e=>t=>{let r=t.currentTarget.value;n({[e]:r})},i=t.vadThreshold===``,a=[`0.65`,`0.5`,`0.35`].includes(t.vadThreshold),o=!i&&!a,s=i?``:a?t.vadThreshold:`__custom`,l=o?[...wP,{label:`Custom`,value:`__custom`}]:wP,u=l.find(e=>e.value===s)?.label??`Custom`;return c`
    <div class="agent-chat__talk-options" aria-label="Talk options">
      <div class="agent-chat__talk-options-primary">
        ${NP({label:`Voice`,value:t.voice,options:CP,onSelect:e=>n({voice:e})})}
        ...
        ${NP({label:`Sensitivity`,value:s,options:l,selectedLabel:u,onSelect:e=>{e!==`__custom`&&n({vadThreshold:e})}})}
      </div>
      <details class="agent-chat__talk-options-advanced">
        <summary>Advanced</summary>
        <div class="agent-chat__talk-options-grid">
          ${NP({label:`Provider`,value:t.provider,options:TP,onSelect:e=>n({provider:e})})}
          ${NP({label:`Transport`,value:t.transport,options:EP,onSelect:e=>n({transport:e})})}
          ${NP({label:`Reasoning`,value:t.reasoningEffort,options:DP,onSelect:e=>n({reasoningEffort:e})})}
          <label class="agent-chat__talk-field">
            <span>Exact VAD</span>
            <input
              type="number"
  ...
  `}function FP(e){let n=e.realtimeTalkConversation??[];return n.length===0?d:c`
  ...
  `}function IP(){return{slashMenuOpen:!1,slashMenuItems:[],slashMenuIndex:0,slashMenuMode:`command`,slashMenuCommand:null,slashMenuArgItems:[],slashMenuExpanded:!1,slashCommandRefreshPending:!1,searchOpen:!1,searchQuery:``,pinnedExpanded:!1,historyRenderSessionKey:null,historyRenderMessagesRef:null,historyRenderMessageCount:0,historyRenderLimit:0,historyRenderLastScrollTop:null,historyRenderExpansionFrame:null,historyRenderAnchorAdjustment:null,historyRenderAnchorFrame:null}}var X=IP(),LP=new Map,RP=new Map;function zP(e){return`${e.currentAgentId}\u0000${e.sessionKey}`}function BP(e){let t=YN(RP,zP(e),()=>({hostDraft:e.draft,value:e.draft}));return t.hostDraft!==e.draft&&(t.hostDraft=e.draft,t.value=e.draft),t}function VP(e,t){let n=BP(e);n.value=t,n.hostDraft!==t&&(n.hostDraft=t,e.onDraftChange(t))}function HP(e,t){return e.sessionKey===t.sessionKey&&e.messages===t.messages&&e.toolMessages===t.toolMessages&&e.streamSegments===t.streamSegments&&e.stream===t.stream&&e.streamStartedAt===t.streamStartedAt&&e.queue===t.queue&&e.showToolCalls===t.showToolCalls&&e.searchOpen===t.searchOpen&&e.searchQuery===t.searchQuery&&e.historyRenderLimit===t.historyRenderLimit}function UP(e){let t=YN(LP,e.sessionKey,()=>({input:null,items:[]}));if(t.input&&HP(t.input,e))return t.items;let n=qA(e);return t.input=e,t.items=n,n}function WP(e,t){let n=t.map(e=>e.key).filter(t=>e.has(t)).toSorted();return n.length===0?``:n.join(`\0`)}function GP(e){return e.size===0?``:Array.from(e).toSorted(([e],[t])=>e.localeCompare(t)).map(([e,t])=>`${e}:${t?`1`:`0`}`).join(`\0`)}function KP(){X.historyRenderExpansionFrame!=null&&cancelAnimationFrame(X.historyRenderExpansionFrame),X.historyRenderAnchorFrame!=null&&cancelAnimationFrame(X.historyRenderAnchorFrame),Object.assign(X,IP()),LP.clear(),RP.clear()}function qP(e){return Math.min(Math.max(0,e),100)}function JP(e){return e<=OP||X.searchOpen&&X.searchQuery.trim().length>0}function YP(e){let t=Array.isArray(e.messages)?e.messages:[],n=qP(t.length),r=X.historyRenderSessionKey!==e.sessionKey,i=X.historyRenderMessagesRef!==t,a=X.historyRenderMessageCount;if((r||i&&a===0)&&(X.historyRenderLastScrollTop=null),n===0)return X.historyRenderSessionKey=e.sessionKey,X.historyRenderMessagesRef=t,X.historyRenderMessageCount=t.length,X.historyRenderLimit=0,X.historyRenderLastScrollTop=null,0;if(JP(t.length))return X.historyRenderSessionKey=e.sessionKey,X.historyRenderMessagesRef=t,X.historyRenderMessageCount=t.length,X.historyRenderLimit=n,n;if(r||i&&a===0)X.historyRenderLimit=Math.min(OP,n);else if(i){let e=t.length-a;X.historyRenderLimit>=a?X.historyRenderLimit=n:e>0&&e<=kP?X.historyRenderLimit=Math.min(n,X.historyRenderLimit+e):X.historyRenderLimit=Math.min(Math.max(X.historyRenderLimit,OP),n)}return X.historyRenderSessionKey=e.sessionKey,X.historyRenderMessagesRef=t,X.historyRenderMessageCount=t.length,X.historyRenderLimit=Math.min(Math.max(1,X.historyRenderLimit),n),X.historyRenderLimit}function XP(e,t){let n=e.currentTarget;if(!(n instanceof HTMLElement))return;let r=Math.max(0,n.scrollTop),i=X.historyRenderLastScrollTop;X.historyRenderLastScrollTop=r;let a=Math.max(0,n.scrollHeight-r-n.clientHeight);if(!(r<=AP&&(r===0||!(r>0&&a<=AP)&&(i==null||r<i))))return;let o=qP(X.historyRenderMessageCount);X.historyRenderLimit>=o||(X.historyRenderAnchorAdjustment={scrollHeight:n.scrollHeight,scrollTop:r},ZP(n),X.historyRenderLimit=Math.min(o,X.historyRenderLimit+kP),t())}function ZP(e){let t=X.historyRenderAnchorAdjustment;!t||X.historyRenderAnchorFrame!=null||(X.historyRenderAnchorFrame=requestAnimationFrame(()=>{X.historyRenderAnchorFrame=null,X.historyRenderAnchorAdjustment=null;let n=e.scrollHeight-t.scrollHeight;n<=0||(e.scrollTop=t.scrollTop+n)}))}function QP(e,t,n){if(!e||X.historyRenderExpansionFrame!=null)return;let r=qP(X.historyRenderMessageCount);X.historyRenderLimit>=r||(X.historyRenderExpansionFrame=requestAnimationFrame(()=>{X.historyRenderExpansionFrame=null;let r=qP(X.historyRenderMessageCount);X.historyRenderLimit>=r||e.scrollHeight-e.clientHeight>1||(X.historyRenderLimit=Math.min(r,X.historyRenderLimit+kP),t(),n())}))}function $P(e){e.style.height=`auto`,e.style.height=`${Math.min(e.scrollHeight,150)}px`}function eF(e,t){if(!t||e.defaultPrevented)return;let n=e.target,r=e.currentTarget;!(n instanceof Element)||!(r instanceof HTMLElement)||n.closest(gP)||r.querySelector(`.agent-chat__composer-combobox > textarea`)?.focus({preventScroll:!0})}function tF(e){let t=e.currentTarget;t instanceof HTMLElement&&t.closest(`.agent-chat__input`)?.querySelector(`.agent-chat__file-input`)?.click()}function nF(e,t){requestAnimationFrame(()=>{if(document.activeElement!==e)return;$P(e);let n=t===`up`?0:e.value.length;e.selectionStart=n,e.selectionEnd=n})}function rF(){return`att-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function iF(e,t){return Gu({attachment:{id:rF(),mimeType:e.type||`application/octet-stream`,fileName:e.name||void 0,sizeBytes:e.size},dataUrl:t,file:e})}function aF(e){let t=/^\s*data:(image\/[a-z0-9.+-]+);base64,([a-z0-9+/=\s]+)\s*$/i.exec(e);if(!t)return null;let n=t[1].toLowerCase();if(!IE({name:`pasted-image`,type:n}))return null;let r=t[2].replace(/\s+/g,``);try{let e=atob(r),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);let i=n.split(`/`)[1]?.replace(/[^a-z0-9.+-]/gi,``)||`png`;return{file:new File([t],`pasted-image.${i}`,{type:n}),dataUrl:`data:${n};base64,${r}`}}catch{return null}}function oF(e){return e.mimeType.startsWith(`image/`)}function sF(e,t){let n=e.clipboardData?.items;if(!n||!t.onAttachmentsChange)return;let r=[];for(let e of Array.from(n))e.type.startsWith(`image/`)&&r.push(e);if(r.length===0){let n=e.clipboardData?.getData(`text/plain`),r=n?aF(n):null;if(!r)return;e.preventDefault(),t.onAttachmentsChange([...t.attachments??[],iF(r.file,r.dataUrl)]);return}e.preventDefault();for(let e of r){let n=e.getAsFile();if(!n)continue;let r=new FileReader;r.addEventListener(`load`,()=>{let e=r.result,i=iF(n,e),a=t.attachments??[];t.onAttachmentsChange?.([...a,i])}),r.readAsDataURL(n)}}function cF(e,t){let n=e.target;if(!n.files||!t.onAttachmentsChange)return;let r=t.attachments??[],i=[],a=0;for(let e of n.files){if(!IE(e))continue;a++;let n=new FileReader;n.addEventListener(`load`,()=>{i.push(iF(e,n.result)),a--,a===0&&t.onAttachmentsChange?.([...r,...i])}),n.readAsDataURL(e)}n.value=``}function lF(e,t){e.preventDefault();let n=e.dataTransfer?.files;if(!n||!t.onAttachmentsChange)return;let r=t.attachments??[],i=[],a=0;for(let e of n){if(!IE(e))continue;a++;let n=new FileReader;n.addEventListener(`load`,()=>{i.push(iF(e,n.result)),a--,a===0&&t.onAttachmentsChange?.([...r,...i])}),n.readAsDataURL(e)}}function uF(e){let t=e.attachments??[];return t.length===0?d:c`
    <div class="chat-attachments-preview">
      ${t.map(t=>c`
          <div
            class=${[`chat-attachment-thumb`,oF(t)?``:`chat-attachment-thumb--file`].filter(Boolean).join(` `)}
          >
            ${oF(t)&&qu(t)?c`<img src=${qu(t)} alt="Attachment preview" />`:c`
  ...
  `:d}function fF(e){let t=e.size;return typeof t!=`number`||!Number.isFinite(t)||t<0?``:t>=1024*1024?`${(t/(1024*1024)).toFixed(1).replace(/\.0$/,``)} MB`:t>=1024?`${(t/1024).toFixed(1).replace(/\.0$/,``)} KB`:`${t} B`}function pF(e){if(!e)return d;let t=e.list?.files??[];return c`
  ...
  `}function mF(){X.slashMenuMode=`command`,X.slashMenuCommand=null,X.slashMenuArgItems=[],X.slashMenuItems=[],X.slashMenuExpanded=!1}function hF(){return X.slashMenuOpen||X.slashMenuMode!==`command`||X.slashMenuCommand!==null||X.slashMenuArgItems.length>0||X.slashMenuItems.length>0||X.slashMenuExpanded}function gF(e){hF()&&(X.slashMenuOpen=!1,mF(),e())}function _F(e,t,n,r){if(!t.onSlashIntent||X.slashCommandRefreshPending)return;let i=t.onSlashIntent();!i||typeof i.then!=`function`||(X.slashCommandRefreshPending=!0,Promise.resolve(i).finally(()=>{X.slashCommandRefreshPending=!1;let i=r?.()??t.getDraft?.()??e;if(!i.startsWith(`/`)){gF(n);return}vF(i,n,t,{skipSlashIntent:!0})}))}function vF(e,t,n,r={},i){let a=e.match(/^\/(\S+)\s(.*)$/);if(a){r.skipSlashIntent||_F(e,n,t,i);let o=a[1].toLowerCase(),s=a[2].toLowerCase(),c=zp.find(e=>e.name===o);if(c?.argOptions?.length){let e=s?c.argOptions.filter(e=>e.toLowerCase().startsWith(s)):c.argOptions;if(e.length>0){X.slashMenuMode=`args`,X.slashMenuCommand=c,X.slashMenuArgItems=e,X.slashMenuOpen=!0,X.slashMenuIndex=0,X.slashMenuItems=[],t();return}}gF(t);return}let o=e.match(/^\/(\S*)$/);if(o){r.skipSlashIntent||_F(e,n,t,i);let a=Qp(o[1],{showAll:X.slashMenuExpanded});X.slashMenuItems=a,X.slashMenuOpen=a.length>0,X.slashMenuIndex=0,X.slashMenuMode=`command`,X.slashMenuCommand=null,X.slashMenuArgItems=[]}else{gF(t);return}t()}function yF(e,t,n){if(e.argOptions?.length){VP(t,`/${e.name} `),X.slashMenuMode=`args`,X.slashMenuCommand=e,X.slashMenuArgItems=e.argOptions,X.slashMenuOpen=!0,X.slashMenuIndex=0,X.slashMenuItems=[],n();return}X.slashMenuOpen=!1,mF(),e.executeLocal&&!e.args?(VP(t,`/${e.name}`),n(),t.onSend()):(VP(t,`/${e.name} `),n())}function bF(e,t,n){if(e.argOptions?.length){VP(t,`/${e.name} `),X.slashMenuMode=`args`,X.slashMenuCommand=e,X.slashMenuArgItems=e.argOptions,X.slashMenuOpen=!0,X.slashMenuIndex=0,X.slashMenuItems=[],n();return}X.slashMenuOpen=!1,mF(),VP(t,e.args?`/${e.name} `:`/${e.name}`),n()}function xF(e,t,n,r){let i=X.slashMenuCommand?.name??``;X.slashMenuOpen=!1,mF(),VP(t,`/${i} ${e}`),n(),r&&t.onSend()}function SF(e){return e.toLowerCase().replace(/[^a-z0-9_-]+/gu,`-`).replace(/^-+|-+$/gu,``)||`item`}function CF(e){return`chat-slash-option-command-${SF(e.name)}`}function wF(e,t){return`chat-slash-option-arg-${SF(e)}-${SF(t)}`}function TF(){return X.slashMenuOpen?X.slashMenuMode===`args`?!!(X.slashMenuCommand&&X.slashMenuArgItems.length>0):X.slashMenuItems.length>0:!1}function EF(){if(!TF())return null;if(X.slashMenuMode===`args`){let e=X.slashMenuCommand?.name,t=X.slashMenuArgItems[X.slashMenuIndex];return e&&t?wF(e,t):null}let e=X.slashMenuItems[X.slashMenuIndex];return e?CF(e):null}function DF(){if(!TF())return``;if(X.slashMenuMode===`args`){let e=X.slashMenuCommand?.name,t=X.slashMenuArgItems[X.slashMenuIndex];return e&&t?`/${e} ${t}`:``}let e=X.slashMenuItems[X.slashMenuIndex];return e?`${`/${e.name}${e.args?` ${e.args}`:``}`} ${e.description}`:``}function OF(e){return e.length<100?null:`~${Math.ceil(e.length/4)} tokens`}function kF(e){pj(e.messages,e.assistantName)}function AF(e){return X.searchOpen?c`
  ...
  `:d}function jF(e,t,n){let r=Lo({name:e.userName??null,avatar:e.userAvatar??null}),i=Array.isArray(e.messages)?e.messages:[],a=[];for(let e of t.indices){let t=i[e];if(!t)continue;let n=KN(t),r=typeof t.role==`string`?t.role:`unknown`;a.push({index:e,text:n,role:r})}return a.length===0?d:c`
  ...
  `}function MF(e,t,n){if(!X.slashMenuOpen)return d;if(X.slashMenuMode===`args`&&X.slashMenuCommand&&X.slashMenuArgItems.length>0)return c`
      <div
        id=${xP}
        class="slash-menu"
        role="listbox"
      ...
      >
        <div class="slash-menu-group">
          ...
          ${X.slashMenuArgItems.map((n,r)=>c`
              <div
                id=${wF(X.slashMenuCommand?.name??``,n)}
    ...
    <div id=${xP} class="slash-menu" role="listbox" aria-label="Slash commands">
      ${i}
      ${a>0?c`<button
            class="slash-menu-show-more"
            @click=${r=>{r.preventDefault(),r.stopPropagation(),X.slashMenuExpanded=!0,vF(n,e,t)}}
          >
  ...
  `}function NF(e){let r=e.connected,i=e.sending||e.stream!==null,a=!!(e.canAbort&&e.onAbort),o=_P(e.runStatus),s=a&&!o,l=e.queue.some(t=>vP(t,e.sessionKey,e.runStatus)),f=s||l?{phase:`in-progress`}:e.runStatus,m=e.compactionStatus?.phase===`active`||e.compactionStatus?.phase===`retrying`,h=e.sessions?.sessions?.find(t=>t.key===e.sessionKey),g=h?.reasoningLevel??`off`,_=e.showThinking&&g!==`off`,v={name:e.assistantName,avatar:tj(e)},y=BP(e),b=y.value,x=null,C=jP(e.sessionKey),ee=MP(e.sessionKey),w=(e.attachments?.length??0)>0,T=OF(b),te=e.composerControls,ne=e.connected?w?S(`chat.composer.placeholderWithAttachments`):S(`chat.composer.placeholder`,{name:e.assistantName||`agent`}):S(`chat.composer.placeholderDisconnected`),E=e.onRequestUpdate??(()=>{}),re=e.splitRatio??.6,D=!!(e.sidebarOpen&&e.onCloseSidebar),ie=e.stream??null,ae=YP(e),oe=e=>{let t=e.target.closest(`.code-block-copy`);if(!t)return;let n=t.dataset.code??``;navigator.clipboard.writeText(n).then(()=>{t.classList.add(`copied`),setTimeout(()=>t.classList.remove(`copied`),1500)},()=>{})},se=t=>{XP(t,E),e.onChatScroll?.(t)},ce=UP({sessionKey:e.sessionKey,messages:e.messages,toolMessages:e.toolMessages,streamSegments:e.streamSegments,stream:ie,streamStartedAt:e.streamStartedAt,queue:e.queue,showToolCalls:e.showToolCalls,searchOpen:X.searchOpen,searchQuery:X.searchQuery,historyRenderLimit:ae});sP(e.sessionKey,ce,!!e.autoExpandToolCalls);let O=aP(e.sessionKey),le=e=>{O.set(e,!O.get(e)),E()},ue=(e.realtimeTalkConversation?.length??0)>0,k=ce.length===0&&!e.loading&&!ue,de=e.loading&&ce.length===0,fe=h?.contextTokens??e.sessions?.defaults?.contextTokens??null,pe=c`
    <div
      class="chat-thread"
      role="log"
      aria-live="polite"
      ${u(t=>{QP(t instanceof HTMLElement?t:null,E,e.onScrollToBottom??(()=>{}))})}
      @scroll=${se}
      @click=${oe}
    >
      <div class="chat-thread-inner">
        ...
        ${n([ce,WP(ee,ce),GP(O),RM(),e.sessionKey,e.fullMessageAgentId,_,e.showToolCalls,!!e.autoExpandToolCalls,e.assistantName,v.avatar,e.userName,e.userAvatar,e.basePath,(e.localMediaPreviewRoots??[]).join(`\0`),e.assistantAttachmentAuthToken,e.canvasPluginSurfaceUrl,e.embedSandboxMode??`scripts`,e.allowExternalEmbedUrls??!1,fe],()=>t(ce,e=>e.key,t=>t.kind===`divider`?c`
                  ...
                  `:t.kind===`reading-indicator`?nN(v,e.basePath,e.assistantAttachmentAuthToken??null):t.kind===`stream`?rN(t.text,t.startedAt,t.isStreaming,e.onOpenSidebar,v,e.basePath,e.assistantAttachmentAuthToken??null):t.kind===`group`?ee.has(t.key)?d:iN(t,{onOpenSidebar:e.onOpenSidebar,sessionKey:e.sessionKey,agentId:e.fullMessageAgentId,showReasoning:_,showToolCalls:e.showToolCalls,autoExpandToolCalls:!!e.autoExpandToolCalls,isToolMessageExpanded:e=>O.get(e),onToggleToolMessageExpanded:(e,t)=>{O.set(e,!(t??O.get(e)??!1)),E()},isToolExpanded:e=>O.get(e)??!1,onToggleToolExpanded:le,onRequestUpdate:E,assistantName:e.assistantName,assistantAvatar:v.avatar,userName:e.userName??null,userAvatar:e.userAvatar??null,basePath:e.basePath,localMediaPreviewRoots:e.localMediaPreviewRoots??[],assistantAttachmentAuthToken:e.assistantAttachmentAuthToken??null,canvasPluginSurfaceUrl:e.canvasPluginSurfaceUrl,embedSandboxMode:e.embedSandboxMode??`scripts`,allowExternalEmbedUrls:e.allowExternalEmbedUrls??!1,contextWindow:fe,onDelete:()=>{ee.delete(t.key),E()}}):d))}
        ${FP(e)}
      </div>
    </div>
  `,me=t=>{let n=e.getDraft?.();typeof n==`string`&&(y.hostDraft=n,y.value=n,t&&t.value!==n&&(t.value=n,$P(t)))},he=t=>{if(X.slashMenuOpen&&X.slashMenuMode===`args`&&X.slashMenuArgItems.length>0){let n=X.slashMenuArgItems.length;switch(t.key){case`ArrowDown`:t.preventDefault(),X.slashMenuIndex=(X.slashMenuIndex+1)%n,E();return;case`ArrowUp`:t.preventDefault(),X.slashMenuIndex=(X.slashMenuIndex-1+n)%n,E();return;case`Tab`:t.preventDefault(),xF(X.slashMenuArgItems[X.slashMenuIndex],e,E,!1);return;case`Enter`:t.preventDefault(),xF(X.slashMenuArgItems[X.slashMenuIndex],e,E,!0);return;case`Escape`:t.preventDefault(),X.slashMenuOpen=!1,mF(),E();return}}if(X.slashMenuOpen&&X.slashMenuItems.length>0){let n=X.slashMenuItems.length;switch(t.key){case`ArrowDown`:t.preventDefault(),X.slashMenuIndex=(X.slashMenuIndex+1)%n,E();return;case`ArrowUp`:t.preventDefault(),X.slashMenuIndex=(X.slashMenuIndex-1+n)%n,E();return;case`Tab`:t.preventDefault(),bF(X.slashMenuItems[X.slashMenuIndex],e,E);return;case`Enter`:t.preventDefault(),yF(X.slashMenuItems[X.slashMenuIndex],e,E);return;case`Escape`:t.preventDefault(),X.slashMenuOpen=!1,mF(),E();return}}if(t.key===`Escape`&&e.sideResult&&!X.searchOpen){t.preventDefault(),e.onDismissSideResult?.();return}if((t.key===`ArrowUp`||t.key===`ArrowDown`)&&e.onHistoryKeydown){let n=t.target;VP(e,n.value);let r=e.onHistoryKeydown({key:t.key,selectionStart:n.selectionStart,selectionEnd:n.selectionEnd,valueLength:n.value.length,altKey:t.altKey,ctrlKey:t.ctrlKey,metaKey:t.metaKey,shiftKey:t.shiftKey,isComposing:t.isComposing,keyCode:t.keyCode});if(r.handled){r.preventDefault&&t.preventDefault(),r.restoreCaret&&nF(n,r.restoreCaret);return}}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&t.key===`f`){t.preventDefault(),X.searchOpen=!X.searchOpen,X.searchOpen||(X.searchQuery=``),E();return}if(t.key===`Enter`&&!t.shiftKey){if(t.isComposing||t.keyCode===229||!e.connected)return;if(t.preventDefault(),r){let n=t.target;VP(e,n.value),e.onSend(),me(n)}}},ge=t=>{let n=t.target;$P(n),y.value=n.value,(i||s||e.queue.length>0||n.value.startsWith(`/`)||hF())&&VP(e,n.value),vF(n.value,E,e,{},()=>n.value)},_e=t=>{let n=t.target;VP(e,n.value)},ve=()=>{VP(e,y.value),e.onSend(),me(x)},ye=TF(),A=EF(),be=DF();return c`
    <section
      class="card chat"
      @drop=${t=>lF(t,e)}
    ...
    >
      ...
      ${XA({queue:e.queue,canAbort:s,onQueueRetry:e.onQueueRetry,onQueueSteer:e.onQueueSteer,onQueueRemove:e.onQueueRemove})}
      ...
      <div
        ...
        @click=${t=>eF(t,e.connected)}
      >
        ${MF(E,e,b)} ${uF(e)}
        <div class="agent-chat__composer-status-stack">
          ${tP(e.fallbackStatus)}
          ${eP(e.compactionStatus)}
          ${lj(h,e.sessions?.defaults?.contextTokens??null,{compactBusy:m,compactDisabled:!e.connected||i||s,onCompact:e.onCompact})}
          ${dF(h?.goal)}
        </div>
        ...
        <div class="agent-chat__composer-combobox">
          <textarea
            ${u(e=>{x=e instanceof HTMLTextAreaElement?e:null,x&&$P(x)})}
            .value=${b}
            dir=${vM(b)}
            ?disabled=${!e.connected}
            aria-autocomplete="list"
            aria-controls=${p(ye?xP:void 0)}
        ...
        <div class="agent-chat__toolbar">
          ...
          ${qN({canAbort:s,connected:e.connected,draft:b,hasMessages:e.messages.length>0,isBusy:i,sending:e.sending,onAbort:e.onAbort,onExport:()=>kF(e),onNewSession:e.onNewSession,onSend:ve,onStoreDraft:()=>{},showSecondary:!1})}
        </div>
      </div>
    </section>
  `}function PF(e){return L(F(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`)}function FF(e,t){let n={...t,textScale:Qo(t.textScale),lastActiveSessionKey:C(t.lastActiveSessionKey)??C(t.sessionKey)??`main`};e.settings=n,ls(n),Ii(n.customTheme),(t.theme!==e.theme||t.themeMode!==e.themeMode)&&(e.theme=t.theme,e.themeMode=t.themeMode,eI(e,ra(t.theme,t.themeMode))),QF(n.borderRadius),$F(n.textScale),e.applySessionKey=e.settings.lastActiveSessionKey}function IF(e,t){let n=Fo({name:e.userName,avatar:e.userAvatar,...t});e.userName=n.name,e.userAvatar=n.avatar,ds(n)}function LF(e,t){e.sessionKey=t,FF(e,{...e.settings,sessionKey:t,lastActiveSessionKey:t})}var RF=!1;function zF(e){let t=window.__OPENCLAW_NATIVE_CONTROL_AUTH__;if(!t)return;try{delete window.__OPENCLAW_NATIVE_CONTROL_AUTH__}catch{window.__OPENCLAW_NATIVE_CONTROL_AUTH__=void 0}let n=C(t.gatewayUrl),r=C(t.token),i=C(t.password),a={...e.settings,...n?{gatewayUrl:n}:{},...r?{token:r}:{}};(n||r&&r!==e.settings.token)&&FF(e,a),i&&i!==e.password&&(e.password=i)}function BF(e){if(zF(e),!window.location.search&&!window.location.hash)return;let t=new URL(window.location.href),n=new URLSearchParams(t.search),r=new URLSearchParams(t.hash.startsWith(`#`)?t.hash.slice(1):t.hash),i=n.get(`gatewayUrl`)??r.get(`gatewayUrl`),a=C(i)??``,o=!!(a&&a!==e.settings.gatewayUrl),s=n.get(`token`),c=r.get(`token`),l=c!=null||s!=null,u=C(c??s),d=C(n.get(`session`)??r.get(`session`)),f=!!(u&&!d&&!o),p=!1;if(n.has(`token`)&&(n.delete(`token`),p=!0),l&&(s!=null&&(RF=!0,console.warn(`[openclaw] Auth token passed as query parameter (?token=). Use URL fragment instead: #token=<token>. Query parameters may appear in server logs.`)),u&&o?e.pendingGatewayToken=u:u&&u!==e.settings.token&&FF(e,{...e.settings,token:u}),r.delete(`token`),p=!0),f&&(e.sessionKey=`main`,FF(e,{...e.settings,sessionKey:`main`,lastActiveSessionKey:`main`})),(n.has(`password`)||r.has(`password`))&&(n.delete(`password`),r.delete(`password`),p=!0),d&&LF(e,d),i!=null&&(e.pendingGatewayUrl=o?a:null,e.pendingGatewayToken=o?u??null:null,n.delete(`gatewayUrl`),r.delete(`gatewayUrl`),p=!0),!p)return;t.search=n.toString();let m=r.toString();t.hash=m?`#${m}`:``,oI(t,!0)}function VF(e,t){sI(e,t,{refreshPolicy:`always`,syncUrl:!0})}function HF(e,t,n,r){PE({nextTheme:t,applyTheme:n,context:r,currentTheme:e.themeResolved}),tI(e)}function UF(e,t,n){HF(e,ra(t,e.themeMode),()=>FF(e,{...e.settings,theme:t}),n)}function WF(e,t,n){HF(e,ra(e.theme,t),()=>FF(e,{...e.settings,themeMode:t}),n)}async function GF(e,t){await Yb(t),await nr(t);let n=e.agentsList?.agents?.map(e=>e.id)??[];n.length>0&&Gb(t,n);let r=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id;if(r)switch(Wb(t,r),e.agentsPanel){case`files`:Vb(t,r);return;case`skills`:Kb(t,r);return;case`channels`:on(t,!1);return;case`cron`:vI(e);case`overview`:case`tools`:case void 0:}}function KF(e,t,n){n.then(()=>{rr(t).finally(()=>e.requestUpdate?.())},()=>void 0)}async function qF(e,t){let n=e,r=$m(e,e.tab);try{switch(e.tab){case`config`:case`communications`:case`appearance`:case`automation`:case`mcp`:case`infrastructure`:case`aiAgents`:{let t=nr(n);KF(e,n,t),await t}break;case`overview`:await uI(e);break;case`activity`:break;case`workboard`:await Promise.all([nr(n),H(n),Yb(n),ET({host:e,client:n.client,force:!0,requestUpdate:e.requestUpdate})]);break;case`channels`:await _I(e);break;case`instances`:await $S(n);break;case`usage`:await kw(n);break;case`sessions`:await Promise.all([nr(n),H(n)]);break;case`cron`:await vI(e);break;case`skills`:await MC(n);break;case`skillWorkshop`:await _C(n,{force:!0});break;case`agents`:await GF(e,n);break;case`nodes`:await Mb(n),await Promise.allSettled([Ux(n),nr(n),GS(n)]);break;case`dreams`:e.selectedAgentId=PF(e),await nr(n),await Promise.all([DS(n),OS(n),kS(n),AS(n)]);break;case`chat`:try{await Hy(e,{awaitHistory:t?.chatStartup===!0,startup:t?.chatStartup===!0}),ys(e,!e.chatHasAutoScrolled)}finally{QS(n).catch(()=>void 0)}break;case`debug`:await yb(n),e.eventLog=e.eventLogBuffer;break;case`logs`:e.logsAtBottom=!0,await jb(n,{reset:!0}),bs(e,!0);break}th(e,r,`ok`)}catch(t){throw th(e,r,`error`),t}}function JF(){if(typeof window>`u`)return``;let e=window.__OPENCLAW_CONTROL_UI_BASE_PATH__,t=C(e);return t?Hi(t):qi(window.location.pathname)}function YF(e){Ii(e.settings.customTheme);let t=e.settings.theme===`custom`&&!e.settings.customTheme?`claw`:e.settings.theme??`claw`;e.theme=t,e.themeMode=e.settings.themeMode??`system`,t!==e.settings.theme&&(e.settings={...e.settings,theme:t},ls(e.settings)),eI(e,ra(e.theme,e.themeMode)),QF(e.settings.borderRadius??50),$F(e.settings.textScale),tI(e)}function XF(e){e.systemThemeCleanup?.(),e.systemThemeCleanup=null}var ZF={sm:6,md:10,lg:14,xl:20,full:9999,default:10};function QF(e){if(typeof document>`u`)return;let t=document.documentElement,n=e/50;t.style.setProperty(`--radius-sm`,`${Math.round(ZF.sm*n)}px`),t.style.setProperty(`--radius-md`,`${Math.round(ZF.md*n)}px`),t.style.setProperty(`--radius-lg`,`${Math.round(ZF.lg*n)}px`),t.style.setProperty(`--radius-xl`,`${Math.round(ZF.xl*n)}px`),t.style.setProperty(`--radius-full`,`${Math.round(ZF.full*n)}px`),t.style.setProperty(`--radius`,`${Math.round(ZF.default*n)}px`)}function $F(e){if(typeof document>`u`)return;let t=document.documentElement,n=Qo(e)/100;t.style.setProperty(`--control-ui-text-scale`,n.toFixed(2))}function eI(e,t){if(e.themeResolved=t,typeof document>`u`)return;let n=document.documentElement,r=t.endsWith(`light`)?`light`:`dark`;n.dataset.theme=t,n.dataset.themeMode=r,n.style.colorScheme=r}function tI(e){if(e.themeMode!==`system`){e.systemThemeCleanup?.(),e.systemThemeCleanup=null;return}if(e.systemThemeCleanup||typeof globalThis.matchMedia!=`function`)return;let t=globalThis.matchMedia(`(prefers-color-scheme: light)`),n=()=>{e.themeMode===`system`&&eI(e,ra(e.theme,`system`))};if(typeof t.addEventListener==`function`){t.addEventListener(`change`,n),e.systemThemeCleanup=()=>t.removeEventListener(`change`,n);return}typeof t.addListener==`function`&&(t.addListener(n),e.systemThemeCleanup=()=>t.removeListener(n))}function nI(e,t){if(typeof window>`u`)return;let n=Ki(window.location.pathname,e.basePath)??`chat`;iI(e,n),cI(e,n,t)}function rI(e){if(typeof window>`u`)return;let t=Ki(window.location.pathname,e.basePath);if(!t)return;let n=C(new URL(window.location.href).searchParams.get(`session`));n&&LF(e,n),iI(e,t)}function iI(e,t){sI(e,t,{refreshPolicy:`connected`})}function aI(e){e.sessionsChangedReloadTimer!=null&&(globalThis.clearTimeout(e.sessionsChangedReloadTimer),e.sessionsChangedReloadTimer=null)}function oI(e,t){let n=typeof window>`u`?void 0:window.history;if(n)return t?n.replaceState({},``,e.toString()):n.pushState({},``,e.toString())}function sI(e,t,n){let r=e.tab;e.tab=t,r!==t&&(Zm(e,r,t),aI(e)),r===`chat`&&t!==`chat`&&KP(),t===`chat`&&(e.chatHasAutoScrolled=!1),(t===`logs`?Ib:Lb)(e),(t===`nodes`?Pb:Fb)(e),(t===`debug`?Rb:zb)(e),(n.refreshPolicy===`always`||e.connected)&&qF(e),n.syncUrl&&cI(e,t,!1)}function cI(e,t,n){let r=typeof window>`u`?void 0:window.location?.href,i=typeof window>`u`?void 0:window.location?.pathname;if(!r||!i)return;let a=Ui(Wi(t,e.basePath)),o=Ui(i),s=new URL(r);t===`chat`&&e.sessionKey?s.searchParams.set(`session`,e.sessionKey):s.searchParams.delete(`session`),o!==a&&(s.pathname=a),oI(s,n)}function lI(e,t,n){let r=typeof window>`u`?void 0:window.location?.href;if(!r)return;let i=new URL(r);i.searchParams.set(`session`,t),oI(i,n)}async function uI(e,t){let n=e,r=(e.controlUiOverviewRefreshSeq??0)+1;e.controlUiOverviewRefreshSeq=r;let i=()=>e.controlUiOverviewRefreshSeq===r&&e.tab===`overview`;await Promise.allSettled([on(n,!1),$S(n),H(n),px(n),_x(n)]),i()&&gI(n);let a=B();Promise.allSettled([yb(n),MC(n),i()?kw(n):Promise.resolve(),hI(n),QS(n,{refresh:t?.refresh})]).then(e=>{if(!i())return;let t=e.some(e=>e.status===`rejected`)?`error`:`ok`;gI(n),Ym(n,`control-ui.overview.secondary`,{phase:`end`,status:t,durationMs:V(B()-a)},{console:!1})})}function dI(e){return e?.scopes?vb({role:e.role??`operator`,requestedScopes:[`operator.read`],allowedScopes:e.scopes}):!1}function fI(e){return e?.scopes?vb({role:e.role??`operator`,requestedScopes:[`operator.write`],allowedScopes:e.scopes}):!0}function pI(e){return e?.scopes?vb({role:e.role??`operator`,requestedScopes:[`operator.admin`],allowedScopes:e.scopes}):!0}function mI(e){return e?Object.values(e).some(e=>Array.isArray(e)&&e.length>0):!1}async function hI(e){if(!(!e.client||!e.connected))try{let t=await e.client.request(`logs.tail`,{cursor:e.overviewLogCursor||void 0,limit:100,maxBytes:5e4}),n=Array.isArray(t.lines)?t.lines.filter(e=>typeof e==`string`):[];e.overviewLogLines=[...e.overviewLogLines,...n].slice(-500),typeof t.cursor==`number`&&(e.overviewLogCursor=t.cursor)}catch{}}function gI(e){let t=[];e.lastError&&t.push({severity:`error`,icon:`x`,title:`Gateway Error`,description:e.lastError});let n=e.hello?.auth??null;n?.scopes&&!dI(n)&&t.push({severity:`warning`,icon:`key`,title:`Missing operator.read scope`,description:`This connection does not have the operator.read scope. Some features may be unavailable.`,href:`https://docs.openclaw.ai/web/dashboard`,external:!0});let r=e.skillsReport?.skills??[],i=r.filter(e=>!e.disabled&&mI(e.missing));if(i.length>0){let e=i.slice(0,3).map(e=>e.name),n=i.length>3?` +${i.length-3} more`:``;t.push({severity:`warning`,icon:`zap`,title:`Skills with missing dependencies`,description:`${e.join(`, `)}${n}`})}let a=r.filter(e=>e.blockedByAllowlist);a.length>0&&t.push({severity:`warning`,icon:`shield`,title:`${a.length} skill${a.length>1?`s`:``} blocked`,description:a.map(e=>e.name).join(`, `)});let o=e.cronJobs??[],s=o.filter(e=>sx(e)===`error`);s.length>0&&t.push({severity:`error`,icon:`clock`,title:`${s.length} cron job${s.length>1?`s`:``} failed`,description:s.map(e=>e.name).join(`, `)});let c=Date.now(),l=o.filter(e=>e.enabled&&e.state?.nextRunAtMs!=null&&c-e.state.nextRunAtMs>3e5);l.length>0&&t.push({severity:`warning`,icon:`clock`,title:`${l.length} overdue job${l.length>1?`s`:``}`,description:l.map(e=>e.name).join(`, `)});let u=e.modelAuthStatusResult;if(u){let e=(u.providers??[]).filter(ME),n=e.filter(e=>e.status===`expired`||e.status===`missing`);n.length>0&&t.push({severity:`error`,icon:`key`,title:S(`overview.cards.modelAuthAttentionExpiredTitle`),description:S(`overview.cards.modelAuthAttentionExpiredDesc`,{providers:n.map(e=>e.displayName).join(`, `)})});let r=e.filter(e=>e.status===`expiring`);r.length>0&&t.push({severity:`warning`,icon:`key`,title:S(`overview.cards.modelAuthAttentionExpiringTitle`),description:r.map(e=>S(`overview.cards.modelAuthAttentionExpiringEntry`,{provider:e.displayName,when:e.expiry?.label??`soon`})).join(`, `)})}e.attentionItems=t}async function _I(e){let t=e,n=Promise.all([on(t,!1),nr(t)]);KF(e,t,n),await n}async function vI(e){let t=e,n=t.cronRunsScope===`job`?t.cronRunsJobId:null,r=(e.controlUiCronRefreshSeq??0)+1;e.controlUiCronRefreshSeq=r;let i=()=>e.controlUiCronRefreshSeq===r&&e.tab===`cron`,a=e.tab===`cron`,o=B();Ix(t,n).catch(()=>`error`).then(e=>{i()&&Ym(t,`control-ui.cron.runs`,{phase:`end`,status:e,durationMs:V(B()-o)},{console:!1})}),await Promise.all([on(t,!1),px(t),_x(t,{tableFilters:a})])}var yI=/^\s*NO_REPLY\s*$/;function bI(e){if(!e||typeof e!=`object`)return!1;let t=e,n=w(t.role);if(n&&n!==`assistant`||!(`content`in t)&&!(`text`in t))return!1;let r=uf(e);return typeof r==`string`&&r.trim()!==``&&!yI.test(r)}function xI(e){return!!(e&&e.state===`final`&&!bI(e.message))}function SI(e){if(!e||typeof e!=`object`)return null;let t=e;if(t.kind!==`btw`)return null;let n=C(t.runId),r=C(t.sessionKey),i=C(t.question),a=C(t.text);return n&&r&&i&&a?{kind:`btw`,runId:n,sessionKey:r,...C(t.agentId)?{agentId:C(t.agentId)}:{},question:i,text:a,isError:t.isError===!0,ts:typeof t.ts==`number`&&Number.isFinite(t.ts)?t.ts:Date.now()}:null}var CI=new WeakMap;function wI(e){let t=e,n=(CI.get(t)??0)+1;return CI.set(t,n),n}function TI(e,t,n){return CI.get(e)===t&&e.sessionKey.trim()===n}async function EI(e,t){if(!e.client||!e.connected)return;let n=t?.sessionKey?.trim()||e.sessionKey.trim(),r=n?{sessionKey:n}:{},i=wI(e);try{let t=await e.client.request(`agent.identity.get`,r);if(!TI(e,i,n)||!t)return;let a=Ta(t);e.assistantName=a.name,e.assistantAvatar=a.avatar,e.assistantAvatarSource=a.avatarSource??null,e.assistantAvatarStatus=a.avatarStatus??null,e.assistantAvatarReason=a.avatarReason??null,e.assistantAgentId=a.agentId??null;let o=fs().avatar;o&&(e.assistantAvatar=o,e.assistantAvatarSource=o,e.assistantAvatarStatus=`data`,e.assistantAvatarReason=null)}catch{}}function DI(e,t){ps({avatar:t}),t?(e.assistantAvatar=t,e.assistantAvatarSource=t,e.assistantAvatarStatus=`data`,e.assistantAvatarReason=null):(e.assistantAvatar=null,e.assistantAvatarSource=null,e.assistantAvatarStatus=null,e.assistantAvatarReason=null)}var OI=`/__openclaw/control-ui-config.json`;function kI(e){let t=F(e.sessionKey)?.agentId;if(t)return L(t);let n=C(e.assistantAgentId);return n?L(n):null}function AI(e){let t=C(e);return t?L(t):null}function jI(e){let t=fs().avatar;t&&(e.assistantAvatar=t,e.assistantAvatarSource=t,e.assistantAvatarStatus=`data`,e.assistantAvatarReason=null)}async function MI(e,t){if(typeof window>`u`||typeof fetch!=`function`)return;let n=Hi(e.basePath??``),r=n?`${n}${OI}`:OI;try{let n=new URL(r,window.location.origin).origin===window.location.origin?j(e):[],i=n.length>0?n:[``],a=null;for(let e of i){let t={Accept:`application/json`};if(e&&(t.Authorization=`Bearer ${e}`),a=await fetch(r,{method:`GET`,headers:t,credentials:`same-origin`}),a.ok)break;if(a.status!==401&&a.status!==403)return}if(!a||!a.ok)return;let o=await a.json();if(t?.applyIdentity!==!1){let t=kI(e),n=AI(o.assistantAgentId??null);if(!t||!n||t===n){let t=Ta({agentId:o.assistantAgentId??null,name:o.assistantName,avatar:o.assistantAvatar??null,avatarSource:o.assistantAvatarSource??null,avatarStatus:o.assistantAvatarStatus??null,avatarReason:o.assistantAvatarReason??null});e.assistantName=t.name,e.assistantAvatar=t.avatar,e.assistantAvatarSource=t.avatarSource??null,e.assistantAvatarStatus=t.avatarStatus??null,e.assistantAvatarReason=t.avatarReason??null,e.assistantAgentId=t.agentId??null}jI(e)}e.serverVersion=o.serverVersion??null,e.localMediaPreviewRoots=Array.isArray(o.localMediaPreviewRoots)?o.localMediaPreviewRoots.filter(e=>typeof e==`string`):[],e.embedSandboxMode=o.embedSandbox===`trusted`?`trusted`:o.embedSandbox===`strict`?`strict`:`scripts`,e.allowExternalEmbedUrls=o.allowExternalEmbedUrls===!0,e.chatMessageMaxWidth=typeof o.chatMessageMaxWidth==`string`&&o.chatMessageMaxWidth.trim()?o.chatMessageMaxWidth:null}catch{}}var NI=`APPROVAL_ALREADY_RESOLVED`,PI=`APPROVAL_NOT_FOUND`;function FI(e){return typeof e==`object`&&!!e}function II(e,t){if(!Array.isArray(e))return;let n=e.filter(e=>{if(!FI(e))return!1;let{startIndex:n,endIndex:r}=e;return Number.isSafeInteger(n)&&Number.isSafeInteger(r)&&typeof n==`number`&&typeof r==`number`&&n>=0&&r>n&&r<=t});return n.length>0?n:void 0}function LI(e){if(!Array.isArray(e))return;let t=e.filter(e=>e===`allow-once`||e===`allow-always`||e===`deny`);return t.length>0?t:void 0}function RI(e){if(!FI(e))return null;let t=C(e.id)??``,n=e.request;if(!t||!FI(n))return null;let r=typeof n.command==`string`?n.command:``;if(r.trim().length===0)return null;let i=typeof e.createdAtMs==`number`?e.createdAtMs:0,a=typeof e.expiresAtMs==`number`?e.expiresAtMs:0;return!i||!a?null:{id:t,kind:`exec`,request:{command:r,cwd:typeof n.cwd==`string`?n.cwd:null,host:typeof n.host==`string`?n.host:null,security:typeof n.security==`string`?n.security:null,ask:typeof n.ask==`string`?n.ask:null,agentId:typeof n.agentId==`string`?n.agentId:null,resolvedPath:typeof n.resolvedPath==`string`?n.resolvedPath:null,sessionKey:typeof n.sessionKey==`string`?n.sessionKey:null,commandSpans:II(n.commandSpans,r.length),allowedDecisions:LI(n.allowedDecisions)},createdAtMs:i,expiresAtMs:a}}function zI(e){if(!FI(e))return null;let t=C(e.id)??``;return t?{id:t,decision:typeof e.decision==`string`?e.decision:null,resolvedBy:typeof e.resolvedBy==`string`?e.resolvedBy:null,ts:typeof e.ts==`number`?e.ts:null}:null}function BI(e){if(!FI(e))return null;let t=C(e.id)??``;if(!t)return null;let n=typeof e.createdAtMs==`number`?e.createdAtMs:0,r=typeof e.expiresAtMs==`number`?e.expiresAtMs:0;if(!n||!r)return null;let i=FI(e.request)?e.request:{},a=C(i.title)??``;if(!a)return null;let o=typeof i.description==`string`?i.description:null,s=typeof i.severity==`string`?i.severity:null,c=typeof i.pluginId==`string`?i.pluginId:null;return{id:t,kind:`plugin`,request:{command:a,agentId:typeof i.agentId==`string`?i.agentId:null,sessionKey:typeof i.sessionKey==`string`?i.sessionKey:null,allowedDecisions:LI(i.allowedDecisions)},pluginTitle:a,pluginDescription:o,pluginSeverity:s,pluginId:c,createdAtMs:n,expiresAtMs:r}}function VI(e){let t=Date.now();return e.filter(e=>e.expiresAtMs>t)}function HI(e,t){let n=VI(e).filter(e=>e.id!==t.id);return n.unshift(t),n}function UI(e,t){return VI(e).filter(e=>e.id!==t)}function WI(e){return FI(e)?C(e.gatewayCode)??null:null}function GI(e){if(!FI(e))return null;let{details:t}=e;return FI(t)?C(t.reason)??null:null}function KI(e){if(!(e instanceof Error))return!1;let t=WI(e),n=GI(e);return n===NI||n===PI||t===PI?!0:/unknown or expired approval id/i.test(e.message)}function qI(e,t){return Array.isArray(e)?e.flatMap(e=>{let n=t(e);return n?[n]:[]}):null}function JI(e){return e.toSorted((e,t)=>t.createdAtMs-e.createdAtMs)}function YI(e,t){return VI(e).filter(e=>e.kind===t)}function XI(e,t,n,r){let i=new Set(t.map(e=>e.id)),a=VI(n),o=new Set(a.map(e=>e.id)),s=VI(e).filter(e=>!r.has(e.id)&&(!i.has(e.id)||o.has(e.id))),c=new Set(s.map(e=>e.id)),l=a.filter(e=>!i.has(e.id)&&!c.has(e.id));return JI([...s,...l])}function ZI(e,t){let n=Math.max(0,t.expiresAtMs-Date.now()+500);globalThis.setTimeout(()=>{QI(e,t.id)},n)}function QI(e,t){let n=e.execApprovalQueue[0]?.id??null;e.execApprovalQueue=UI(e.execApprovalQueue,t),n!==(e.execApprovalQueue[0]?.id??null)&&(e.execApprovalError=null)}function $I(e,t){e.execApprovalQueue=HI(e.execApprovalQueue,t),e.execApprovalError=null,ZI(e,t)}async function eL(e){let t=e.client;if(!t)return;let n=e.execApprovalRefreshRemovedIds??new Set,r=!e.execApprovalRefreshRemovedIds;r&&(e.execApprovalRefreshRemovedIds=n);let i=VI(e.execApprovalQueue);try{let[r,a]=await Promise.allSettled([t.request(`exec.approval.list`,{}),t.request(`plugin.approval.list`,{})]),o=r.status===`fulfilled`?qI(r.value,RI)??[]:YI(e.execApprovalQueue,`exec`),s=a.status===`fulfilled`?qI(a.value,BI)??[]:YI(e.execApprovalQueue,`plugin`),c=XI(JI([...o,...s]),i,e.execApprovalQueue,n);e.execApprovalQueue=c;for(let t of c)ZI(e,t)}finally{r&&(e.execApprovalRefreshRemovedIds=null)}}function tL(e,t){QI(e,t),e.execApprovalRefreshRemovedIds?.add(t),e.execApprovalError=null}function nL(e,t){QI(e,t),e.execApprovalRefreshRemovedIds?.add(t)}var rL={ok:!1,ts:0,durationMs:0,heartbeatSeconds:0,defaultAgentId:``,agents:[],sessions:{path:``,count:0,recent:[]}};async function iL(e){try{return await e.request(`health`,{})??rL}catch{return rL}}async function aL(e){if(!(!e.client||!e.connected)&&!e.healthLoading){e.healthLoading=!0,e.healthError=null;try{e.healthResult=await iL(e.client)}catch(t){e.healthError=String(t)}finally{e.healthLoading=!1}}}function oL(e){return/^(?:typeerror:\s*)?(?:fetch failed|failed to fetch)$/i.test(e.trim())}var sL=5e3,cL=250,lL=1e4;function uL(e,t){t&&$I(e,t)}function dL(e,t){let n=zI(t);n&&nL(e,n.id)}function fL(e){return e===`final`||e===`aborted`||e===`error`}function pL(e){if(!e||typeof e!=`object`||Array.isArray(e))return!1;let t=e;return t.phase===`start`||t.phase===`message`||t.phase===`end`||t.phase===`error`||t.reason===`send`||t.reason===`steer`}function mL(e){e.sessionsChangedReloadTimer!=null&&(globalThis.clearTimeout(e.sessionsChangedReloadTimer),e.sessionsChangedReloadTimer=null)}function hL(e){return e.connected&&!!e.client&&e.tab!==`chat`}function gL(e){mL(e),e.sessionsChangedReloadTimer=globalThis.setTimeout(()=>{e.sessionsChangedReloadTimer=null,hL(e)&&H(e)},sL)}function _L(e){return{tone:`danger`,text:`Update installed but running version did not change — restart may have been blocked.${e.actualVersion?` Expected v${e.expectedVersion}, running v${e.actualVersion}.`:``}`}}function vL(e){let t=e?.trim()||`restart-unhealthy`;return{tone:`danger`,text:`Update error: ${t}. ${t===`restart-unhealthy`?`The replacement process never became healthy and the previous process stayed up.`:`Check the gateway logs for the replacement failure.`}`}}async function yL(e,t){let n=e.pendingUpdateExpectedVersion?.trim();if(!n)return;let r=Date.now()+1e4;for(;e.client===t&&e.connected&&Date.now()<r;){let r;try{r=await t.request(`update.status`,{})}catch{r=null}let i=r?.sentinel,a=i?.stats?.after?.version?.trim()||null;if(i?.kind===`update`&&a){if(e.pendingUpdateExpectedVersion=null,i.status&&i.status!==`ok`){e.updateStatusBanner=vL(i.stats?.reason??null);return}a!==n&&(e.updateStatusBanner=_L({expectedVersion:n,actualVersion:a}));return}await new Promise(e=>{setTimeout(e,250)})}if(e.client!==t||!e.connected)return;let i=e.hello?.server?.version?.trim()||null;e.pendingUpdateExpectedVersion=null,i!==n&&(e.updateStatusBanner=_L({expectedVersion:n,actualVersion:i}))}function bL(e){let t=e.serverVersion?.trim();if(!t)return;let n=e.pageUrl??(typeof window>`u`?void 0:window.location.href);if(n)try{let r=new URL(n),i=new URL(e.gatewayUrl,r);return!new Set([`ws:`,`wss:`,`http:`,`https:`]).has(i.protocol)||!xL(r,i)?void 0:t}catch{return}}function xL(e,t){return t.host===e.host?!0:SL(e.hostname)&&SL(t.hostname)&&CL(e)===CL(t)}function SL(e){let t=e.trim().toLowerCase().replace(/^\[/,``).replace(/\]$/,``);return t===`localhost`||t===`::1`||t===`0:0:0:0:0:0:0:1`||t===`127.0.0.1`||t.startsWith(`127.`)}function CL(e){if(e.port)return e.port;switch(e.protocol){case`http:`:case`ws:`:return`80`;case`https:`:case`wss:`:return`443`;default:return``}}function wL(e,t){let n=(e??``).trim(),r=t.mainSessionKey?.trim();if(!r)return n;if(!n)return r;let i=t.mainKey?.trim()||`main`,a=t.defaultAgentId?.trim();return n===`main`||n===i||a&&(n===`agent:${a}:main`||n===`agent:${a}:${i}`)?r:n}function TL(e,t){if(!t?.mainSessionKey)return;if(wL(e.sessionKey,t)===e.sessionKey){let n=wL(e.settings.lastActiveSessionKey,t);n!==e.settings.lastActiveSessionKey&&FF(e,{...e.settings,lastActiveSessionKey:n});return}let n=wL(e.sessionKey,t),r=wL(e.settings.sessionKey,t),i=wL(e.settings.lastActiveSessionKey,t),a=n||r||e.sessionKey,o={...e.settings,sessionKey:r||a,lastActiveSessionKey:i||a},s=o.sessionKey!==e.settings.sessionKey||o.lastActiveSessionKey!==e.settings.lastActiveSessionKey;a!==e.sessionKey&&(e.sessionKey=a),s&&FF(e,o)}function EL(e){let t=e.hello?.snapshot,n=t?.sessionDefaults?.mainSessionKey?.trim();if(n)return n;let r=t?.sessionDefaults?.mainKey?.trim()||e.agentsList?.mainKey?.trim();return r&&F(r)?r:Zl({agentId:e.agentsList?.defaultId?.trim()||`main`,mainKey:r})}function DL(e){return Kl(e)}function OL(e){let t=e.hello?.snapshot?.sessionDefaults,n=t?.defaultAgentId?.trim();if(n)return L(n);let r=F(t?.mainSessionKey??``);return r?L(r.agentId):void 0}function kL(e){return Jl(e)}function AL(e,t){return t?L(t):DL(e)}function jL(e,t,n){if(!I(t))return!0;let r=I(e.sessionKey)?kL(e):Yl(e,e.sessionKey);return r?AL(e,n)===r:!0}function ML(e,t,n){if(!t)return!1;if($l(t,e.sessionKey))return!0;let r=Yl(e,e.sessionKey);return!!(r&&I(t)&&AL(e,n)===r)}function NL(e,t){return jL(e,t.sessionKey,t.agentId)}function PL(e){let t=F(e.sessionKey);if(!t)return!1;let n=new Set((e.agentsList?.agents??[]).map(e=>L(e.id)));if(n.size===0||n.has(L(t.agentId)))return!1;let r=EL(e);return e.sessionKey=r,FF(e,{...e.settings,sessionKey:r,lastActiveSessionKey:r}),lI(e,r,!0),!0}function FL(e){if(e.tab!==`chat`)return!1;if(I(e.sessionKey)){let t=OL(e);if(!t)return!1;let n=e.assistantAgentId?L(e.assistantAgentId):void 0;if(n&&n!==t)return!1;let r=e.agentsList?.defaultId?L(e.agentsList.defaultId):void 0;return!r||r===t}let t=F(e.sessionKey);return t?L(t.agentId)===OL(e):!0}function IL(e){return e instanceof Error?e:Error(String(e))}function LL(e,t){return e===t?!0:e.length===t.length?e.every((e,n)=>e===t[n]):!1}function RL(e){let t=e.chatComposerProvisionalRestore;e.chatComposerProvisionalRestore=null;let n=e.hello?.snapshot,r=t?wL(t.sessionKey,n?.sessionDefaults??{}):``;!t||!$l(r,e.sessionKey)||e.chatMessage!==t.chatMessage||!LL(e.chatQueue,t.chatQueue)||vd(e,e.sessionKey)&&(e.chatMessage=``,e.chatQueue=[])}async function zL(e){let t,n=FL(e),r=e.agentsList,i=n?qF(e,{chatStartup:!0}).catch(e=>{t=IL(e)}):Promise.resolve(),a=!n,o;if(await i,n&&e.agentsList&&e.agentsList!==r){if(t)throw t;return}try{await Yb(e),a=PL(e)||a}catch(e){o=IL(e)}if(a)await qF(e);else if(t)throw t;if(o)throw o}async function BL(e,t){e.client===t&&await zL(e)}function VL(e){if(typeof queueMicrotask==`function`){queueMicrotask(e);return}Promise.resolve().then(e)}function HL(e,t){let n=e,r=t?.reason??`initial`;n.pendingShutdownMessage=null,n.resumeChatQueueAfterReconnect=!1,mL(e),e.lastError=null,e.lastErrorCode=null,e.chatError=null,e.hello=null,e.connected=!1,r===`seq-gap`?(e.execApprovalQueue=VI(e.execApprovalQueue),jy(e,e.chatRunId??void 0),n.resumeChatQueueAfterReconnect=!0):e.execApprovalQueue=VI(e.execApprovalQueue),e.execApprovalError=null;let i=e.client,a=bL({gatewayUrl:e.settings.gatewayUrl,serverVersion:e.serverVersion}),o=new tn({url:e.settings.gatewayUrl,token:e.settings.token.trim()?e.settings.token:void 0,password:e.password.trim()?e.password:void 0,clientName:`openclaw-control-ui`,clientVersion:a,mode:`webchat`,instanceId:e.clientInstanceId,onHello:t=>{if(e.client!==o)return;if(n.pendingShutdownMessage=null,e.connected=!0,e.lastError=null,e.lastErrorCode=null,e.chatError=null,e.hello=t,ZL(e,t),RL(e),Sd(e,{preserveCurrent:!0}),e.pendingAbort){let t=e.pendingAbort;e.pendingAbort=null,e.client.request(`chat.abort`,t.runId?{sessionKey:t.sessionKey,...Nv(e,t.sessionKey),...t.agentId?{agentId:t.agentId}:{},runId:t.runId}:{sessionKey:t.sessionKey,...Nv(e,t.sessionKey),...t.agentId?{agentId:t.agentId}:{}}).catch(e=>{console.warn(`[openclaw] pending abort failed:`,e)})}let r=e.chatRunId,i=!!r||e.chatStream!=null;Pf(e,{outcome:i?`interrupted`:void 0,sessionStatus:`killed`,runId:r,sessionKey:e.sessionKey,clearLocalRun:!0,clearChatStream:!0,clearToolStream:!0,clearSideResultTerminalRuns:!0,clearRunStatus:!i});let a=Ny(e);(n.resumeChatQueueAfterReconnect||a)&&(n.resumeChatQueueAfterReconnect=!1,a&&Fy(e),Jy(e)),pv(e),mv(e,{force:!0}),BL(e,o),VL(()=>{e.client===o&&(MI(e,{applyIdentity:!1}),EI(e),e.tab!==`chat`&&sb(e),aL(e),e.reconcileWebPushState?.(),yL(e,o))})},onClose:({code:t,reason:r,error:i})=>{if(e.client===o)if(e.connected=!1,Py(e),mL(e),e.lastErrorCode=Ft(i)??(typeof i?.code==`string`?i.code:null),t!==1012){if(i?.message){e.lastError=e.lastErrorCode&&(e.lastErrorCode===M.PAIRING_REQUIRED||oL(i.message))?Lm({message:i.message,details:i.details,code:i.code}):i.message;return}e.lastError=n.pendingShutdownMessage??`disconnected (${t}): ${r||`no reason`}`}else e.lastError=n.pendingShutdownMessage??null,e.lastErrorCode=null},onEvent:t=>{e.client===o&&UL(e,t)},onRequestTiming:t=>{e.client===o&&nh(e,t)},onConnectTiming:t=>{e.client===o&&rh(e,t)},onGap:({expected:t,received:n})=>{e.client===o&&(e.lastError=`event gap detected (expected seq ${t}, got ${n}); reconnecting`,e.lastErrorCode=null,HL(e,{reason:`seq-gap`}))}});e.client=o,i?.stop(),o.start()}function UL(e,t){try{XL(e,t)}catch(e){console.error(`[gateway] handleGatewayEvent error:`,t.event,e)}}function WL(e,t,n,r){if(n!==`final`&&n!==`error`&&n!==`aborted`||GL(t,r))return!1;let i=e,a=i.toolStreamOrder.length>0,o=()=>void Jy(e);jy(e,t?.runId);let s=t?.runId,c=s?e.refreshSessionsAfterChat.get(s):void 0;if(s&&c&&(e.refreshSessionsAfterChat.delete(s),n===`final`&&H(e,{...Cv(e),...Fv(e,c)})),a&&n===`final`){if(r&&!xI(t))return o(),!1;let n=s??null;return qg(e).finally(()=>{n&&e.chatRunId&&e.chatRunId!==n||(ku(i),o())}),!0}return ku(i),o(),!1}function GL(e,t){return!!(t&&e&&e.runId!==t)}function KL(e,t){t?.sessionKey&&Jr(e,t.sessionKey);let n=e;if(fL(t?.state)&&typeof t?.runId==`string`&&n.chatSideResultTerminalRuns?.has(t.runId)===!0&&t?.runId){n.chatSideResultTerminalRuns?.delete(t.runId);return}let r=e.chatRunId,i=p_(e,t);ly(e,t,i);let a=GL(t,r),o=WL(e,t,i,r),s=e,c=s.pendingSessionMessageReloadSessionKey?.trim(),l=t?.sessionKey?.trim(),u=i===`final`&&xI(t),d=!!(c&&l&&$l(c,l)&&fL(i)&&!a&&$l(l,e.sessionKey)&&!e.chatRunId),f=d&&(i!==`final`||u);if(d&&(s.pendingSessionMessageReloadSessionKey=null),u&&!o&&!a){qg(e);return}f&&!o&&qg(e)}function qL(e,t,n,r){jy(e,typeof n?.clientRunId==`string`&&n.clientRunId.trim()?n.clientRunId:typeof n?.runId==`string`&&n.runId.trim()?n.runId:r??void 0);let i=()=>void Jy(e),a=()=>{!t.applied||!t.clearedChatRunStatus||e.chatRunId||Pf(e,{outcome:t.clearedChatRunStatus.phase,runId:t.clearedChatRunStatus.runId,sessionKey:t.clearedChatRunStatus.sessionKey,clearIndicators:!1})},o=e,s=o.pendingSessionMessageReloadSessionKey?.trim(),c=typeof n?.sessionKey==`string`?n.sessionKey.trim():``;if(s&&$l(s,e.sessionKey)&&(!c||$l(c,s))){o.pendingSessionMessageReloadSessionKey=null;let t=s;return Promise.resolve(qg(e)).finally(()=>{$l(e.sessionKey,t)&&(a(),i())}),!0}return a(),i(),!1}function JL(e,t){let n=e,r=t?.sessionKey?.trim();if(!jL(e,r,t?.agentId))return;let i=ML(e,r,t?.agentId),a=e.chatRunId,o=dv(e,t);if(!(o.applied&&o.clearedChatRun&&(i&&(n.pendingSessionMessageReloadSessionKey=r),qL(e,o,t,a)))&&!(!r||!i)){if(e.chatRunId){n.pendingSessionMessageReloadSessionKey=r;let i=Date.now(),a=e.chatRunId;H(e,{...Cv(e),...Pv(e,e.sessionKey),publishChatRunStatus:!1}).finally(()=>YL(e,r,t?.agentId,i,a));return}n.pendingSessionMessageReloadSessionKey=null,qg(e)}}function YL(e,t,n,r,i){if(!$l(e.pendingSessionMessageReloadSessionKey?.trim()??``,t)||!ML(e,t,n))return;if(e.chatRunId){e.sessionsLoading===!0&&Date.now()-r<lL&&globalThis.setTimeout(()=>YL(e,t,n,r,i),cL);return}let a=e.sessionsResult?.sessions.find(e=>$l(e.key,t));qL(e,{applied:!0,change:`updated`,clearedChatRun:!0,...a?{clearedChatRunStatus:{phase:a.status===`done`?`done`:`interrupted`,runId:i??null,sessionKey:t}}:{}},{sessionKey:t},i)}function XL(e,t){if(e.eventLogBuffer=[{ts:Date.now(),event:t.event,payload:t.payload},...e.eventLogBuffer].slice(0,250),(e.tab===`debug`||e.tab===`overview`)&&(e.eventLog=e.eventLogBuffer),t.event===`agent`||t.event===`session.tool`){if(e.onboarding)return;Vu(e,t.payload);return}if(t.event===`chat`){KL(e,t.payload);return}if(t.event===`chat.send_timing`){ny(e,t.payload);return}if(t.event===`chat.side_result`){let n=SI(t.payload);if(!n||!ML(e,n.sessionKey,n.agentId)||!NL(e,n))return;let r=e;r.chatSideResult=n,r.chatSideResultTerminalRuns?.add(n.runId);return}if(t.event===`session.message`){JL(e,t.payload);return}if(t.event===`session.operation`){Iu(e,t.payload);return}if(t.event===`presence`){let n=t.payload;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence,e.presenceError=null,e.presenceStatus=null);return}if(t.event===`shutdown`){let n=t.payload,r=n&&typeof n.reason==`string`&&n.reason.trim()?n.reason.trim():`gateway stopping`,i=typeof n?.restartExpectedMs==`number`?`Restarting: ${r}`:`Disconnected: ${r}`;e.pendingShutdownMessage=i,e.lastError=i,e.lastErrorCode=null;return}if(t.event===`sessions.changed`){let n=e.chatRunId,r=dv(e,t.payload);if(r.applied){r.clearedChatRun&&qL(e,r,t.payload,n);return}if(pL(t.payload))return;gL(e);return}if(t.event===`cron`&&e.tab===`cron`&&vI(e),(t.event===`device.pair.requested`||t.event===`device.pair.resolved`)&&Ux(e,{quiet:!0}),t.event===`exec.approval.requested`){uL(e,RI(t.payload));return}if(t.event===`exec.approval.resolved`){dL(e,t.payload);return}if(t.event===`plugin.approval.requested`){uL(e,BI(t.payload));return}if(t.event===`plugin.approval.resolved`){dL(e,t.payload);return}t.event===`update.available`&&(e.updateAvailable=t.payload?.updateAvailable??null)}function ZL(e,t){let n=t.snapshot;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence),n?.health&&(e.debugHealth=n.health,e.healthResult=n.health),n?.sessionDefaults&&TL(e,n.sessionDefaults),e.updateAvailable=n?.updateAvailable??null}var QL=200;function $L(e){let t=++e.connectGeneration;e.basePath=JF(),BF(e),e.controlUiBootstrapReady=MI(e,{applyIdentity:!1}),nI(e,!0),!(typeof e.pendingGatewayUrl==`string`&&e.pendingGatewayUrl.trim())&&Sd(e,{preserveCurrent:!0})?e.chatComposerProvisionalRestore={sessionKey:e.sessionKey,chatMessage:e.chatMessage,chatQueue:[...e.chatQueue]}:e.chatComposerProvisionalRestore=null,YF(e),window.addEventListener(`popstate`,e.popStateHandler),e.connectGeneration===t&&HL(e),e.tab===`nodes`&&Pb(e),e.tab===`logs`&&Ib(e),e.tab===`debug`&&Rb(e),e.controlUiResponsivenessObserver??=lh(e)}function eR(e){Ds(e)}function tR(e){e!=null&&typeof window.cancelAnimationFrame==`function`&&window.cancelAnimationFrame(e)}function nR(e){e!=null&&typeof window.clearTimeout==`function`&&window.clearTimeout(e)}function rR(e){e!=null&&globalThis.clearTimeout(e)}function iR(e){rR(e.chatComposerPersistTimer),e.chatComposerPersistTimer=null,e.chatComposerPersistSnapshot=null}function aR(e){let t=e.chatComposerPersistSnapshot;if(e.chatComposerPersistTimer==null||!t){iR(e);return}iR(e),yd({...e,sessionKey:t.sessionKey,chatMessage:t.chatMessage,chatQueue:t.chatQueue},t.sessionKey)}function oR(e){iR(e),e.chatComposerPersistSnapshot={sessionKey:e.sessionKey,chatMessage:e.chatMessage,chatQueue:[...e.chatQueue]},e.chatComposerPersistTimer=globalThis.setTimeout(()=>{aR(e)},QL)}function sR(e){e.connectGeneration+=1,e.controlUiTabPaintSeq=(e.controlUiTabPaintSeq??0)+1,aR(e),window.removeEventListener(`popstate`,e.popStateHandler),Fb(e),Lb(e),zb(e),tR(e.chatScrollFrame),e.chatScrollFrame=null,tR(e.logsScrollFrame),e.logsScrollFrame=null,tR(e.activityScrollFrame),e.activityScrollFrame=null,nR(e.chatScrollTimeout),e.chatScrollTimeout=null,rR(e.sessionsChangedReloadTimer),e.sessionsChangedReloadTimer=null,e.realtimeTalkSession?.stop(),e.realtimeTalkSession=null,e.realtimeTalkActive=!1,e.realtimeTalkStatus=`idle`,e.realtimeTalkDetail=null,e.realtimeTalkTranscript=null,e.resetRealtimeTalkConversation?.(),e.client?.stop(),e.client=null,e.connected=!1,XF(e),e.topbarObserver?.disconnect(),e.topbarObserver=null,e.controlUiResponsivenessObserver?.disconnect(),e.controlUiResponsivenessObserver=null}function cR(e,t){if(t.has(`chatQueue`)?(iR(e),yd(e)):t.has(`sessionKey`)?(aR(e),t.has(`chatMessage`)&&yd(e)):t.has(`chatMessage`)&&oR(e),!(e.tab===`chat`&&e.chatManualRefreshInFlight)){if(e.tab===`chat`&&(t.has(`chatMessages`)||t.has(`chatToolMessages`)||t.has(`chatStream`)||t.has(`chatLoading`)||t.has(`realtimeTalkConversation`)||t.has(`tab`))){let n=t.has(`tab`),r=t.has(`chatLoading`)&&t.get(`chatLoading`)===!0&&!e.chatLoading,i=t.get(`chatStream`),a=t.has(`chatStream`)&&i==null&&typeof e.chatStream==`string`;ys(e,n||r||a||!e.chatHasAutoScrolled)}e.tab===`logs`&&(t.has(`logsEntries`)||t.has(`logsAutoFollow`)||t.has(`tab`))&&e.logsAutoFollow&&e.logsAtBottom&&bs(e,t.has(`tab`)||t.has(`logsAutoFollow`)),e.tab===`activity`&&(t.has(`activityEntries`)||t.has(`activityAutoFollow`)||t.has(`tab`))&&e.activityAutoFollow&&e.activityAtBottom&&xs(e,t.has(`tab`)||t.has(`activityAutoFollow`))}}function lR(){return window.chrome?.webview}function uR(e){lR()?.postMessage(e)}function dR(e,t){if(!t||typeof t!=`object`)return;let n=t;if(typeof n.type==`string`&&n.type===`draft-text`){let t=n.payload&&typeof n.payload==`object`?n.payload.text:void 0;typeof t==`string`&&e.handleChatDraftChange(t)}}function fR(e){let t=lR();if(!t)return()=>{};let n=t=>{dR(e,t.data)};return t.addEventListener(`message`,n),uR({type:`ready`}),()=>{t.removeEventListener(`message`,n)}}function pR(e,t,n,r){let i=n.trim();if(!i)return;let a=w(i);t.has(a)||(t.add(a),e.push({value:i,label:r(i)}))}function mR(e){return e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey)}function hR(e){let t=e.chatModelCatalog??[],n=e.chatModelOverrides[e.sessionKey];if(n)return Oa(n,t);if(n===null)return``;let r=mR(e);return Ma(r?.model,r?.modelProvider,t)}function gR(e){return Ma(e.sessionsResult?.defaults?.model,e.sessionsResult?.defaults?.modelProvider,e.chatModelCatalog??[])}function _R(e,t,n,r){let i=new Set,a=[],o=(e,t)=>{pR(a,i,e,e=>t??e)};for(let n of e){let e=Va(n,t);o(e.value,e.label)}return n&&o(n,Ba(n,t)),r&&o(r,Ba(r,t)),a}function vR(e){let t=e.chatModelCatalog??[],n=Ra(t),r=hR(e),i=gR(e),a=Ba(i,n);return{currentOverride:r,defaultModel:i,defaultDisplay:a,defaultLabel:i?`Default (${a})`:`Default model`,options:_R(t,n,r,i)}}function yR(e){let t=Ns(e);if(t===void 0)return null;let n=t-Date.now();if(n<=0)return`now`;let r=Math.floor(n/6e4);if(r<60)return`${r}m`;let i=Math.floor(r/60),a=r%60;if(i<24)return a>0?`${i}h ${a}m`:`${i}h`;let o=Math.floor(i/24);if(o<7){let e=i%24;return e>0?`${o}d ${e}h`:`${o}d`}return new Date(t).toLocaleDateString(void 0,{month:`short`,day:`numeric`})}function bR(e){return e.flatMap(e=>(e.usage?.windows??[]).map(t=>({displayName:e.displayName,label:(t.label||``).trim(),remaining:Math.max(0,Math.min(100,Math.round(100-t.usedPercent))),resetAt:t.resetAt}))).toSorted((e,t)=>e.remaining-t.remaining||e.displayName.localeCompare(t.displayName))}function xR(e,t){return bR((e?.providers??[]).filter(t))}var SR={imessage:`iMessage`,telegram:`Telegram`,discord:`Discord`,signal:`Signal`,slack:`Slack`,whatsapp:`WhatsApp`,matrix:`Matrix`,email:`Email`,sms:`SMS`},CR=Object.keys(SR);function wR(e){return e.charAt(0).toUpperCase()+e.slice(1)}function TR(e){let t=w(e);if(e===`main`||e===`agent:main:main`)return{prefix:``,fallbackName:`Main Session`};if(e.includes(`:subagent:`))return{prefix:`Subagent:`,fallbackName:`Subagent:`};if(t.startsWith(`cron:`)||e.includes(`:cron:`))return{prefix:`Cron:`,fallbackName:`Cron Job:`};let n=e.match(/^agent:[^:]+:([^:]+):direct:(.+)$/);if(n){let e=n[1],t=n[2];return{prefix:``,fallbackName:`${SR[e]??wR(e)} · ${t}`}}let r=e.match(/^agent:[^:]+:([^:]+):group:(.+)$/);if(r){let e=r[1];return{prefix:``,fallbackName:`${SR[e]??wR(e)} Group`}}for(let t of CR)if(e===t||e.startsWith(`${t}:`))return{prefix:``,fallbackName:`${SR[t]} Session`};return{prefix:``,fallbackName:e}}function ER(e,t){let n=C(t?.label)??``,r=C(t?.displayName)??``,{prefix:i,fallbackName:a}=TR(e),o=e=>i?RegExp(`^${i.replace(/[.*+?^${}()|[\\]\\]/g,`\\$&`)}\\s*`,`i`).test(e)?e:`${i} ${e}`:e;return n&&n!==e?o(n):r&&r!==e?o(r):a}function DR(e){let t=w(e);if(!t)return!1;if(t.startsWith(`cron:`))return!0;if(!t.startsWith(`agent:`))return!1;let n=t.split(`:`).filter(Boolean);return n.length<3?!1:n.slice(2).join(`:`).startsWith(`cron:`)}function OR(e){return Vf(e)??w(e)}function kR(e){return`Inherited: ${jR(e?OR(e):`off`)}`}function AR(e,t){let n=OR(e);return!n||n===`off`?`Off`:jR(t?.trim()||n)}function jR(e){let t=w(e);if([`on`,`enable`,`enabled`].includes(t))return`On`;switch(OR(e)){case`adaptive`:return`Adaptive`;case`minimal`:return`Minimal`;case`low`:return`Low`;case`medium`:return`Medium`;case`high`:return`High`;case`xhigh`:return`Extra high`;case`max`:return`Maximum`;default:return e.charAt(0).toUpperCase()+e.slice(1)}}var MR=new Set([`anthropic`,`minimax`,`minimax-portal`,`openai`,`openrouter`,`xai`]),NR=300,PR=new WeakMap;function FR(e,t){e.lastError=t,e.chatError=t}function IR(e,t=()=>void 0,n={}){zz(e,e.sessionsResult);let r=Uz(e,e.sessionKey,e.sessionsResult),i=Hz(e),a=i.length>1,o=n.compact??!1,s=o?``:hz(e,t,i),l=n.sessionSwitcherOnly??!1,u=l?``:_z(e),d=l?``:mz(e),f=n.surface??`desktop`,p=uz(e,r),m=e.chatSessionPickerOpen&&e.chatSessionPickerSurface===f,h=e.sessionSwitchFlashKey===e.sessionKey;return c`
    <div class=${[`chat-controls__session-row`,l?`chat-controls__session-row--session-switcher`:``,a&&!o?``:`chat-controls__session-row--single-agent`,o?`chat-controls__session-row--compact`:``,d?`chat-controls__session-row--has-quota`:``,h?`chat-controls__session-row--flash`:``].filter(Boolean).join(` `)}>
      ${s}
      ${fz({state:e,onSwitchSession:t,surface:f,selectedSessionLabel:p,pickerOpen:m,disabled:!e.connected||!e.client,compact:o})}
      ${u} ${d}
    </div>
    <div class="chat-controls__session-notice" role="status" aria-live="polite">
      ${e.sessionSwitchNotice?.text??``}
    </div>
  `}function LR(e){return e?.hasMore?typeof e.nextOffset==`number`&&Number.isFinite(e.nextOffset)?Math.max(0,Math.floor(e.nextOffset)):e.sessions.length:null}async function RR(e){await H(e,{...Cv(e),...Pv(e,e.sessionKey)})}function zR(e){e.requestUpdate?.()}function BR(e){let t=PR.get(e);return t||(t={activeRequestId:null,activeRequestSignature:null,nextRequestId:0,timer:null},PR.set(e,t)),t}function VR(e){let t=BR(e);t.timer&&=(globalThis.clearTimeout(t.timer),null)}function HR(e){let t=BR(e);t.nextRequestId+=1,t.activeRequestId=null,t.activeRequestSignature=null}function UR(e,t){let n=BR(e);return n.activeRequestSignature===t?null:(n.nextRequestId+=1,n.activeRequestId=n.nextRequestId,n.activeRequestSignature=t,n.activeRequestId)}function WR(e,t){return BR(e).activeRequestId===t}function GR(e,t){if(!WR(e,t))return;let n=BR(e);n.activeRequestId=null,n.activeRequestSignature=null}function KR(e){return[e.query,typeof e.offset==`number`&&Number.isFinite(e.offset)?Math.max(0,Math.floor(e.offset)):0,e.append===!0?`append`:`replace`].join(`
`)}function qR(e){let t=e.updateComplete,n=()=>{document.querySelector(`[data-chat-session-picker-search="true"]`)?.focus()};if(t){t.then(n);return}setTimeout(n,0)}function JR(e,t){e.chatSessionPickerOpen=!0,e.chatSessionPickerSurface=t,e.chatSessionPickerError=null,!e.chatSessionPickerResult&&!e.chatSessionPickerAppliedQuery&&tz(e),zR(e),qR(e)}function YR(e){VR(e),e.chatSessionPickerOpen=!1,e.chatSessionPickerSurface=null,zR(e)}function XR(e){VR(e),HR(e),e.chatSessionPickerOpen=!1,e.chatSessionPickerSurface=null,e.chatSessionPickerQuery=``,e.chatSessionPickerAppliedQuery=``,e.chatSessionPickerLoading=!1,e.chatSessionPickerError=null,e.chatSessionPickerResult=null}function ZR(e,t){if(e.chatSessionPickerOpen&&e.chatSessionPickerSurface===t){YR(e);return}JR(e,t)}function QR(e,t={}){let n=Cv(e,{search:t.query,offset:t.offset}),r={includeGlobal:n.includeGlobal,includeUnknown:n.includeUnknown,configuredAgentsOnly:n.configuredAgentsOnly,limit:n.limit},i=F(e.sessionKey),a=e.sessionsResult?.sessions.find(t=>t.key===e.sessionKey),o=a?.kind===`global`||a?.kind===`unknown`||e.sessionKey===`global`||e.sessionKey===`unknown`;(i||!o)&&(r.agentId=L(i?.agentId??e.agentsList?.defaultId??`main`));let s=typeof n.offset==`number`&&Number.isFinite(n.offset)?Math.max(0,Math.floor(n.offset)):0;s>0&&(r.offset=s);let c=C(n.search??void 0);return c&&(r.search=c),r}function $R(e,t){if(e.sessionsShowArchived)return t;let n=t.sessions.filter(e=>e.key&&e.archived!==!0);return{...t,count:n.length,sessions:n}}function ez(e,t){let n=new Map(e.sessions.map(e=>[e.key,e])),r=[...e.sessions];for(let e of t.sessions)n.has(e.key)||(n.set(e.key,e),r.push(e));return{...t,count:r.length,sessions:r,totalCount:t.totalCount??e.totalCount}}async function tz(e,t={}){if(!e.client||!e.connected)return;let n=C(t.query??e.chatSessionPickerAppliedQuery)??``,r=UR(e,KR({append:t.append,offset:t.offset,query:n}));if(r!==null){e.chatSessionPickerLoading=!0,e.chatSessionPickerError=null,zR(e);try{let i=$R(e,await e.client.request(`sessions.list`,QR(e,{query:n,offset:t.offset})));if(!WR(e,r))return;let a=e.chatSessionPickerResult??e.sessionsResult;e.chatSessionPickerResult=t.append===!0&&a?ez(a,i):i,e.chatSessionPickerAppliedQuery=n}catch(t){if(!WR(e,r))return;e.chatSessionPickerError=String(t)}finally{WR(e,r)&&(GR(e,r),e.chatSessionPickerLoading=!1,zR(e))}}}async function nz(e){VR(e);let t=C(e.chatSessionPickerQuery)??``;if(!t){rz(e);return}t===e.chatSessionPickerAppliedQuery&&e.chatSessionPickerResult||await tz(e,{query:t})}function rz(e,t={}){VR(e),HR(e),e.chatSessionPickerQuery=``,e.chatSessionPickerAppliedQuery=``,e.chatSessionPickerError=null,e.chatSessionPickerResult=null,e.chatSessionPickerLoading=!1,zR(e),e.chatSessionPickerOpen&&tz(e),(t.focus??!0)&&qR(e)}function iz(e){VR(e);let t=BR(e);t.timer=globalThis.setTimeout(()=>{t.timer=null,nz(e)},NR)}function az(e,t){e.chatSessionPickerQuery=t;let n=C(t)??``;if(!n){rz(e,{focus:!1});return}n!==e.chatSessionPickerAppliedQuery||!e.chatSessionPickerResult?(HR(e),e.chatSessionPickerError=null,e.chatSessionPickerLoading=!1,iz(e)):VR(e),zR(e)}async function oz(e){let t=e.chatSessionPickerResult,n=LR(t);n!==null&&await tz(e,{query:e.chatSessionPickerAppliedQuery,offset:n,append:!0})}function sz(e,t){return e.sessionsResult?.sessions.find(e=>e.key===t)??e.chatSessionPickerResult?.sessions.find(e=>e.key===t)}function cz(e){return e.chatSessionPickerResult||e.chatSessionPickerAppliedQuery||e.chatSessionPickerOpen?e.chatSessionPickerResult:e.sessionsResult}function lz(e,t){let n=new Map((t?.sessions??[]).map(e=>[e.key,e]));return Uz(e,e.sessionKey,t).flatMap(e=>e.options).filter(e=>n.has(e.key)).map(e=>({row:n.get(e.key),label:e.label}))}function uz(e,t){let n=sz(e,e.sessionKey),r=ER(e.sessionKey,n);return r===e.sessionKey?t.flatMap(e=>e.options).find(t=>t.key===e.sessionKey)?.label??e.sessionKey:r}function dz(e){let t=[C(e.surface),[C(e.modelProvider),C(e.model)].filter(Boolean).join(`/`)].filter(Boolean),n=ml(e.updatedAt,void 0,``);return n&&t.push(n),t.join(` · `)}function fz(e){let{state:t,onSwitchSession:n,surface:r,selectedSessionLabel:i,pickerOpen:a,disabled:o,compact:s}=e,l=`chat-session-picker-${r}`;return c`
    <div class="chat-controls__session chat-controls__session-picker">
      <button
        ...
        ?disabled=${o}
        @click=${()=>ZR(t,r)}
        @keydown=${e=>{(e.key===`ArrowDown`||e.key===`Enter`||e.key===` `)&&(e.preventDefault(),JR(t,r))}}
      >
  ...
  `}function pz(e,n,r){let i=cz(e),a=lz(e,i),o=!e.connected||!e.client,s=(C(e.chatSessionPickerQuery)??``)!==e.chatSessionPickerAppliedQuery,l=o||e.chatSessionPickerLoading||s,u=e.chatSessionPickerQuery.trim()!==``||e.chatSessionPickerAppliedQuery.trim()!==``,d=LR(i),f=a.length,p=i?.totalCount,m=typeof p==`number`&&Number.isFinite(p)?`${f} / ${p}`:String(f);return c`
    <div
      id=${r}
      class="chat-session-picker"
      role="dialog"
      aria-label=${S(`chat.selectors.session`)}
      @keydown=${t=>{t.key===`Escape`&&(t.preventDefault(),t.stopPropagation(),YR(e))}}
    >
      <div class="chat-session-picker__search-row">
        <label class="field chat-session-picker__search">
          <input
            ...
            ?disabled=${o}
            @input=${t=>{az(e,t.target.value)}}
            @keydown=${t=>{t.key===`Enter`&&(t.preventDefault(),nz(e))}}
            @blur=${()=>{C(e.chatSessionPickerQuery)&&nz(e)}}
          />
        </label>
        <button
      ...
      <div class="chat-session-picker__list" role="listbox">
        ...
        ${t(a,e=>e.row.key,t=>{let{row:r,label:i}=t,a=dz(r),o=r.key===e.sessionKey;return c`
              <button
                ...
                title=${i}
                type="button"
                @click=${()=>{YR(e),r.key!==e.sessionKey&&n(e,r.key)}}
              >
  ...
  `}function mz(e){let t=xR(e.modelAuthStatusResult,ME),n=t[0];if(!n)return``;let r=t.find(e=>e.displayName!==n.displayName||e.label!==n.label),i=yR(n.resetAt),a=[[n.displayName,n.label,i?`resets ${i}`:null].filter(Boolean).join(` · `),r?`${r.displayName}${r.label?` ${r.label}`:``} ${r.remaining}% left`:null].filter(Boolean).join(` · `);return c`
    <a
  ...
  `}function hz(e,n,r=Hz(e)){if(r.length<=1)return``;let i=Lz(e,e.sessionKey),a=r.find(e=>e.id===i)?.label??i;return c`
    <label class="field chat-controls__session chat-controls__agent">
      <select
        ...
        .value=${i}
        ?disabled=${!e.connected}
        @change=${t=>{let r=L(t.target.value);r!==i&&n(e,Vz(e,r))}}
      >
  ...
  `}async function gz(e){return ex(e)}function _z(e){let{currentOverride:t,defaultLabel:n,options:r}=vR(e),i=Ez(e),a=bz(e,t),o=e.chatLoading||e.chatSending||!!e.chatRunId||e.chatStream!==null,s=!e.connected||o||!!e.chatModelSwitchPromises?.[e.sessionKey]||e.chatModelsLoading&&r.length===0||!e.client,c=!e.connected||o||!e.client||i.options.length===0&&i.currentOverride===``,l=t===``?n:r.find(e=>e.value===t)?.label??t,u=i.currentOverride===``?i.defaultLabel:i.options.find(e=>e.value===i.currentOverride)?.label??i.currentOverride;return jz({disabled:s,modelOptions:[{value:``,label:n},...r],selectedModelLabel:l,selectedModelValue:t,selectedThinkingLabel:u,selectedThinkingValue:i.currentOverride,fastMode:a,thinkingDisabled:c,thinkingOptions:[{value:``,label:i.defaultLabel},...i.options],onModelSelect:t=>Pz(e,t),onFastModeSelect:t=>Nz(e,t),onThinkingSelect:t=>Iz(e,t)})}function vz(e){let t=e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey);return{provider:t?.modelProvider??e.sessionsResult?.defaults?.modelProvider??null,model:t?.model??e.sessionsResult?.defaults?.model??null}}function yz(e,t){let n=e.trim();if(!n)return null;let r=n.indexOf(`/`);return r>0?n.slice(0,r).toLowerCase():t.find(e=>e.id.trim().toLowerCase()===n.toLowerCase())?.provider.trim().toLowerCase()||null}function bz(e,t){let n=e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey),{provider:r}=vz(e),i=yz(t,e.chatModelCatalog??[])??r?.trim().toLowerCase()??null,a=n?.fastMode===!0?`on`:n?.fastMode===!1?`off`:``,o=!!(i&&MR.has(i)||a);return{currentOverride:a,disabled:!o||!e.connected||e.chatLoading||e.chatSending||!!e.chatRunId||e.chatStream!==null||!e.client,options:[{value:``,label:`Default`},{value:`on`,label:`Fast`},{value:`off`,label:`Standard`}],supported:o}}function xz(e,t){return(!e?.modelProvider||e.modelProvider===t?.modelProvider)&&(!e?.model||e.model===t?.model)}function Sz(e,t){let n=new Set,r=[],i=(e,t)=>{let i=OR(e);pR(r,n,i,()=>AR(i,t))};for(let t of e)i(t.id,t.label);return t&&i(t),r}function Cz(e){return OR(e??``)===`off`}function wz(e){return e.every(e=>Cz(e.id||e.label))}function Tz(e,t,n,r,i){let a=(!e?.modelProvider||e.modelProvider===t?.modelProvider)&&(!e?.model||e.model===t?.model),o=n&&r?i.find(e=>e.provider===n&&e.id===r):void 0,s=(e?.thinkingLevels?.length?e.thinkingLevels:null)??(a&&t?.thinkingLevels?.length?t.thinkingLevels:null);if(s)return o?.reasoning===!1&&wz(s)?[]:s;let c=(e?.thinkingOptions?.length?e.thinkingOptions:null)??(a&&t?.thinkingOptions?.length?t.thinkingOptions:null);return o?.reasoning===!1&&(!c||c.every(Cz))?[]:(c??(n&&r?Hf(n,r):Hf())).map(e=>({id:Vf(e)??w(e),label:e}))}function Ez(e){let t=e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey),n=t?.thinkingLevel,r=typeof n==`string`&&n.trim()?Vf(n)??n.trim():``,i=e.sessionsResult?.defaults,{provider:a,model:o}=vz(e),s=Tz(t,i,a,o,e.chatModelCatalog??[]),c=(!t||xz(t,i))&&i?.thinkingDefault?i.thinkingDefault:void 0,l=t?.thinkingDefault??c??(a&&o?Wf({provider:a,model:o,catalog:e.chatModelCatalog??[]}):`off`),u=s.length===0&&r===`off`?``:r;return{currentOverride:u,defaultLabel:kR(l),options:Sz(s,u)}}function Dz(e){return/^Default \((.+)\)$/u.exec(e)?.[1]??e}function Oz(e,t){return e.value===``&&t?Dz(e.label):e.label}function kz(e){return e.replace(/^Inherited:\s*/u,``)}function Az(e){return e.value===``?`Default`:kz(e.label)}function jz(e){let{disabled:n,fastMode:r,modelOptions:i,selectedModelLabel:a,selectedModelValue:o,selectedThinkingLabel:s,selectedThinkingValue:l,thinkingDisabled:u,thinkingOptions:d,onFastModeSelect:f,onModelSelect:p,onThinkingSelect:m}=e,h=`${Dz(a)} · ${kz(s)}`;return c`
  ...
  `}function Mz(e,t,n){let r=e.sessionsResult;r&&(e.sessionsResult={...r,sessions:r.sessions.map(e=>e.key===t?Object.assign({},e,{fastMode:n}):e)})}async function Nz(e,t){if(!e.client||!e.connected)return;let n=e.sessionKey,r=e.sessionsResult?.sessions?.find(e=>e.key===n)?.fastMode,i=t===``?void 0:t===`on`;if(r!==i){FR(e,null),Mz(e,n,i);try{await e.client.request(`sessions.patch`,{key:n,...Nv(e,n),fastMode:i??null}),await RR(e),Mz(e,n,i)}catch(t){Mz(e,n,r),FR(e,`Failed to set speed: ${String(t)}`)}}}async function Pz(e,t){if(!e.client||!e.connected)return!1;if(hR(e)===t)return!0;let n=e.sessionKey,r=e.chatModelOverrides[n];FR(e,null),e.chatModelOverrides={...e.chatModelOverrides,[n]:Da(t)};let i=e.client,a={},o=()=>{if(e.chatModelSwitchPromises?.[n]===a.current){let t={...e.chatModelSwitchPromises};delete t[n],e.chatModelSwitchPromises=t}},s=(async()=>{try{return await i.request(`sessions.patch`,{key:n,...Nv(e,n),model:t||null}),gz(e),await RR(e),!0}catch(t){return e.chatModelOverrides={...e.chatModelOverrides,[n]:r},FR(e,`Failed to set model: ${String(t)}`),!1}finally{o()}})();return a.current=s,e.chatModelSwitchPromises={...e.chatModelSwitchPromises,[n]:s},s}function Fz(e,t,n){let r=e.sessionsResult;r&&(e.sessionsResult={...r,sessions:r.sessions.map(e=>e.key===t?Object.assign({},e,{thinkingLevel:n}):e)})}async function Iz(e,t){if(!e.client||!e.connected)return;let n=e.sessionKey,r=e.sessionsResult?.sessions?.find(e=>e.key===n)?.thinkingLevel,i=(Vf(t)??t.trim())||void 0,a=typeof r==`string`&&r.trim()?Vf(r)??r.trim():void 0;if((a??``)!==(i??``)){FR(e,null),Fz(e,n,i),e.chatThinkingLevel=i??null;try{await e.client.request(`sessions.patch`,{key:n,...Nv(e,n),thinkingLevel:i??null}),await RR(e),Fz(e,n,i),e.chatThinkingLevel=i??null}catch(t){Fz(e,n,r),e.chatThinkingLevel=a??null,FR(e,`Failed to set thinking level: ${String(t)}`)}}}function Lz(e,t){return L(F(t)?.agentId??e.agentsList?.defaultId??`main`)}function Rz(e,t){return e.kind===`global`||e.kind===`unknown`||DR(e.key)||nu(e.key)||e.spawnedBy?null:L(F(e.key)?.agentId??t)}function zz(e,t){if(!t)return;let n=t.sessions,r=C(e.sessionsResultAgentId),i=L(e.agentsList?.defaultId??`main`),a=new Map;for(let e of n){let t=Rz(e,i);t&&a.set(t,[...a.get(t)??[],e])}if(!(a.size===0&&!r)){e.chatAgentSessionRowsByAgent??={},r&&(e.chatAgentSessionRowsByAgent[r]=a.get(r)??[]);for(let[t,n]of a)e.chatAgentSessionRowsByAgent[t]=n}}function Bz(e,t,n){let r=new Map;for(let n of e.chatAgentSessionRowsByAgent?.[t]??[])r.set(n.key,n);for(let i of e.sessionsResult?.sessions??[])Rz(i,n)===t&&r.set(i.key,i);return[...r.values()]}function Vz(e,t){let n=L(t);if(Lz(e,e.sessionKey)===n)return e.sessionKey;let r=L(e.agentsList?.defaultId??`main`),i=Bz(e,n,r).filter(e=>tu(e.key,n,r)?Rz(e,r)===n:!1).toSorted((e,t)=>(t.updatedAt??0)-(e.updatedAt??0));return i[0]?.key?i[0].key:Zl({agentId:n})}function Hz(e){let t=new Set,n=[],r=r=>{let i=L(r);t.has(i)||(t.add(i),n.push({id:i,label:Wz(e,i)}))};r(Lz(e,e.sessionKey)),r(e.agentsList?.defaultId??`main`);for(let t of e.agentsList?.agents??[])r(t.id);for(let t of e.sessionsResult?.sessions??[]){let e=F(t.key);e&&r(e.agentId)}return n}function Uz(e,t,n){let r=n?.sessions??[],i=e.sessionsHideCron??!0,a=Lz(e,t),o=L(e.agentsList?.defaultId??`main`),s=new Map;for(let e of r)s.set(e.key,e);let c=new Set,l=new Map,u=(e,t)=>{let n=l.get(e);if(n)return n;let r={id:e,label:t,options:[]};return l.set(e,r),r},d=t=>{if(!t||c.has(t))return;c.add(t);let n=s.get(t),r=F(t),i=r?u(`agent:${w(r.agentId)}`,Wz(e,r.agentId)):u(`other`,`Other Sessions`),a=C(r?.rest)??t;i.options.push({key:t,label:Gz(t,n,r?.rest),scopeLabel:a,title:t})};for(let e of r)!tu(e.key,a,o)&&e.key!==t||e.key!==t&&(e.kind===`global`||e.kind===`unknown`)||i&&e.key!==t&&DR(e.key)||(nu(e.key)||e.spawnedBy)&&e.key!==t||d(e.key);(s.has(t)||t)&&d(t);for(let e of l.values()){let t=new Map;for(let n of e.options)t.set(n.label,(t.get(n.label)??0)+1);for(let n of e.options)(t.get(n.label)??0)>1&&n.scopeLabel!==n.label&&(n.label=`${n.label} · ${n.scopeLabel}`)}let f=Array.from(l.values()).flatMap(e=>e.options.map(t=>({groupLabel:e.label,option:t}))),p=new Map(f.map(({option:e})=>[e,e.label])),m=()=>{let e=new Map;for(let{option:t}of f){let n=p.get(t)??t.label;e.set(n,(e.get(n)??0)+1)}return e},h=(e,t)=>{let n=t.trim();return n?e===n||e.endsWith(` · ${n}`)||e.endsWith(` / ${n}`):!1},g=m();for(let{groupLabel:e,option:t}of f){let n=p.get(t)??t.label;if((g.get(n)??0)<=1)continue;let r=`${e} / `;n.startsWith(r)||p.set(t,`${e} / ${n}`)}let _=m();for(let{option:e}of f){let t=p.get(e)??e.label;(_.get(t)??0)<=1||h(t,e.scopeLabel)||p.set(e,`${t} · ${e.scopeLabel}`)}let v=m();for(let{option:e}of f){let t=p.get(e)??e.label;(v.get(t)??0)<=1||p.set(e,`${t} · ${e.key}`)}for(let{option:e}of f)e.label=p.get(e)??e.label;return Array.from(l.values())}function Wz(e,t){let n=w(t),r=(e.agentsList?.agents??[]).find(e=>w(e.id)===n),i=C(r?.identity?.name)??C(r?.name)??``;return i&&i!==t?`${i} (${t})`:t}function Gz(e,t,n){let r=C(n)??e;if(!t)return r;let i=C(t.label)??``,a=C(t.displayName)??``;return i&&i!==e||a&&a!==e?ER(e,t):r}async function Kz(e){e.chatManualRefreshInFlight=!0,e.chatNewMessagesBelow=!1,await e.updateComplete,e.resetToolStream();try{await Hy(e,{awaitHistory:!0,scheduleScroll:!1}),e.scrollToBottom({smooth:!0})}finally{requestAnimationFrame(()=>{e.chatManualRefreshInFlight=!1,e.chatNewMessagesBelow=!1})}}function qz(e){return Ee(e)}function Jz(e){let t=eu(e.sessionKey),n=e.agentsList?.agents.find(e=>w(e.id)===t);return{agentLabel:C(n?.identity?.name)??C(n?.name)??t}}function Yz(e){let t=e.hello?.snapshot;return C(t?.sessionDefaults?.mainSessionKey)||C(t?.sessionDefaults?.mainKey)||`main`}function Xz(e,t){let n=e.chatQueueBySession??={};if(e.chatQueue.length>0){n[t]=[...e.chatQueue],e.chatQueueBySession={...n};return}Object.hasOwn(n,t)&&(delete n[t],e.chatQueueBySession={...n})}function Zz(e,t){return[...e.chatQueueBySession?.[t]??[]]}function Qz(e,t){let n=e,r=e.sessionKey;yd(e,r),Xz(e,r),e.sessionKey=t,r!==t&&XR(e),e.currentSessionId=null,e.chatMessage=``,e.chatAttachments=[],e.chatMessages=[],e.chatToolMessages=[],e.activityEntries=[],e.activityExpandedIds=new Set,e.activityAtBottom=!0,e.chatStreamSegments=[],e.chatThinkingLevel=null,e.chatStream=null,e.chatSideResult=null,e.lastError=null,e.chatError=null,e.chatAvatarUrl=null,e.chatAvatarSource=null,e.chatAvatarStatus=null,e.chatAvatarReason=null,e.realtimeTalkTranscript=null,e.resetRealtimeTalkConversation?.(),e.chatQueue=Zz(e,t),Sd(e),n.resetChatInputHistoryNavigation(),n.chatStreamStartedAt=null,Pf(e,{clearLocalRun:!0,clearChatStream:!0,clearToolStream:!0,clearSideResultTerminalRuns:!0,clearRunStatus:!0}),n.resetChatScroll(),e.applySettings({...e.settings,sessionKey:t,lastActiveSessionKey:t})}function $z(e){return!e.chatLoading&&!e.chatSending&&!e.chatRunId&&e.chatStream===null&&e.chatQueue.length===0}var eB=`Start a new session after the active run or queued messages finish.`,tB=`Session list is still refreshing. Try New Chat again in a moment.`,nB=`New Chat could not create a new session. Try again in a moment.`;function rB(e,t,n){let r=Wi(t,e.basePath),i=t===`config`?Gi(e.tab):e.tab===t,a=n?.collapsed??e.settings.navCollapsed;return c`
    <a
      href=${r}
      class="nav-item ${i?`nav-item--active`:``}"
      @click=${n=>{n.defaultPrevented||n.button!==0||n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||(n.preventDefault(),t===`chat`&&(e.sessionKey||Qz(e,Yz(e)),e.tab!==`chat`&&e.loadAssistantIdentity()),e.setTab(t))}}
      title=${Yi(t)}
    >
      <span class="nav-item__icon" aria-hidden="true">${q[Ji(t)]}</span>
      ${a?d:c`<span class="nav-item__text">${Yi(t)}</span>`}
    </a>
  `}function iB(e){return c`
  ...
  `}function aB(e){switch(e){case`always`:return S(`chat.autoScrollAlways`);case`off`:return S(`chat.autoScrollOff`);case`near-bottom`:return S(`chat.autoScrollNearBottom`)}return S(`chat.autoScrollNearBottom`)}function oB(e){switch(e){case`near-bottom`:return`always`;case`always`:return`off`;case`off`:return`near-bottom`}return`near-bottom`}function sB(e,t={}){let n=Xo(e.settings.chatAutoScroll),r=`${S(`chat.autoScrollMode`)}: ${aB(n)}`,i=n!==`off`;return c`
    <button
      ...
      aria-pressed=${i}
      title=${r}
      @click=${()=>{e.applySettings({...e.settings,chatAutoScroll:oB(n)})}}
    >
      ${q.scrollText}
      ${t.labelled?c`<span class="chat-settings-action__text">${S(`chat.autoScrollMode`)}</span>`:``}
    </button>
  `}function cB(e){let t=e.sessionsHideCron??!0,n=t?hB(e,e.sessionsResult):0,r=e.onboarding,i=e.onboarding?!1:e.settings.chatShowThinking,a=e.onboarding?!0:e.settings.chatShowToolCalls,o=S(r?`chat.onboardingDisabled`:`chat.thinkingToggle`),s=S(r?`chat.onboardingDisabled`:`chat.toolCallsToggle`),l=!e.connected||e.chatManualRefreshInFlight||e.chatLoading||e.chatSending||e.chatStream!==null||!!e.chatRunId,u=t?n>0?S(`chat.showCronSessionsHidden`,{count:String(n)}):S(`chat.showCronSessions`):S(`chat.hideCronSessions`),d=c`
    <svg
      width="18"
      height="18"
      viewBox="0 0 24 24"
  ...
  `}function lB(e,t,n){let r=e.sessionKey,i=e.sessionsResult,a=ER(t,e.sessionsResult?.sessions.find(e=>e.key===t)??e.chatSessionPickerResult?.sessions.find(e=>e.key===t));Qz(e,t),r!==t&&e.announceSessionSwitch?.(t,a),e.loadAssistantIdentity(),sb(e),Jp({client:e.client,agentId:F(t)?.agentId}),lI(e,t,!0);let o=mv(e),s=qg(e);if(ky(e,t,s,mB(e),i),n?.awaitInitialLoad)return Promise.allSettled([o,s]).then(()=>void 0)}function uB(e,t){lB(e,t)}function dB(e,t){return lB(e,t,{awaitInitialLoad:!0})??Promise.resolve()}function fB(e){if(e.lastError=null,e.lastErrorCode=null,e.chatError=null,e.realtimeTalkStatus===`error`){let t=e;t.realtimeTalkSession?.stop(),t.realtimeTalkSession=null,e.realtimeTalkActive=!1,e.realtimeTalkStatus=`idle`,e.realtimeTalkDetail=null,e.realtimeTalkTranscript=null,e.resetRealtimeTalkConversation?.()}}async function pB(e,t){if(t?.source!==`user`||!e.client||!e.connected)return!1;if(!$z(e))return e.lastError=eB,e.chatError=e.lastError,!1;if(e.sessionsLoading)return e.lastError=tB,e.chatError=e.lastError,!1;e.lastError=null,e.chatError=null;let n=e.sessionKey,r=e.sessionsResult?.sessions.some(e=>e.key===n)?n:void 0,i=await _v(e,{agentId:Nv(e,n).agentId??eu(n),parentSessionKey:r,emitCommandHooks:r===void 0?void 0:!0},{...Cv(e),...Pv(e,n)});if(!i||e.sessionKey!==n||!$z(e))return i||(e.lastError=e.sessionsError??(e.sessionsLoading?tB:nB),e.chatError=e.lastError),!1;let a=e.chatMessage,o=e.chatAttachments;return uB(e,i),e.chatMessage=a,e.chatAttachments=o,!0}async function mB(e){await H(e,{...Cv(e),...Pv(e,e.sessionKey)})}function hB(e,t){if(!t?.sessions)return 0;let n=L(F(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`),r=L(e.agentsList?.defaultId??`main`);return t.sessions.filter(t=>DR(t.key)&&t.key!==e.sessionKey&&tu(t.key,n,r)).length}var gB=[{id:`system`,labelKey:`common.system`,short:`SYS`},{id:`light`,labelKey:`common.light`,short:`LIGHT`},{id:`dark`,labelKey:`common.dark`,short:`DARK`}];function _B(e){let t=e=>e===`system`?q.monitor:e===`light`?q.sun:q.moon,n=(t,n)=>{t!==e.themeMode&&e.setThemeMode(t,{element:n.currentTarget})};return c`
    <div class="topbar-theme-mode" role="group" aria-label=${S(`common.colorMode`)}>
      ${gB.map(r=>{let i=S(`common.colorModeOption`,{mode:S(r.labelKey)});return c`
          <button
            type="button"
  ...
  `}function vB(e){let t=e.connected?S(`common.online`):S(`common.offline`);return c`
    <span
    ...
    ></span>
  `}function yB(e,t){let n={mod:null,promise:null,error:void 0,hasError:!1},r=()=>{n.promise=e().then(e=>{n.mod=e,n.error=void 0,n.hasError=!1},e=>{n.error=e,n.hasError=!0,n.promise=null}).finally(()=>{t?.()})};return{read:()=>n.mod===null?(!n.promise&&!n.hasError&&r(),null):n.mod,retry:()=>{n.mod===null&&(n.error=void 0,n.hasError=!1,n.promise=null,r(),t?.())},error:()=>n.error,hasError:()=>n.hasError,pending:()=>n.promise!==null}}function bB(e){return e instanceof Error&&e.message.trim()?e.message:typeof e==`string`&&e.trim()?e.trim():S(`lazyView.unknownError`)}function xB(e,t){let n=e.read();if(n!==null)return t(n);if(e.hasError()){let t=e.error();return c`
      <section class="card lazy-view-state lazy-view-state--error">
        ...
        <div class="callout danger" style="margin-top: 12px;">${bB(t)}</div>
  ...
  `}function SB(e,t){if(!e)return t;if(!t)return e;let n={fresh:0,partial:1,stale:2,refreshing:3};return{status:n[t.status]>n[e.status]?t.status:e.status,cachedFiles:Math.max(e.cachedFiles,t.cachedFiles),pendingFiles:Math.max(e.pendingFiles,t.pendingFiles),staleFiles:Math.max(e.staleFiles,t.staleFiles),refreshedAt:Math.max(e.refreshedAt??0,t.refreshedAt??0)||void 0}}var CB=null,wB=e=>{CB&&clearTimeout(CB),CB=window.setTimeout(()=>void kw(e),400)};function TB(e,t){return e.tab===`usage`?xB(t,({renderUsage:t})=>t({data:{loading:e.usageLoading,error:e.usageError,sessions:e.usageResult?.sessions??[],agents:e.agentsList?.agents.map(e=>e.id).filter(Boolean)??[],sessionsLimitReached:(e.usageResult?.sessions?.length??0)>=1e3,totals:e.usageResult?.totals??null,aggregates:e.usageResult?.aggregates??null,costDaily:e.usageCostSummary?.daily??[],cacheStatus:SB(e.usageResult?.cacheStatus,e.usageCostSummary?.cacheStatus)},filters:{startDate:e.usageStartDate,endDate:e.usageEndDate,scope:e.usageScope,selectedSessions:e.usageSelectedSessions,selectedDays:e.usageSelectedDays,selectedHours:e.usageSelectedHours,agentId:e.usageAgentId,query:e.usageQuery,queryDraft:e.usageQueryDraft,timeZone:e.usageTimeZone},display:{chartMode:e.usageChartMode,dailyChartMode:e.usageDailyChartMode,sessionSort:e.usageSessionSort,sessionSortDir:e.usageSessionSortDir,recentSessions:e.usageRecentSessions,sessionsTab:e.usageSessionsTab,visibleColumns:e.usageVisibleColumns,contextExpanded:e.usageContextExpanded,headerPinned:e.usageHeaderPinned},detail:{timeSeriesMode:e.usageTimeSeriesMode,timeSeriesBreakdownMode:e.usageTimeSeriesBreakdownMode,timeSeries:e.usageTimeSeries,timeSeriesLoading:e.usageTimeSeriesLoading,timeSeriesCursorStart:e.usageTimeSeriesCursorStart,timeSeriesCursorEnd:e.usageTimeSeriesCursorEnd,sessionLogs:e.usageSessionLogs,sessionLogsLoading:e.usageSessionLogsLoading,sessionLogsExpanded:e.usageSessionLogsExpanded,logFilters:{roles:e.usageLogFilterRoles,tools:e.usageLogFilterTools,hasTools:e.usageLogFilterHasTools,query:e.usageLogFilterQuery}},callbacks:{filters:{onStartDateChange:t=>{e.usageStartDate=t,e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],wB(e)},onEndDateChange:t=>{e.usageEndDate=t,e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],wB(e)},onScopeChange:t=>{e.usageScope=t,e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],e.usageTimeSeries=null,e.usageSessionLogs=null,kw(e)},onAgentChange:t=>{e.usageAgentId=t,e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],e.usageTimeSeries=null,e.usageSessionLogs=null,kw(e)},onRefresh:()=>void kw(e),onTimeZoneChange:t=>{e.usageTimeZone=t,e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],kw(e)},onToggleHeaderPinned:()=>{e.usageHeaderPinned=!e.usageHeaderPinned},onSelectHour:(t,n)=>{if(n&&e.usageSelectedHours.length>0){let n=Array.from({length:24},(e,t)=>t),r=e.usageSelectedHours[e.usageSelectedHours.length-1],i=n.indexOf(r),a=n.indexOf(t);if(i!==-1&&a!==-1){let[t,r]=i<a?[i,a]:[a,i],o=n.slice(t,r+1);e.usageSelectedHours=[...new Set([...e.usageSelectedHours,...o])]}}else e.usageSelectedHours.includes(t)?e.usageSelectedHours=e.usageSelectedHours.filter(e=>e!==t):e.usageSelectedHours=[...e.usageSelectedHours,t]},onQueryDraftChange:t=>{e.usageQueryDraft=t,e.usageQueryDebounceTimer&&window.clearTimeout(e.usageQueryDebounceTimer),e.usageQueryDebounceTimer=window.setTimeout(()=>{e.usageQuery=e.usageQueryDraft,e.usageQueryDebounceTimer=null},250)},onApplyQuery:()=>{e.usageQueryDebounceTimer&&=(window.clearTimeout(e.usageQueryDebounceTimer),null),e.usageQuery=e.usageQueryDraft},onClearQuery:()=>{e.usageQueryDebounceTimer&&=(window.clearTimeout(e.usageQueryDebounceTimer),null),e.usageQueryDraft=``,e.usageQuery=``},onSelectDay:(t,n)=>{if(n&&e.usageSelectedDays.length>0){let n=(e.usageCostSummary?.daily??[]).map(e=>e.date),r=e.usageSelectedDays[e.usageSelectedDays.length-1],i=n.indexOf(r),a=n.indexOf(t);if(i!==-1&&a!==-1){let[t,r]=i<a?[i,a]:[a,i],o=n.slice(t,r+1);e.usageSelectedDays=[...new Set([...e.usageSelectedDays,...o])]}}else e.usageSelectedDays.includes(t)?e.usageSelectedDays=e.usageSelectedDays.filter(e=>e!==t):e.usageSelectedDays=[t]},onClearDays:()=>{e.usageSelectedDays=[]},onClearHours:()=>{e.usageSelectedHours=[]},onClearSessions:()=>{e.usageSelectedSessions=[],e.usageTimeSeries=null,e.usageSessionLogs=null},onClearFilters:()=>{e.usageSelectedDays=[],e.usageSelectedHours=[],e.usageSelectedSessions=[],e.usageTimeSeries=null,e.usageSessionLogs=null}},display:{onChartModeChange:t=>{e.usageChartMode=t},onDailyChartModeChange:t=>{e.usageDailyChartMode=t},onSessionSortChange:t=>{e.usageSessionSort=t},onSessionSortDirChange:t=>{e.usageSessionSortDir=t},onSessionsTabChange:t=>{e.usageSessionsTab=t},onToggleColumn:t=>{e.usageVisibleColumns.includes(t)?e.usageVisibleColumns=e.usageVisibleColumns.filter(e=>e!==t):e.usageVisibleColumns=[...e.usageVisibleColumns,t]}},details:{onToggleContextExpanded:()=>{e.usageContextExpanded=!e.usageContextExpanded},onToggleSessionLogsExpanded:()=>{e.usageSessionLogsExpanded=!e.usageSessionLogsExpanded},onLogFilterRolesChange:t=>{e.usageLogFilterRoles=t},onLogFilterToolsChange:t=>{e.usageLogFilterTools=t},onLogFilterHasToolsChange:t=>{e.usageLogFilterHasTools=t},onLogFilterQueryChange:t=>{e.usageLogFilterQuery=t},onLogFilterClear:()=>{e.usageLogFilterRoles=[],e.usageLogFilterTools=[],e.usageLogFilterHasTools=!1,e.usageLogFilterQuery=``},onSelectSession:(t,n)=>{if(e.usageTimeSeries=null,e.usageSessionLogs=null,e.usageRecentSessions=[t,...e.usageRecentSessions.filter(e=>e!==t)].slice(0,8),n&&e.usageSelectedSessions.length>0){let n=e.usageChartMode===`tokens`,r=[...e.usageResult?.sessions??[]].toSorted((e,t)=>{let r=n?e.usage?.totalTokens??0:e.usage?.totalCost??0;return(n?t.usage?.totalTokens??0:t.usage?.totalCost??0)-r}).map(e=>e.key),i=e.usageSelectedSessions[e.usageSelectedSessions.length-1],a=r.indexOf(i),o=r.indexOf(t);if(a!==-1&&o!==-1){let[t,n]=a<o?[a,o]:[o,a],i=r.slice(t,n+1);e.usageSelectedSessions=[...new Set([...e.usageSelectedSessions,...i])]}}else e.usageSelectedSessions.length===1&&e.usageSelectedSessions[0]===t?e.usageSelectedSessions=[]:e.usageSelectedSessions=[t];e.usageTimeSeriesCursorStart=null,e.usageTimeSeriesCursorEnd=null,e.usageSelectedSessions.length===1&&(jw(e,e.usageSelectedSessions[0]),Mw(e,e.usageSelectedSessions[0]))},onTimeSeriesModeChange:t=>{e.usageTimeSeriesMode=t},onTimeSeriesBreakdownChange:t=>{e.usageTimeSeriesBreakdownMode=t},onTimeSeriesCursorRangeChange:(t,n)=>{e.usageTimeSeriesCursorStart=t,e.usageTimeSeriesCursorEnd=n}}}})):d}var EB=[`noopener`,`noreferrer`],DB=`_blank`;function OB(e){let t=[],n=new Set(EB);for(let r of(e??``).split(/\s+/)){let e=x(r);!e||n.has(e)||(n.add(e),t.push(e))}return[...EB,...t].join(` `)}var kB=class extends i{constructor(...e){super(...e),this.tab=`overview`,this.basePath=``,this.agentLabel=``,this.handleOverviewClick=e=>{e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),this.dispatchEvent(new CustomEvent(`navigate`,{detail:`overview`,bubbles:!0,composed:!0})))}}createRenderRoot(){return this}render(){let e=Yi(this.tab),t=this.agentLabel.trim();return c`
    ...
    `}};Y([r()],kB.prototype,`tab`,void 0),Y([r()],kB.prototype,`basePath`,void 0),Y([r()],kB.prototype,`agentLabel`,void 0),customElements.get(`dashboard-header`)||customElements.define(`dashboard-header`,kB);function AB(){return zp.map(e=>({id:`slash:${e.name}`,label:`/${e.name}`,icon:e.icon??`terminal`,category:`search`,action:`/${e.name}`,description:e.description}))}function jB(){return[{id:`nav-overview`,label:S(`overview.palette.items.overview`),icon:`barChart`,category:`navigation`,action:`nav:overview`},{id:`nav-sessions`,label:S(`overview.palette.items.sessions`),icon:`fileText`,category:`navigation`,action:`nav:sessions`},{id:`nav-cron`,label:S(`overview.palette.items.scheduled`),icon:`scrollText`,category:`navigation`,action:`nav:cron`},{id:`nav-skills`,label:S(`overview.palette.items.skills`),icon:`zap`,category:`navigation`,action:`nav:skills`},{id:`nav-config`,label:S(`overview.palette.items.settings`),icon:`settings`,category:`navigation`,action:`nav:config`},{id:`nav-agents`,label:S(`overview.palette.items.agents`),icon:`folder`,category:`navigation`,action:`nav:agents`},{id:`skill-shell`,label:S(`overview.palette.items.shellCommand`),icon:`monitor`,category:`skills`,action:`/skill shell`,description:S(`overview.palette.descriptions.shellCommand`)},{id:`skill-debug`,label:S(`overview.palette.items.debugMode`),icon:`bug`,category:`skills`,action:`/verbose full`,description:S(`overview.palette.descriptions.debugMode`)}]}function MB(){return[...AB(),...jB()]}function NB(e){let t=MB();if(!e)return t;let n=w(e);return t.filter(e=>w(e.label).includes(n)||w(e.description).includes(n))}function PB(e){let t=new Map;for(let n of e){let e=t.get(n.category)??[];e.push(n),t.set(n.category,e)}return[...t.entries()]}var FB=null,IB=null,LB=null,RB=[`a[href]`,`button:not([disabled])`,`input:not([disabled])`,`select:not([disabled])`,`textarea:not([disabled])`,`summary`,`[tabindex]:not([tabindex='-1'])`].join(`,`),zB=`cmd-palette-label`,BB=`cmd-palette-input`,VB=`cmd-palette-listbox`;function HB(){FB||=document.activeElement}function UB(){let e=FB;FB=null,IB=null,e instanceof HTMLElement&&e.isConnected&&requestAnimationFrame(()=>{e.isConnected&&e.focus()})}function WB(e,t){e.action.startsWith(`nav:`)?t.onNavigate(e.action.slice(4)):t.onSlashCommand(e.action),t.onToggle(),UB()}function GB(e){IB&&(e.onToggle(),UB())}function KB(){requestAnimationFrame(()=>{document.querySelector(`.cmd-palette__item--active`)?.scrollIntoView({block:`nearest`})})}function qB(e,t){let n=[...t.querySelectorAll(RB)].filter(e=>e.isConnected&&e.tabIndex>=0&&!e.closest(`[hidden]`));if(n.length===0){e.preventDefault(),t.focus();return}let r=document.activeElement instanceof HTMLElement?document.activeElement:null,i=n[0],a=n[n.length-1],o=r?n.includes(r):!1;if(e.shiftKey&&(!o||r===i)){e.preventDefault(),a.focus();return}!e.shiftKey&&(!o||r===a)&&(e.preventDefault(),i.focus())}function JB(e,t){if(e.key===`Tab`){let t=e.currentTarget?.closest(`dialog`);t instanceof HTMLElement&&qB(e,t);return}let n=NB(t.query);if(!(n.length===0&&(e.key===`ArrowDown`||e.key===`ArrowUp`||e.key===`Enter`)))switch(e.key){case`ArrowDown`:e.preventDefault(),t.onActiveIndexChange((t.activeIndex+1)%n.length),KB();break;case`ArrowUp`:e.preventDefault(),t.onActiveIndexChange((t.activeIndex-1+n.length)%n.length),KB();break;case`Enter`:e.preventDefault(),n[t.activeIndex]&&WB(n[t.activeIndex],t);break;case`Escape`:e.preventDefault(),e.stopPropagation(),GB(t);break}}function YB(e){switch(e){case`search`:return S(`overview.palette.categories.search`);case`navigation`:return S(`overview.palette.categories.navigation`);case`skills`:return S(`overview.palette.categories.skills`);default:return e}}function XB(e){return`cmd-palette-option-${e.id.replace(/[^a-zA-Z0-9_-]/g,`-`)}`}function ZB(e){if(!(e instanceof HTMLDialogElement)){IB&&UB();return}if(IB!==e&&(HB(),IB=e,LB?.onOpen?.()),!e.open){if(typeof e.showModal==`function`)try{e.removeAttribute(`aria-modal`),e.showModal();return}catch{}e.setAttribute(`aria-modal`,`true`),e.setAttribute(`open`,``)}}function QB(e){e instanceof HTMLInputElement&&requestAnimationFrame(()=>{e.isConnected&&e.focus()})}function $B(e){if(!e.open)return d;LB=e;let t=NB(e.query),n=PB(t),r=t[e.activeIndex],i=r?XB(r):d,a=S(`overview.palette.placeholder`);return c`
    <dialog
      ${u(ZB)}
      class="cmd-palette-overlay"
      aria-labelledby=${zB}
      @cancel=${t=>{t.preventDefault(),GB(e)}}
      @click=${t=>{t.target===t.currentTarget&&GB(e)}}
    >
      <div
        class="cmd-palette"
        ...
        @keydown=${t=>JB(t,e)}
      >
        <label id=${zB} class="cmd-palette__label" for=${BB}
          >${a}</label
        >
        <input
          ${u(QB)}
        ...
        />
        <div id=${VB} class="cmd-palette__results" role="listbox">
          ${n.length===0?c`<div class="cmd-palette__empty">
                ...
                <span>${S(`overview.palette.noResults`)}</span>
                  ...
                  <div class="cmd-palette__group-label">${YB(n)}</div>
                  ${r.map(n=>{let r=t.indexOf(n),i=r===e.activeIndex;return c`
                      <div
                        ...
                        @click=${t=>{t.stopPropagation(),WB(n,e)}}
  ...
  `}function pV(e){let t=C(e.assistantAvatarOverride);return t?eo(t,{identity:{avatar:t,avatarUrl:t}}):e.assistantAvatarStatus===`none`&&e.assistantAvatarReason===`missing`?null:eo(e.assistantAvatarUrl,{identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}})}function mV(e){let t=C(e);return t?/^data:image\//i.test(t)?`${t.slice(0,t.indexOf(`,`)>0?t.indexOf(`,`):32)},...`:t.length>72?`${t.slice(0,34)}...${t.slice(-24)}`:t:null}function hV(e,t,n,r=!1){return r?null:e===`remote`?`Remote URLs are blocked by Control UI image policy`:t===`missing`?`File not found`:t===`unsupported_extension`?`Unsupported image type`:t===`outside_workspace`?`Outside workspace`:t===`too_large`?`Image is too large`:t?`Cannot render avatar`:null}function gV(e){let t=C(e.assistantName)??`Assistant`,n=C(e.assistantAvatarOverride),r=pV(e);if(r)return c`<img class="qs-assistant-avatar" src=${r} alt=${t} />`;let i=ao(n??e.assistantAvatar);return i?c`<div
    ...
    <img
      ...
      alt=${t}
    />
  `}function _V(e,t){let n=e.target,r=n.files?.[0],i=t.onUserAvatarChange;if(!r||!i){n.value=``;return}if(!r.type.startsWith(`image/`)){n.value=``;return}if(r.size>lV){n.value=``;return}let a=new FileReader;a.addEventListener(`load`,()=>{i(typeof a.result==`string`?a.result:null)}),a.readAsDataURL(r),n.value=``}function vV(e,t){let n=e.target,r=n.files?.[0],i=t.onAssistantAvatarOverrideChange;if(!r||!i){n.value=``;return}if(r.size>uV){n.value=``;return}let a=new FileReader;a.addEventListener(`load`,()=>{let e=typeof a.result==`string`?a.result:``;e&&i(e)}),a.readAsDataURL(r),n.value=``}var yV={bootstrapMaxChars:2e4,bootstrapTotalMaxChars:6e4,contextInjection:`always`};function bV(e){let t=e?.agents?.defaults;return{bootstrapMaxChars:typeof t?.bootstrapMaxChars==`number`&&Number.isFinite(t.bootstrapMaxChars)?Math.floor(t.bootstrapMaxChars):yV.bootstrapMaxChars,bootstrapTotalMaxChars:typeof t?.bootstrapTotalMaxChars==`number`&&Number.isFinite(t.bootstrapTotalMaxChars)?Math.floor(t.bootstrapTotalMaxChars):yV.bootstrapTotalMaxChars,contextInjection:t?.contextInjection===`continuation-skip`?`continuation-skip`:`always`}}function xV(e,t){return e.bootstrapMaxChars===t.bootstrapMaxChars&&e.bootstrapTotalMaxChars===t.bootstrapTotalMaxChars&&e.contextInjection===t.contextInjection}function SV(e){return`${e.toLocaleString()} chars`}function CV(e){return e===`always`?`Every turn`:`Skip safe follow-ups`}function wV(e){return e===`always`?`Reinject workspace bootstrap context on every turn.`:`Skip bootstrap reinjection after a completed safe follow-up.`}function TV(e){let t=e.value!==e.previousValue;return c`
  ...
  `}function DV(e){return c`
    <div class="qs-card qs-card--model">
      ${EV(q.brain,`Model & Thinking`)}
  ...
  `}function OV(e){let t=e.channels.filter(e=>e.connected).length,n=t>0?c`<span class="qs-badge qs-badge--ok">${t} connected</span>`:void 0;return c`
    <div class="qs-card qs-card--channels">
      ${EV(q.send,`Channels`,n)}
      <div class="qs-card__body">
  ...
  `}function kV(e){let{cronJobCount:t,skillCount:n,mcpServerCount:r}=e.automation;return c`
    <div class="qs-card qs-card--automations">
      ${EV(q.zap,`Automations`)}
      <div class="qs-card__body">
        <div class="qs-row">
          <span class="qs-row__label">
  ...
  `}function AV(e){let{gatewayAuth:t,execPolicy:n,deviceAuth:r,browserEnabled:i,toolProfile:a}=e.security,o=a.trim()||`full`,s=sV.includes(o)?sV:[...sV,o];return c`
    <div class="qs-card qs-card--security">
      ${EV(q.eye,`Security`,c`<button class="qs-link-btn" @click=${e.onSecurityConfigure}>Configure →</button>`)}
      <div class="qs-card__body">
        <div class="qs-row">
  ...
  `}function jV(e){let t=e.hasCustomTheme?e.customThemeLabel??`Imported theme`:`Import`,n=[...rV,{id:`custom`,label:t}];return c`
    <div class="qs-card qs-card--appearance">
      ${EV(q.spark,`Appearance`)}
      <div class="qs-card__body">
        <div class="qs-row">
  ...
  `}function MV(e){let t=Fo({name:null,avatar:e.userAvatar??null}),n=zo(t)??``,r=C(e.assistantName)??`Assistant`,i=!!(pV(e)||ao(e.assistantAvatarOverride??e.assistantAvatar)),a=C(e.assistantAvatarOverride),o=mV(a??e.assistantAvatarSource),s=hV(e.assistantAvatarStatus??null,e.assistantAvatarReason,i,!!a),l=a?`UI override`:`IDENTITY.md`,u=!!e.onAssistantAvatarOverrideChange,f=a?`Override from settings`:s?`Fallback avatar`:i?`From IDENTITY.md`:`Fallback logo`;return c`
        ...
        <div class="qs-identity-grid">
          <section class="qs-identity-card" aria-label="Your local chat identity">
            ...
            <div class="qs-identity-card__copy">
              ...
              <div class="qs-identity-card__title">${cV}</div>
  ...
  `}function NV(e){let t=e.configObject??e.savedConfigObject??{},n=e.savedConfigObject??{},r=nV(t),i=nV(n),a=r?tV(r):void 0,o=i?tV(i):void 0,s=bV(t),l=bV(n),u=!xV(s,l),f=e.configDirty===!0,p=e.connected&&e.configReady===!0&&e.configSaving!==!0&&e.configApplying!==!0,m=u?c`
    ...
    <div class="qs-card qs-card--span-all">
      ${EV(q.zap,`Context Profile`,u?c`<span class="qs-badge qs-badge--warn">Pending</span>`:o?c`<span class="qs-badge qs-badge--ok">Saved</span>`:c`<span class="qs-badge">Custom</span>`)}
      <div class="qs-card__body qs-profiles">
        <div class="qs-profiles__copy">
          ...
          <div class="qs-presets-grid">
            ${eV.map(t=>{let n=t.patch.agents?.defaults??{},a=n.contextInjection===`continuation-skip`?`continuation-skip`:`always`;return c`
                <button
                  type="button"
                ...
                >
                  ...
                  <div class="qs-preset__meta">
                    <span
                      >${SV(Number(n.bootstrapMaxChars??0))} per
                      file</span
                    >
                    <span
                      >${SV(Number(n.bootstrapTotalMaxChars??0))}
                      total</span
                    >
                    <span>${CV(a)}</span>
                  </div>
        ...
        <div class="qs-profile-panel">
          ...
          <div class="qs-profile-panel__stats">
            ${TV({label:`Bootstrap Per File`,value:SV(s.bootstrapMaxChars),previousValue:SV(l.bootstrapMaxChars),note:`Maximum context injected from any single bootstrap file.`})}
            ${TV({label:`Bootstrap Total`,value:SV(s.bootstrapTotalMaxChars),previousValue:SV(l.bootstrapTotalMaxChars),note:`Total combined context allowed across all bootstrap files.`})}
            ${TV({label:`Follow-up Turns`,value:CV(s.contextInjection),previousValue:CV(l.contextInjection),note:wV(s.contextInjection)})}
          </div>
  ...
  `}var IV=new Set([`title`,`description`,`default`,`nullable`,`tags`,`x-tags`]);function LV(e){return Object.keys(e??{}).filter(e=>!IV.has(e)).length===0}function RV(e){if(e===void 0)return``;try{return JSON.stringify(e,null,2)??``}catch{return``}}function zV(e){return typeof e==`string`||typeof e==`number`||typeof e==`boolean`||typeof e==`bigint`?String(e):null}function BV(e,t){if(Object.is(e,t))return!0;let n=zV(e),r=zV(t);return n!==null&&n===r}var VV={chevronDown:c`
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  `};function HV(e){if(!e||typeof e!=`object`||Array.isArray(e))return!1;let t=e;return typeof t.source!=`string`||typeof t.id!=`string`?!1:t.provider===void 0||typeof t.provider==`string`}function UV(e){let t=Pn(e.value,e.path,e.hints),n=t&&(e.revealSensitive||(e.isSensitivePathRevealed?.(e.path)??!1));return{isSensitive:t,isRedacted:t&&!n,isRevealed:n,canReveal:t}}function WV(e){let{state:t}=e;return!t.isSensitive||!e.onToggleSensitivePath?d:c`
    <button
      type="button"
  ...
  `}function GV(e){return!!(e&&(e.text.length>0||e.tags.length>0))}function KV(e){let t=[],n=new Set;return{text:w(e.trim().replace(/(^|\s)tag:([^\s]+)/gi,(e,r,i)=>{let a=w(i);return a&&!n.has(a)&&(n.add(a),t.push(a)),r})),tags:t}}function qV(e){if(!Array.isArray(e))return[];let t=new Set,n=[];for(let r of e){if(typeof r!=`string`)continue;let e=r.trim();if(!e)continue;let i=w(e);t.has(i)||(t.add(i),n.push(e))}return n}function JV(e,t,n){let r=bn(e,n),i=r?.label??t.title??xn(String(e.at(-1))),a=r?.help??t.description,o=qV(t[`x-tags`]??t.tags),s=qV(r?.tags);return{label:i,help:a,tags:s.length>0?s:o}}function YV(e,t){if(!e)return!0;for(let n of t)if(x(n)?.includes(e))return!0;return!1}function XV(e,t){if(e.length===0)return!0;let n=new Set(t.map(e=>w(e)));return e.every(e=>n.has(e))}function ZV(e){let{schema:t,path:n,hints:r,criteria:i}=e;if(!GV(i))return!0;let{label:a,help:o,tags:s}=JV(n,t,r);if(!XV(i.tags,s))return!1;if(!i.text)return!0;let c=n.filter(e=>typeof e==`string`).join(`.`),l=t.enum&&t.enum.length>0?t.enum.map(e=>String(e)).join(` `):``;return YV(i.text,[a,o,t.title,t.description,c,l])}function QV(e){let{schema:t,value:n,path:r,hints:i,criteria:a}=e;if(!GV(a)||ZV({schema:t,path:r,hints:i,criteria:a}))return!0;let o=N(t);if(o===`object`){let e=n??t.default,o=e&&typeof e==`object`&&!Array.isArray(e)?e:{},s=t.properties??{};for(let[e,t]of Object.entries(s))if(QV({schema:t,value:o[e],path:[...r,e],hints:i,criteria:a}))return!0;let c=t.additionalProperties;if(c&&typeof c==`object`){let e=new Set(Object.keys(s));for(let[t,n]of Object.entries(o))if(!e.has(t)&&QV({schema:c,value:n,path:[...r,t],hints:i,criteria:a}))return!0}return!1}if(o===`array`){let e=Array.isArray(t.items)?t.items[0]:t.items;if(!e)return!1;let o=Array.isArray(n)?n:Array.isArray(t.default)?t.default:[];if(o.length===0)return!1;for(let t=0;t<o.length;t+=1)if(QV({schema:e,value:o[t],path:[...r,t],hints:i,criteria:a}))return!0}return!1}function $V(e){return e.length===0?d:c`
    <div class="cfg-tags">${e.map(e=>c`<span class="cfg-tag">${e}</span>`)}</div>
  `}function eH(e){let{schema:t,value:n,path:r,hints:i,unsupported:a,disabled:o,onPatch:s}=e,l=e.showLabel??!0,u=N(t),{label:f,help:p,tags:m}=JV(r,t,i),h=yn(r),g=e.searchCriteria;if(a.has(h))return c`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(g&&GV(g)&&!QV({schema:t,value:n,path:r,hints:i,criteria:g}))return d;if(t.anyOf||t.oneOf){let a=(t.anyOf??t.oneOf??[]).filter(e=>!(e.type===`null`||Array.isArray(e.type)&&e.type.includes(`null`)));if(a.length===1)return eH({...e,schema:a[0]});let u=a.map(e=>{if(e.const!==void 0)return e.const;if(e.enum&&e.enum.length===1)return e.enum[0]}),h=u.every(e=>e!==void 0);if(h&&u.length>0&&u.length<=5){let e=n??t.default;return c`
        <div class="cfg-field">
          ${l?c`<label class="cfg-field__label">${f}</label>`:d}
          ${p?c`<div class="cfg-field__help">${p}</div>`:d} ${$V(m)}
          <div class="cfg-segmented">
            ${u.map(t=>c`
                <button
                  type="button"
                  class="cfg-segmented__btn ${BV(t,e)?`active`:``}"
                  ?disabled=${o}
                  @click=${()=>s(r,t)}
                >
                  ${ul(t)}
      ...
      `}if(h&&u.length>5)return rH({...e,options:u,value:n??t.default});let g=new Set(a.map(e=>N(e)).filter(Boolean)),_=new Set([...g].map(e=>e===`integer`?`number`:e));if([..._].every(e=>[`string`,`number`,`boolean`].includes(e))){let n=_.has(`string`),r=_.has(`number`);if(_.has(`boolean`)&&_.size===1)return eH({...e,schema:{...t,type:`boolean`,anyOf:void 0,oneOf:void 0}});if(n||r)return tH({...e,inputType:r&&!n?`number`:`text`})}return iH({schema:t,value:n,path:r,hints:i,disabled:o,showLabel:l,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed,onToggleSensitivePath:e.onToggleSensitivePath,onPatch:s})}if(t.enum){let i=t.enum;if(i.length<=5){let e=n??t.default;return c`
        <div class="cfg-field">
          ${l?c`<label class="cfg-field__label">${f}</label>`:d}
          ${p?c`<div class="cfg-field__help">${p}</div>`:d} ${$V(m)}
          <div class="cfg-segmented">
      ...
      `}return rH({...e,options:i,value:n??t.default})}if(u===`object`)return aH(e);if(u===`array`)return oH(e);if(u===`boolean`){let e=typeof n==`boolean`?n:typeof t.default==`boolean`?t.default:!1;return c`
    ...
    `}return u===`number`||u===`integer`?nH(e):u===`string`?tH({...e,inputType:`text`}):c`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported type: ${u}. Use Raw mode.</div>
    </div>
  `}function tH(e){let{schema:t,value:n,path:r,hints:i,disabled:a,onPatch:o,inputType:s}=e,l=e.showLabel??!0,u=bn(r,i),{label:f,help:p,tags:m}=JV(r,t,i),h=UV({path:r,value:n,hints:i,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed}),g=typeof n==`object`&&!!n&&!Array.isArray(n),_=HV(n),v=e.rawAvailable??!0,y=h.isRedacted||_,b=y?_?v?`Structured value (SecretRef) - use Raw mode to edit`:`Structured value (SecretRef) - edit the config file directly`:Tn:u?.placeholder??(t.default===void 0?``:`Default: ${ul(t.default)}`),x=y?``:g?RV(n):n??``,S=h.isSensitive&&!y?`text`:s;return c`
    <div class="cfg-field">
      ${l?c`<label class="cfg-field__label">${f}</label>`:d}
      ${p?c`<div class="cfg-field__help">${p}</div>`:d} ${$V(m)}
      <div class="cfg-input-wrap">
        ...
        />
        ${_?d:WV({path:r,state:h,disabled:a,onToggleSensitivePath:e.onToggleSensitivePath})}
  ...
  `}function nH(e){let{schema:t,value:n,path:r,hints:i,disabled:a,onPatch:o}=e,s=e.showLabel??!0,{label:l,help:u,tags:f}=JV(r,t,i),p=n??t.default??``,m=typeof p==`number`?p:0;return c`
    <div class="cfg-field">
      ${s?c`<label class="cfg-field__label">${l}</label>`:d}
      ${u?c`<div class="cfg-field__help">${u}</div>`:d} ${$V(f)}
  ...
  `}function rH(e){let{schema:t,value:n,path:r,hints:i,disabled:a,options:o,onPatch:s}=e,l=e.showLabel??!0,{label:u,help:f,tags:p}=JV(r,t,i),m=n??t.default,h=o.findIndex(e=>e===m||String(e)===String(m)),g=`__unset__`;return c`
    <div class="cfg-field">
      ${l?c`<label class="cfg-field__label">${u}</label>`:d}
      ${f?c`<div class="cfg-field__help">${f}</div>`:d} ${$V(p)}
      <select
        class="cfg-select"
        ?disabled=${a}
  ...
  `}function iH(e){let{schema:t,value:n,path:r,hints:i,disabled:a,onPatch:o}=e,s=e.showLabel??!0,{label:l,help:u,tags:f}=JV(r,t,i),p=RV(n),m=UV({path:r,value:n,hints:i,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed}),h=m.isRedacted?``:p;return c`
    <div class="cfg-field">
      ${s?c`<label class="cfg-field__label">${l}</label>`:d}
      ${u?c`<div class="cfg-field__help">${u}</div>`:d} ${$V(f)}
      <div class="cfg-input-wrap">
        ...
        ></textarea>
        ${WV({path:r,state:m,disabled:a,onToggleSensitivePath:e.onToggleSensitivePath})}
      </div>
    </div>
  `}function aH(e){let{schema:t,value:n,path:r,hints:i,unsupported:a,disabled:o,onPatch:s,searchCriteria:l,rawAvailable:u,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m}=e,h=e.showLabel??!0,{label:g,help:_,tags:v}=JV(r,t,i),y=l&&GV(l)&&ZV({schema:t,path:r,hints:i,criteria:l})?void 0:l,b=n??t.default,x=b&&typeof b==`object`&&!Array.isArray(b)?b:{},S=t.properties??{},C=Object.entries(S).toSorted((e,t)=>{let n=bn([...r,e[0]],i)?.order??0,a=bn([...r,t[0]],i)?.order??0;return n===a?e[0].localeCompare(t[0]):n-a}),ee=new Set(Object.keys(S)),w=t.additionalProperties,T=!!w&&typeof w==`object`,te=c`
    ${C.map(([e,t])=>eH({schema:t,value:x[e],path:[...r,e],hints:i,rawAvailable:u,unsupported:a,disabled:o,searchCriteria:y,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m,onPatch:s}))}
    ${T?sH({schema:w,value:x,path:r,hints:i,rawAvailable:u,unsupported:a,disabled:o,reservedKeys:ee,searchCriteria:y,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m,onPatch:s}):d}
  `;return r.length===1?c` <div class="cfg-fields">${te}</div> `:h?c`
    <details class="cfg-object" ?open=${r.length<=2}>
      <summary class="cfg-object__header">
        ...
        <span class="cfg-object__chevron">${VV.chevronDown}</span>
      </summary>
      ${_?c`<div class="cfg-object__help">${_}</div>`:d}
      <div class="cfg-object__content">${te}</div>
    </details>
  `:c` <div class="cfg-fields cfg-fields--inline">${te}</div> `}function oH(e){let{schema:t,value:n,path:r,hints:i,unsupported:a,disabled:o,onPatch:s,searchCriteria:l,rawAvailable:u,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m}=e,h=e.showLabel??!0,{label:g,help:_,tags:v}=JV(r,t,i),y=l&&GV(l)&&ZV({schema:t,path:r,hints:i,criteria:l})?void 0:l,b=Array.isArray(t.items)?t.items[0]:t.items;if(!b)return c`
      <div class="cfg-field cfg-field--error">
    ...
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <button
          ...
          @click=${()=>{s(r,[...x,vn(b)])}}
        >
          <span class="cfg-array__add-icon">${VV.plus}</span>
          Add
        </button>
      </div>
              ...
              ${x.map((e,t)=>c`
                  <div class="cfg-array__item">
                    ...
                    <div class="cfg-array__item-content">
                      ${eH({schema:b,value:e,path:[...r,t],hints:i,rawAvailable:u,unsupported:a,disabled:o,searchCriteria:y,showLabel:!1,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m,onPatch:s})}
                    </div>
                  </div>
                `)}
            </div>
  ...
  `}function sH(e){let{schema:t,value:n,path:r,hints:i,rawAvailable:a,unsupported:o,disabled:s,reservedKeys:l,onPatch:u,searchCriteria:d,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m}=e,h=LV(t),g=Object.entries(n??{}).filter(([e])=>!l.has(e)),_=d&&GV(d)?g.filter(([e,n])=>QV({schema:t,value:n,path:[...r,e],hints:i,criteria:d})):g;return c`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        >
          <span class="cfg-map__add-icon">${VV.plus}</span>
          Add Entry
        </button>
      </div>
      ...
      ${_.length===0?c` <div class="cfg-map__empty">No custom entries.</div> `:c`
            <div class="cfg-map__items">
              ${_.map(([e,l])=>{let g=[...r,e],_=RV(l),v=UV({path:g,value:l,hints:i,revealSensitive:f??!1,isSensitivePathRevealed:p});return c`
                    ...
                    <div class="cfg-map__item-value">
                      ${h?c`
                            <div class="cfg-input-wrap">
                              ...
                              ></textarea>
                              ${WV({path:g,state:v,disabled:s,onToggleSensitivePath:m})}
                            </div>
                          `:eH({schema:t,value:l,path:g,hints:i,rawAvailable:a,unsupported:o,disabled:s,searchCriteria:d,showLabel:!1,revealSensitive:f,isSensitivePathRevealed:p,onToggleSensitivePath:m,onPatch:u})}
                    </div>
                  </div>
                `})}
            </div>
  ...
  `},lH={env:{label:`Environment Variables`,description:`Environment variables passed to the gateway process`},update:{label:`Updates`,description:`Auto-update settings and release channel`},agents:{label:`Agents`,description:`Agent configurations, models, and identities`},auth:{label:`Authentication`,description:`API keys and authentication profiles`},channels:{label:`Channels`,description:`Messaging channels (Telegram, Discord, Slack, etc.)`},messages:{label:`Messages`,description:`Message handling and routing settings`},commands:{label:`Commands`,description:`Custom slash commands`},hooks:{label:`Hooks`,description:`Webhooks and event hooks`},skills:{label:`Skills`,description:`Skill packs and capabilities`},tools:{label:`Tools`,description:`Tool configurations (browser, search, etc.)`},gateway:{label:`Gateway`,description:`Gateway server settings (port, auth, binding)`},wizard:{label:`Setup Wizard`,description:`Setup wizard state and history`},meta:{label:`Metadata`,description:`Gateway metadata and version information`},logging:{label:`Logging`,description:`Log levels and output configuration`},browser:{label:`Browser`,description:`Browser automation settings`},ui:{label:`UI`,description:`User interface preferences`},models:{label:`Models`,description:`AI model configurations and providers`},bindings:{label:`Bindings`,description:`Key bindings and shortcuts`},broadcast:{label:`Broadcast`,description:`Broadcast and notification settings`},audio:{label:`Audio`,description:`Audio input/output settings`},session:{label:`Session`,description:`Session management and persistence`},cron:{label:`Cron`,description:`Scheduled tasks and automation`},web:{label:`Web`,description:`Web server and API settings`},discovery:{label:`Discovery`,description:`Service discovery and networking`},canvasHost:{label:`Canvas Host`,description:`Canvas rendering and display`},talk:{label:`Talk`,description:`Voice and speech settings`},plugins:{label:`Plugins`,description:`Plugin management and extensions`},diagnostics:{label:`Diagnostics`,description:`Instrumentation, OpenTelemetry, and cache-trace settings`},cli:{label:`CLI`,description:`CLI banner and startup behavior`},secrets:{label:`Secrets`,description:`Secret provider configuration`},acp:{label:`ACP`,description:`Agent Communication Protocol runtime and streaming settings`},mcp:{label:`MCP`,description:`Model Context Protocol server definitions`}};function uH(e){return cH[e]??cH.default}function dH(e){if(!e.query)return!0;let t=KV(e.query),n=t.text,r=lH[e.key];return n&&(w(e.key).includes(n)||r?.label&&w(r.label).includes(n)||r?.description&&w(r.description).includes(n))&&t.tags.length===0?!0:QV({schema:e.schema,value:e.sectionValue,path:[e.key],hints:e.uiHints,criteria:t})}function fH(e){if(!e.schema)return c` <div class="muted">Schema unavailable.</div> `;let t=e.schema,n=e.value??{};if(N(t)!==`object`||!t.properties)return c` <div class="callout danger">Unsupported schema. Use Raw.</div> `;let r=new Set(e.unsupportedPaths??[]),i=t.properties,a=e.searchQuery??``,o=KV(a),s=e.activeSection,l=e.activeSubsection??null,u=Object.entries(i).toSorted((t,n)=>{let r=bn([t[0]],e.uiHints)?.order??50,i=bn([n[0]],e.uiHints)?.order??50;return r===i?t[0].localeCompare(n[0]):r-i}).filter(([t,r])=>!(s&&t!==s||a&&!dH({key:t,schema:r,sectionValue:n[t],uiHints:e.uiHints,query:a}))),f=null;if(s&&l&&u.length===1){let e=u[0]?.[1];e&&N(e)===`object`&&e.properties&&e.properties[l]&&(f={sectionKey:s,subsectionKey:l,schema:e.properties[l]})}if(u.length===0)return c`
    ...
    <section class="config-section-card" id=${t.id}>
      ${t.showHeader?c`
            <div class="config-section-card__header">
              <span class="config-section-card__icon">${uH(t.sectionKey)}</span>
      ...
      <div class="config-section-card__content">
        ${eH({schema:t.node,value:t.nodeValue,path:t.path,hints:e.uiHints,rawAvailable:e.rawAvailable??!0,unsupported:r,disabled:e.disabled??!1,showLabel:!1,searchCriteria:o,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed,onToggleSensitivePath:e.onToggleSensitivePath,onPatch:e.onPatch})}
      </div>
    </section>
  `;return c`
    <div class="config-form config-form--modern">
      ${f?(()=>{let{sectionKey:t,subsectionKey:r,schema:i}=f,a=bn([t,r],e.uiHints),o=a?.label??i.title??xn(r),s=a?.help??i.description??``,c=n[t],l=c&&typeof c==`object`?c[r]:void 0;return p({id:`config-section-${t}-${r}`,sectionKey:t,label:o,description:s,showHeader:!1,node:i,nodeValue:l,path:[t,r]})})():u.map(([e,t])=>{let r=lH[e]??{label:e.charAt(0).toUpperCase()+e.slice(1),description:t.description??``};return p({id:`config-section-${e}`,sectionKey:e,label:r.label,description:r.description,showHeader:s==null,node:t,nodeValue:n[e],path:[e]})})}
    </div>
  `}var pH=new Set([`title`,`description`,`default`,`nullable`,`tags`,`x-tags`]),mH=new Set([`string`,`number`,`integer`,`boolean`,`object`,`array`]);function hH(e){return Object.keys(e??{}).filter(e=>!pH.has(e)).length===0}function gH(e){let t=e.filter(e=>e!=null),n=t.length!==e.length;return{enumValues:_H(t),nullable:n}}function _H(e){let t=[];for(let n of e)t.some(e=>Object.is(e,n))||t.push(n);return t}function vH(e){return!e||typeof e!=`object`?{schema:null,unsupportedPaths:[`<root>`]}:yH(e,[])}function yH(e,t){let n=new Set,r={...e},i=yn(t)||`<root>`;if(e.anyOf||e.oneOf||e.allOf)return CH(e,t)||{schema:e,unsupportedPaths:[i]};let a=Array.isArray(e.type)&&e.type.includes(`null`),o=N(e)??(e.properties||e.additionalProperties?`object`:void 0);if(r.type=o??e.type,r.nullable=a||e.nullable,r.enum){let{enumValues:e,nullable:t}=gH(r.enum);r.enum=e,t&&(r.nullable=!0),e.length===0&&n.add(i)}if(o===`object`){let a=e.properties??{},o={};for(let[e,r]of Object.entries(a)){let i=yH(r,[...t,e]);i.schema&&(o[e]=i.schema);for(let e of i.unsupportedPaths)n.add(e)}if(r.properties=o,e.additionalProperties===!0)r.additionalProperties={};else if(e.additionalProperties===!1)r.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties==`object`&&!hH(e.additionalProperties)){let a=yH(e.additionalProperties,[...t,`*`]);r.additionalProperties=a.schema??e.additionalProperties,a.unsupportedPaths.length>0&&n.add(i)}}else if(o===`array`){let a=Array.isArray(e.items)?e.items[0]:e.items;if(!a)n.add(i);else{let e=yH(a,[...t,`*`]);r.items=e.schema??a,e.unsupportedPaths.length>0&&n.add(i)}}else o!==`string`&&o!==`number`&&o!==`integer`&&o!==`boolean`&&!r.enum&&n.add(i);return{schema:r,unsupportedPaths:Array.from(n)}}function bH(e){if(N(e)!==`object`)return!1;let t=e.properties?.source,n=e.properties?.provider,r=e.properties?.id;return!t||!n||!r?!1:typeof t.const==`string`&&N(n)===`string`&&N(r)===`string`}function xH(e){let t=e.oneOf??e.anyOf;return!t||t.length===0?!1:t.every(e=>bH(e))}function SH(e,t,n,r){let i=n.findIndex(e=>N(e)===`string`);if(i<0)return null;let a=n.filter((e,t)=>t!==i);return a.length!==1||!xH(a[0])?null:yH({...e,...n[i],nullable:r||n[i].nullable,anyOf:void 0,oneOf:void 0,allOf:void 0},t)}function CH(e,t){if(e.allOf)return null;let n=e.anyOf??e.oneOf;if(!n)return null;let r=[],i=[],a=!1;for(let e of n){if(!e||typeof e!=`object`)return null;if(Array.isArray(e.enum)){let{enumValues:t,nullable:n}=gH(e.enum);r.push(...t),n&&(a=!0);continue}if(`const`in e){if(e.const==null){a=!0;continue}r.push(e.const);continue}if(N(e)===`null`){a=!0;continue}i.push(e)}return SH(e,t,i,a)||(r.length>0&&i.length===0?{schema:{...e,enum:_H(r),nullable:a,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}:i.length===1?yH({...e,...i[0],nullable:a||i[0].nullable,anyOf:void 0,oneOf:void 0,allOf:void 0},t):i.length>0&&r.length===0&&i.every(e=>{let t=N(e);return!!t&&mH.has(String(t))})?{schema:{...e,nullable:a},unsupportedPaths:[]}:null)}var wH={0:`None`,25:`Slight`,50:`Default`,75:`Round`,100:`Full`},TH={90:`Small`,100:`Default`,110:`Large`,125:`XL`,140:`XXL`},EH={all:c`
  ...
  `},DH=[{id:`core`,label:`Core`,sections:[{key:`env`,label:`Environment`},{key:`auth`,label:`Authentication`},{key:`update`,label:`Updates`},{key:`meta`,label:`Meta`},{key:`logging`,label:`Logging`},{key:`diagnostics`,label:`Diagnostics`},{key:`cli`,label:`Cli`},{key:`secrets`,label:`Secrets`}]},{id:`ai`,label:`AI & Agents`,sections:[{key:`agents`,label:`Agents`},{key:`models`,label:`Models`},{key:`skills`,label:`Skills`},{key:`tools`,label:`Tools`},{key:`memory`,label:`Memory`},{key:`session`,label:`Session`}]},{id:`communication`,label:`Communication`,sections:[{key:`channels`,label:`Channels`},{key:`messages`,label:`Messages`},{key:`broadcast`,label:`Broadcast`},{key:`__notifications__`,label:`Notifications`},{key:`talk`,label:`Talk`},{key:`audio`,label:`Audio`}]},{id:`automation`,label:`Automation`,sections:[{key:`commands`,label:`Commands`},{key:`hooks`,label:`Hooks`},{key:`bindings`,label:`Bindings`},{key:`cron`,label:`Cron`},{key:`approvals`,label:`Approvals`},{key:`plugins`,label:`Plugins`}]},{id:`infrastructure`,label:`Infrastructure`,sections:[{key:`gateway`,label:`Gateway`},{key:`web`,label:`Web`},{key:`browser`,label:`Browser`},{key:`nodeHost`,label:`NodeHost`},{key:`canvasHost`,label:`CanvasHost`},{key:`discovery`,label:`Discovery`},{key:`media`,label:`Media`},{key:`acp`,label:`Acp`},{key:`mcp`,label:`Mcp`}]},{id:`appearance`,label:S(`tabs.appearance`),sections:[{key:`__appearance__`,label:`Theme`},{key:`ui`,label:`UI`},{key:`wizard`,label:`Setup Wizard`}]}],OH=new Set(DH.flatMap(e=>e.sections.map(e=>e.key)));function kH(e){return EH[e]??EH.default}function AH(e,t){if(!e||N(e)!==`object`||!e.properties)return e;let n=t.include,r=t.exclude,i={};for(let t of Object.keys(e.properties))n&&n.size>0&&!n.has(t)||r&&r.size>0&&r.has(t)||(i[t]=e.properties[t]);return{...e,properties:i}}function jH(e){return!e||typeof e!=`object`||Array.isArray(e)?null:e}function MH(e,t){return lH[e]||{label:t?.title??xn(e),description:t?.description??``}}var NH=64,PH=2e4,FH=1e3,IH=2e3,LH=2e5,RH;function zH(e){return e.length>0?e.join(`.`):`<root>`}function BH(e,t){if(!e||!t)return[];let n=[],r=0;function i(e,t,r){n.length<FH&&n.push({path:e,from:t,to:r})}function a(e,t,n){if(e.length!==t.length||e.length>IH)return!0;for(let r=0;r<e.length;r+=1)if(s(e[r],t[r],n+1))return!0;return!1}function o(e,t,n){let r=Object.keys(e),i=Object.keys(t);if(r.length!==i.length)return!0;for(let i of r)if(!Object.hasOwn(t,i)||s(e[i],t[i],n+1))return!0;return!1}function s(e,t,n){return r+=1,r>PH||n>NH?!0:e===t?!1:typeof e==typeof t?typeof e!=`object`||!e||t===null?e!==t:Array.isArray(e)||Array.isArray(t)?Array.isArray(e)&&Array.isArray(t)?a(e,t,n+1):!0:o(e,t,n+1):!0}function c(e,t,o,s){if(r+=1,r>PH||s>NH||n.length>=FH||e===t)return;if(typeof e!=typeof t){i(o,e,t);return}if(typeof e!=`object`||!e||t===null){e!==t&&i(o,e,t);return}if(Array.isArray(e)||Array.isArray(t)){(Array.isArray(e)&&Array.isArray(t)&&a(e,t,s+1)||!Array.isArray(e)||!Array.isArray(t))&&i(o,e,t);return}let l=e,u=t,d=new Set([...Object.keys(l),...Object.keys(u)]);for(let e of d)c(l[e],u[e],[...o,e],s+1)}return c(e,t,[],0),n}function VH(e,t){if(RH?.original===e&&RH.current===t)return RH.diff;if(e.length>LH||t.length>LH)return RH={original:e,current:t,diff:[]},RH.diff;try{let n=ie.parse(e),r=ie.parse(t);if(!n||!r||typeof n!=`object`||typeof r!=`object`||Array.isArray(n)||Array.isArray(r))return RH={original:e,current:t,diff:[]},[];let i=BH(n,r);return RH={original:e,current:t,diff:i},i}catch{return RH={original:e,current:t,diff:[]},[]}}function HH(e,t=40){if(Array.isArray(e))return`[${e.length} item${e.length===1?``:`s`}]`;let n;try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:n.slice(0,t-3)+`...`}function UH(e,t,n){return jn(zH(e))&&t!=null&&HH(t).trim()!==``?Tn:HH(t)}function WH(e,t){let n=e.split(`.`);return n.length===t.length?n.every((e,n)=>e===`*`||e===t[n]):!1}function GH(e,t){return Object.entries(t).some(([t,n])=>!!n.sensitive&&WH(t,e))}function KH(e,t){for(let n=1;n<=e.length;n+=1){let r=e.slice(0,n),i=zH(r);if((bn(r,t)?.sensitive??!1)||GH(r,t)||jn(i))return!0}return!1}function qH(e,t,n,r){let i=In(t,e,n)>0;return!r&&t!=null&&(KH(e,n)||i)?Tn:HH(t)}var JH=[{id:`claw`,label:`Claw`,description:`Chroma family`,icon:q.zap},{id:`knot`,label:`Knot`,description:`Black & red`,icon:q.link},{id:`dash`,label:`Dash`,description:`Chocolate blueprint`,icon:q.barChart}];function YH(e){return e.hasCustomTheme&&e.customThemeLabel?e.customThemeLabel:`Imported theme`}function XH(){(typeof requestAnimationFrame==`function`?requestAnimationFrame:e=>window.setTimeout(()=>e(0),0))(()=>{let e=globalThis.document?.querySelector(`[data-custom-theme-import-input]`);e&&(typeof e.scrollIntoView==`function`&&e.scrollIntoView({block:`center`,behavior:`smooth`}),e.focus(),e.select())})}function ZH(e){let t=e.webPush;if(!t)return c`
      <div class="settings-notifications">
        <section class="settings-notifications__card">
          <div class="settings-notifications__header">
            <span class="settings-notifications__icon">${kH(`__notifications__`)}</span>
          ...
          <div class="settings-notifications__actions">
            ${t.supported&&t.permission!==`denied`?t.subscribed?c`
                  ...
                  `:c`
                    ...
                    >
                      ${t.loading?q.loader:kH(`__notifications__`)}
  ...
  `}function QH(e){let t=e.hasCustomTheme||e.customThemeImportExpanded===!0;t&&e.customThemeImportFocusToken!=null&&e.customThemeImportFocusToken!==Z.lastCustomThemeImportFocusToken&&(Z.lastCustomThemeImportFocusToken=e.customThemeImportFocusToken,XH());let n=YH(e);return c`
    <div class="settings-appearance">
      <div class="settings-appearance__section">
        <h3 class="settings-appearance__heading">Theme</h3>
        <p class="settings-appearance__hint">Choose a theme family.</p>
        <div class="settings-theme-grid">
          ${[...JH,{id:`custom`,label:e.hasCustomTheme?n:`Import`,description:e.hasCustomTheme?`Imported from tweakcn: ${n}`:`Import a tweakcn theme into this browser-local slot`,icon:q.spark}].map(t=>c`
              <button
          ...
          <div class="settings-roundness__options">
            ${qo.map(t=>c`
                ...
                >
                  ...
                  ></span>
                  <span class="settings-roundness__label">${wH[t]}</span>
                </button>
              `)}
          </div>
        </div>
        ...
        <div class="settings-text-scale">
          <div class="settings-text-scale__options">
            ${Jo.map(t=>c`
                ...
                >
                  <span class="settings-text-scale__sample">${TH[t]}</span>
      ...
      <main class="config-main">
                ...
                <div class="config-diff__content">
                  ${D.map(t=>c`
                      <div class="config-diff__item">
                        <div class="config-diff__path">${zH(t.path)}</div>
                        <div class="config-diff__values">
                          <span class="config-diff__from"
                            >${UH(t.path,t.from,e.uiHints)}</span
                          >
                          <span class="config-diff__arrow">→</span>
                          <span class="config-diff__to"
                            >${UH(t.path,t.to,e.uiHints)}</span
                          >
                        </div>
                      </div>
                    `)}
        ...
        ${ie&&f===`raw`?c`
              <details
                class="config-diff"
                ?open=${Z.rawDiffOpen}
                @toggle=${e=>{let t=e.target;Z.rawDiffOpen!==t.open&&(Z.rawDiffOpen=t.open,t.open||(RH=void 0),p())}}
              >
                <summary class="config-diff__summary">
                ...
                <div class="config-diff__content">
                  ${ae.length>0?ae.map(t=>c`
                          <div class="config-diff__item">
                            ...
                            <div class="config-diff__values">
                              <span class="config-diff__from"
                                >${qH(t.path,t.from,e.uiHints,Z.rawRevealed)}</span
                              >
                              <span class="config-diff__arrow">→</span>
                              <span class="config-diff__to"
                                >${qH(t.path,t.to,e.uiHints,Z.rawRevealed)}</span
                              >
                            </div>
                          </div>
                        `):c`
        ...
        <div class="config-content">
          ${e.activeSection===`__appearance__`?i?QH(e):d:e.activeSection===`__notifications__`?i?ZH(e):d:f===`form`?c`
                    ${k?QH(e):d}
                    ${e.schemaLoading?c`
                        ...
                        `:fH({schema:s.schema,uiHints:e.uiHints,value:e.formValue,rawAvailable:u,disabled:e.loading||!e.formValue,unsupportedPaths:s.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:null,revealSensitive:e.activeSection===`env`?h:!1,isSensitivePathRevealed:rU,onToggleSensitivePath:e=>{iU(e),p()}})}
  ...
  `}var oU=[{id:`every-morning`,labelKey:`cron.quickCreate.schedules.everyMorning.label`,icon:`🌅`,descriptionKey:`cron.quickCreate.schedules.everyMorning.description`},{id:`every-evening`,labelKey:`cron.quickCreate.schedules.everyEvening.label`,icon:`🌙`,descriptionKey:`cron.quickCreate.schedules.everyEvening.description`},{id:`hourly`,labelKey:`cron.quickCreate.schedules.hourly.label`,icon:`🔄`,descriptionKey:`cron.quickCreate.schedules.hourly.description`},{id:`weekdays`,labelKey:`cron.quickCreate.schedules.weekdays.label`,icon:`📅`,descriptionKey:`cron.quickCreate.schedules.weekdays.description`},{id:`weekly`,labelKey:`cron.quickCreate.schedules.weekly.label`,icon:`📆`,descriptionKey:`cron.quickCreate.schedules.weekly.description`},{id:`once`,labelKey:`cron.quickCreate.schedules.once.label`,icon:`⚡`,descriptionKey:`cron.quickCreate.schedules.once.description`}],sU=[{id:`notify`,labelKey:`cron.quickCreate.delivery.notify.label`,descriptionKey:`cron.quickCreate.delivery.notify.description`},{id:`silent`,labelKey:`cron.quickCreate.delivery.silent.label`,descriptionKey:`cron.quickCreate.delivery.silent.description`},{id:`isolated`,labelKey:`cron.quickCreate.delivery.isolated.label`,descriptionKey:`cron.quickCreate.delivery.isolated.description`}];function cU(){return{prompt:``,name:``,schedulePreset:`every-morning`,deliveryPreset:`notify`}}function lU(e=new Date){let t=new Date(e);return t.setHours(t.getHours()+1,0,0,0),`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}T${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}function uU(e){let t={name:e.name||S(`cron.quickCreate.defaultName`),payloadKind:`agentTurn`,deleteAfterRun:!1,scheduleAt:``,payloadText:e.prompt,enabled:!0};switch(e.schedulePreset){case`every-morning`:t.scheduleKind=`cron`,t.cronExpr=`0 8 * * *`;break;case`every-evening`:t.scheduleKind=`cron`,t.cronExpr=`0 18 * * *`;break;case`hourly`:t.scheduleKind=`every`,t.everyAmount=`1`,t.everyUnit=`hours`;break;case`weekdays`:t.scheduleKind=`cron`,t.cronExpr=`0 9 * * 1-5`;break;case`weekly`:t.scheduleKind=`cron`,t.cronExpr=`0 9 * * 1`;break;case`once`:t.scheduleKind=`at`,t.scheduleAt=lU(),t.deleteAfterRun=!0;break;default:break}switch(e.deliveryPreset){case`notify`:t.sessionTarget=`isolated`,t.deliveryMode=`announce`,t.wakeMode=`now`;break;case`silent`:t.sessionTarget=`main`,t.deliveryMode=`none`,t.wakeMode=`now`;break;case`isolated`:t.sessionTarget=`isolated`,t.deliveryMode=`none`,t.wakeMode=`now`;break}return t}var dU=[`what`,`when`,`how`],fU={what:`cron.quickCreate.steps.what`,when:`cron.quickCreate.steps.when`,how:`cron.quickCreate.steps.how`};function pU(e){let t=dU.indexOf(e);return c`
    <div class="cqc-steps">
      ${dU.map((e,n)=>{let r=n<t?`done`:n===t?`active`:`pending`;return c`
          <div class="cqc-step cqc-step--${r}">
            <span class="cqc-step__dot">${r===`done`?`✓`:n+1}</span>
            <span class="cqc-step__label">${S(fU[e])}</span>
          </div>
          ${n<dU.length-1?c`<div class="cqc-step__line cqc-step__line--${r}"></div>`:d}
        `})}
    </div>
  `}function mU(e){return e.onAdvancedCreate?c`
    <button class="btn cqc-advanced-button" @click=${e.onAdvancedCreate}>
      ${S(`cron.form.advanced`)}
    </button>
  `:d}function hU(e){return c`
    <div class="cqc-body">
  ...
  `}var SU=/<!--\s*openclaw:dreaming:diary:start\s*-->/,CU=/<!--\s*openclaw:dreaming:diary:end\s*-->/;function wU(e){let t=e,n=SU.exec(e),r=CU.exec(e);n&&r&&r.index>n.index&&(t=e.slice(n.index+n[0].length,r.index));let i=[],a=t.split(/\n---\n/).filter(e=>e.trim().length>0);for(let e of a){let t=e.trim().split(`
...
`)})}return i}function TU(e){let t=Date.parse(e);return Number.isFinite(t)?t:null}function EU(e){let t=TU(e);if(t===null)return e;let n=new Date(t);return`${n.getMonth()+1}/${n.getDate()}`}function DU(e){return[...e].toReversed().map((e,t)=>Object.assign({},e,{page:t}))}var OU=[`dreaming.phrases.consolidatingMemories`,`dreaming.phrases.tidyingKnowledgeGraph`,`dreaming.phrases.replayingConversations`,`dreaming.phrases.weavingShortTerm`,`dreaming.phrases.defragmentingMindPalace`,`dreaming.phrases.filingLooseThoughts`,`dreaming.phrases.connectingDots`,`dreaming.phrases.compostingContext`,`dreaming.phrases.alphabetizingSubconscious`,`dreaming.phrases.promotingHunches`,`dreaming.phrases.forgettingNoise`,`dreaming.phrases.dreamingEmbeddings`,`dreaming.phrases.reorganizingAttic`,`dreaming.phrases.indexingDay`,`dreaming.phrases.nurturingInsights`,`dreaming.phrases.simmeringIdeas`,`dreaming.phrases.whisperingVectorStore`],kU={light:`dreaming.phase.light`,deep:`dreaming.phase.deep`,rem:`dreaming.phase.rem`},AU=Math.floor(Math.random()*OU.length),jU=0,MU=6e3,NU=`scene`,Q=`dreams`,PU=`recent`,FU=new Set,IU=new Set,LU=!1,RU=!1,zU=``,BU=``,VU=null,HU=``,UU=null,WU=!1,GU=null,KU=0,qU=0;function JU(e){KU=Math.max(0,Math.min(e,Math.max(0,qU-1)))}function YU(){let e=Date.now();return e-jU>MU&&(jU=e,AU=(AU+1)%OU.length),S(OU[AU]??OU[0])}var XU=[{top:8,left:15,size:3,delay:0,hue:`neutral`},{top:12,left:72,size:2,delay:1.4,hue:`neutral`},{top:22,left:35,size:3,delay:.6,hue:`accent`},{top:18,left:88,size:2,delay:2.1,hue:`neutral`},{top:35,left:8,size:2,delay:.9,hue:`neutral`},{top:45,left:92,size:2,delay:1.7,hue:`neutral`},{top:55,left:25,size:3,delay:2.5,hue:`accent`},{top:65,left:78,size:2,delay:.3,hue:`neutral`},{top:75,left:45,size:2,delay:1.1,hue:`neutral`},{top:82,left:60,size:3,delay:1.8,hue:`accent`},{top:30,left:55,size:2,delay:.4,hue:`neutral`},{top:88,left:18,size:2,delay:2.3,hue:`neutral`}],ZU=c`
  <svg viewBox="0 0 120 120" fill="none">
    <defs>
...
`;function QU(e){let n=!e.active,r=e.dreamingOf??YU();return c`
    <div class="dreams-page">
      <!-- ── Sub-tab bar ── -->
      <div class="dreams__topbar">
        <nav class="dreams__tabs">
          <button
            class="dreams__tab ${NU===`scene`?`dreams__tab--active`:``}"
            @click=${()=>{NU=`scene`,e.onRequestUpdate?.()}}
          >
            ${S(`dreaming.tabs.scene`)}
          </button>
          <button
            class="dreams__tab ${NU===`diary`?`dreams__tab--active`:``}"
            @click=${()=>{NU=`diary`,e.onRequestUpdate?.()}}
          >
            ${S(`dreaming.tabs.diary`)}
          </button>
          <button
            class="dreams__tab ${NU===`advanced`?`dreams__tab--active`:``}"
            @click=${()=>{NU=`advanced`,e.onRequestUpdate?.()}}
          >
      ...
      ${NU===`scene`?tW(e,n,r):NU===`diary`?DW(e):CW(e)}
    </div>
  `}function $U(e){return e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0&&e!==`What Happened`&&e!==`Reflections`&&e!==`Candidates`&&e!==`Possible Lasting Updates`).map(e=>e.replace(/\s*\[memory\/[^\]]+\]/g,``)).map(e=>e.replace(/^(?:\d+\.\s+|-\s+(?:\[[^\]]+\]\s+)?(?:[a-z_]+:\s+)?)/i,``).replace(/^(?:likely_durable|likely_situational|unclear):\s+/i,``).trim()).filter(e=>e.length>0)}function eW(e){return e?new Date(e).toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}):`—`}function tW(e,t,n){return c`
    <section class="dreams ${t?`dreams--idle`:``}">
      ...
      <div class="dreams__lobster">${ZU}</div>
      ...
      <div class="dreams__phases">
        ${Object.keys(kU).map(t=>{let n=e.phases?.[t],r=n!==void 0,i=n?.enabled===!0,a=eW(n?.nextRunAtMs),o=S(kU[t]),s=r?i?a:S(`dreaming.phase.off`):`—`;return c`
  ...
  `}function nW(e,t,n){return t===n?`${e}:${t}`:`${e}:${t}-${n}`}function rW(e){let t=Date.parse(e);return Number.isFinite(t)?new Date(t).toLocaleString([],{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}):e}function iW(e){return e.replace(/\\/g,`/`).split(`/`).findLast(Boolean)??e}function aW(e){switch(e){case`entity`:return`entity`;case`concept`:return`concept`;case`source`:return`source`;case`synthesis`:return`synthesis`;case`report`:return`report`}return e}function oW(e,t,n=`${t}s`){return`${e} ${e===1?t:n}`}var sW=[`source`,`synthesis`,`report`,`entity`,`concept`];function cW(e){switch(e){case`source`:return`Sources`;case`synthesis`:return`Syntheses`;case`report`:return`Reports`;case`entity`:return`Entities`;case`concept`:return`Concepts`}return e}function lW(e){let t=sW.map(t=>{let n=e[t];return n>0?`${cW(t)} · ${oW(n,`page`)}`:null}).filter(e=>e!==null);return t.length>0?t.join(`; `):`No pages yet`}function uW(e){let t=[`${e.label}: ${oW(e.itemCount,`page`)}`];if(e.claimCount>0&&t.push(oW(e.claimCount,`claim row`)),e.questionCount>0){let n=e.items.filter(e=>e.questionCount>0).length,r=n>0?` on ${oW(n,`page`)}`:``;t.push(`${oW(e.questionCount,`open question`)}${r}`)}return e.contradictionCount>0&&t.push(oW(e.contradictionCount,`contradiction`)),t.join(` · `)}function dW(e){if(e.digestStatus===`withheld`)return`needs review`;switch(e.riskLevel){case`low`:return`low risk`;case`medium`:return`medium risk`;case`high`:return`high risk`;case`unknown`:return`unknown risk`}return`unknown risk`}function fW(e,t,n){e.has(t)?e.delete(t):e.add(t),n?.()}async function pW(e,t){LU=!0,RU=!0,zU=iW(e),BU=e,VU=null,HU=``,UU=null,WU=!1,GU=null,t.onRequestUpdate?.();try{let n=await t.onOpenWikiPage(e);if(!n){GU=`No wiki page found for ${e}.`;return}zU=n.title,BU=n.path,VU=n.updatedAt??null,HU=n.content,UU=typeof n.totalLines==`number`?n.totalLines:null,WU=n.truncated===!0}catch(e){GU=String(e)}finally{RU=!1,t.onRequestUpdate?.()}}function mW(e){LU=!1,RU=!1,zU=``,BU=``,VU=null,HU=``,UU=null,WU=!1,GU=null,e?.()}function hW(e){return LU?c`
    <div
      class="dreams-diary__preview-backdrop"
      @click=${()=>mW(e.onRequestUpdate)}
    >
      <div class="dreams-diary__preview-panel" @click=${e=>e.stopPropagation()}>
        <div class="dreams-diary__preview-header">
          <div>
            <div class="dreams-diary__preview-title">${zU||`Wiki page`}</div>
        ...
        <div class="dreams-diary__preview-body">
          ${RU?c`<div class="dreams-diary__empty-text">Loading wiki page…</div>`:GU?c`<div class="dreams-diary__error">${GU}</div>`:c`
                  ${WU?c`
                        <div class="dreams-diary__preview-hint">
                          Showing the first chunk of this
                          page${UU===null?``:` (${UU} total lines)`}.
                        </div>
                      `:d}
                  <pre class="dreams-diary__preview-pre">${HU}</pre>
                `}
        </div>
      </div>
    </div>
  `:d}function gW(){switch(Q){case`dreams`:return c`
      ...
      `}return d}function _W(e){if(!e)return-1/0;let t=Date.parse(e);return Number.isFinite(t)?t:-1/0}function vW(e,t){let n=_W(e.lastRecalledAt),r=_W(t.lastRecalledAt);return r===n?t.totalSignalCount===e.totalSignalCount?e.path.localeCompare(t.path):t.totalSignalCount-e.totalSignalCount:r-n}function yW(e,t){return t.totalSignalCount===e.totalSignalCount?t.phaseHitCount===e.phaseHitCount?vW(e,t):t.phaseHitCount-e.phaseHitCount:t.totalSignalCount-e.totalSignalCount}function bW(e,t){return t===`signals`?e.toSorted(yW):e.toSorted(vW)}function xW(e){let t=e.groundedCount>0,n=e.recallCount>0||e.dailyCount>0;return S(t&&n?`dreaming.advanced.originMixed`:t?`dreaming.advanced.originDailyLog`:`dreaming.advanced.originLive`)}function SW(e){return c`
              ...
              ${e.entries.map(t=>c`
                  <article class="dreams-advanced__item" data-entry-key=${t.key}>
                    ...
                    <div class="dreams-advanced__source">
                      ${nW(t.path,t.startLine,t.endLine)}
                    </div>
  ...
  `}function CW(e){let t=e.shortTermEntries.filter(e=>e.groundedCount>0),n=bW(e.shortTermEntries,PU),r=S(`dreaming.advanced.description`),i=[`${t.length} ${S(`dreaming.advanced.summaryFromDailyLog`)}`,`${e.shortTermCount} ${S(`dreaming.advanced.summaryWaiting`)}`,`${e.promotedCount} ${S(`dreaming.advanced.summaryPromotedToday`)}`].join(` · `);return c`
    <section class="dreams-advanced">
      ...
      <div class="dreams-advanced__sections">
        ${SW({titleKey:`dreaming.advanced.stagedTitle`,descriptionKey:`dreaming.advanced.stagedDescription`,emptyKey:`dreaming.advanced.emptyGrounded`,entries:t,controls:c`
            <button
              class="btn btn--subtle btn--sm"
              ?disabled=${e.modeSaving||e.dreamDiaryActionLoading}
              @click=${()=>e.onResetGroundedShortTerm()}
        ...
        ${SW({titleKey:`dreaming.advanced.shortTermTitle`,descriptionKey:`dreaming.advanced.shortTermDescription`,emptyKey:`dreaming.advanced.emptyShortTerm`,entries:n,controls:c`
            <div class="dreams-advanced__sort">
              <button
                class="dreams-advanced__sort-btn ${PU===`recent`?`dreams-advanced__sort-btn--active`:``}"
                @click=${()=>{PU=`recent`,e.onRequestUpdate?.()}}
              >
                ${S(`dreaming.advanced.sortRecent`)}
              </button>
              <button
                class="dreams-advanced__sort-btn ${PU===`signals`?`dreams-advanced__sort-btn--active`:``}"
                @click=${()=>{PU=`signals`,e.onRequestUpdate?.()}}
              >
                ${S(`dreaming.advanced.sortSignals`)}
              </button>
            </div>
          `,badge:e=>xW(e),meta:e=>[`${e.totalSignalCount} ${S(`dreaming.stats.signals`).toLowerCase()}`,e.recallCount>0?`${e.recallCount} recall`:``,e.dailyCount>0?`${e.dailyCount} daily`:``,e.groundedCount>0?`${e.groundedCount} ${S(`dreaming.stats.grounded`).toLowerCase()}`:``,e.phaseHitCount>0?`${e.phaseHitCount} phase hit`:``]})}
        ${SW({titleKey:`dreaming.advanced.promotedTitle`,descriptionKey:`dreaming.advanced.promotedDescription`,emptyKey:`dreaming.advanced.emptyPromoted`,entries:e.promotedEntries,badge:e=>xW(e),meta:e=>[e.promotedAt?`${S(`dreaming.advanced.updatedPrefix`)} ${rW(e.promotedAt)}`:``,e.groundedCount>0?`${e.groundedCount} ${S(`dreaming.stats.grounded`).toLowerCase()}`:``,e.totalSignalCount>0?`${e.totalSignalCount} ${S(`dreaming.stats.signals`).toLowerCase()}`:``]})}
      </div>

      ${e.statusError?c`<div class="dreams__controls-error">${e.statusError}</div>`:d}
    </section>
  `}function wW(e){let t=e.wikiImportInsights?.clusters??[];if(e.wikiImportInsightsLoading&&t.length===0)return c`
    ...
    `;qU=t.length;let n=Math.max(0,Math.min(KU,t.length-1)),r=t[n];return c`
    <div class="dreams-diary__daychips">
      ${t.map((t,r)=>c`
          <button
            class="dreams-diary__day-chip ${r===n?`dreams-diary__day-chip--active`:``}"
            @click=${()=>{JU(r),e.onRequestUpdate?.()}}
          >
            ${t.label}
          </button>
        `)}
        ...
        ${r.items.map(t=>{let n=FU.has(t.pagePath);return c`
            ...
            >
              ...
              <div class="dreams-diary__insight-meta">
                ${t.updatedAt?rW(t.updatedAt):iW(t.pagePath)}
              ...
              <div class="dreams-diary__insight-actions">
                <button
                  class="btn btn--subtle btn--sm"
                  @click=${n=>{n.stopPropagation(),fW(FU,t.pagePath,e.onRequestUpdate)}}
                >
                  ${n?`Hide details`:`Details`}
                </button>
                <button
                  class="btn btn--subtle btn--sm"
                  @click=${n=>{n.stopPropagation(),pW(t.pagePath,e)}}
                >
                  Open source page
                </button>
              </div>
  ...
  `}function TW(e){let t=e.wikiMemoryPalace,n=t?.clusters??[];if(e.wikiMemoryPalaceLoading&&n.length===0)return c`
      <div class="dreams-diary__empty">
    ...
    `;qU=n.length;let r=Math.max(0,Math.min(KU,n.length-1)),i=n[r],a=t?.totalPages??t?.totalItems??0,o=t?.totalClaims??0,s=t?.totalQuestions??0,l=t?.totalContradictions??0,u=t?lW(t.pageCounts):`No pages yet`,f=uW(i);return c`
    <div class="dreams-diary__daychips">
      ${n.map((t,n)=>c`
          <button
            class="dreams-diary__day-chip ${n===r?`dreams-diary__day-chip--active`:``}"
            @click=${()=>{JU(n),e.onRequestUpdate?.()}}
          >
            ${t.label}
          </button>
        `)}
    ...
    <article class="dreams-diary__entry" key="palace-${i.key}">
      ...
      <div class="dreams-diary__date">
        Vault · ${oW(a,`page`)}
        ${o>0?c`· ${oW(o,`claim row`)}`:d}
        ${s>0?c`· ${oW(s,`open question`)}`:d}
        ${l>0?c`· ${oW(l,`contradiction`)}`:d}
      </div>
      <div class="dreams-diary__prose">
        <p class="dreams-diary__para">Full vault breakdown: ${u}.</p>
        <p class="dreams-diary__para">
          Selected section: ${f}.
          ${i.updatedAt?` Latest update ${rW(i.updatedAt)}.`:``}
        </p>
      </div>
      <div class="dreams-diary__insights">
        ${i.items.map(t=>{let n=IU.has(t.pagePath);return c`
            <article
              class="dreams-diary__insight-card dreams-diary__insight-card--clickable"
              data-palace-page=${t.pagePath}
              @click=${()=>{if(t.kind===`report`){pW(t.pagePath,e);return}fW(IU,t.pagePath,e.onRequestUpdate)}}
            >
              <div class="dreams-diary__insight-topline">
                <div class="dreams-diary__insight-title">${t.title}</div>
              ...
              <div class="dreams-diary__insight-actions">
                <button
                  class="btn btn--subtle btn--sm"
                  @click=${n=>{n.stopPropagation(),fW(IU,t.pagePath,e.onRequestUpdate)}}
                >
                  ${n?`Hide details`:`Details`}
                </button>
                <button
  ...
  `}function EW(e){if(typeof e.dreamDiaryContent!=`string`)return c`
      <div class="dreams-diary__empty">
    ...
    `;let t=wU(e.dreamDiaryContent);if(qU=t.length,t.length===0)return c`
      <div class="dreams-diary__empty">
    ...
    `;let n=DU(t),r=Math.max(0,Math.min(KU,n.length-1)),i=n[r];return c`
    <div class="dreams-diary__daychips">
      ${n.map(t=>c`
          <button
            class="dreams-diary__day-chip ${t.page===r?`dreams-diary__day-chip--active`:``}"
            @click=${()=>{JU(t.page),e.onRequestUpdate?.()}}
          >
            ${EU(t.date)}
          </button>
        `)}
    ...
    <article class="dreams-diary__entry" key="${r}">
      ...
      <div class="dreams-diary__prose">
        ${$U(i.body).map((e,t)=>c`<p class="dreams-diary__para" style="animation-delay: ${.3+t*.15}s;">
              ${f(cM(e))}
            </p>`)}
      </div>
    </article>
  `}function DW(e){let t=(Q===`insights`||Q===`palace`)&&!e.memoryWikiEnabled,n=Q===`dreams`?e.dreamDiaryError:Q===`insights`?e.wikiImportInsightsError:e.wikiMemoryPalaceError;return n&&!t?c`
    ...
    <section class="dreams-diary">
      <div class="dreams-diary__chrome">
        <div class="dreams-diary__header">
          ...
          <button
            ...
            @click=${()=>{KU=0,t?e.onOpenConfig():Q===`dreams`?e.onRefreshDiary():Q===`insights`?e.onRefreshImports():e.onRefreshMemoryPalace()}}
          >
      ...
      ${t?c`
          ...
          `:Q===`dreams`?EW(e):Q===`insights`?wW(e):TW(e)}
      ${hW(e)}
    </section>
  `}function OW(e){let t=e.trim();if(!t||jW(t))return t;let n=t.match(/^\/(?:home|Users)\/([^/]+)(.*)$/);if(n&&AW(n[1]))return kW(n[2]??``);let r=t.match(/^[A-Za-z]:[\\/]Users[\\/]([^\\/]+)(.*)$/i);return r&&AW(r[1])?kW(r[2]??``):t}function kW(e){return`~${e.replace(/\\/g,`/`)}`}function AW(e){return e!==void 0&&e!==`.`&&e!==`..`}function jW(e){return/(^|[\\/])\.{1,2}(?=[\\/]|$)/.test(e)}var MW=[`allow-once`,`allow-always`,`deny`];function NW(e){let t=Math.floor(Math.max(0,e)/1e3);if(t<60)return`${t}s`;let n=Math.floor(t/60);return n<60?`${n}m`:`${Math.floor(n/60)}h`}function PW(e,t,n){return t?c`<div class="exec-approval-meta-row">
    <span>${e}</span><span>${n?.path?OW(t):t}</span>
  </div>`:d}function FW(e){let t=[...e.commandSpans??[]].filter(t=>Number.isSafeInteger(t.startIndex)&&Number.isSafeInteger(t.endIndex)&&t.startIndex>=0&&t.endIndex>t.startIndex&&t.endIndex<=e.command.length).toSorted((e,t)=>e.startIndex-t.startIndex||t.endIndex-e.endIndex),n=[],r=0;for(let e of t)e.startIndex<r||(n.push(e),r=e.endIndex);if(n.length===0)return c`<div class="exec-approval-command mono">${e.command}</div>`;let i=[];r=0;for(let t of n)t.startIndex>r&&i.push(e.command.slice(r,t.startIndex)),i.push(c`<mark class="exec-approval-command-span"
        >${e.command.slice(t.startIndex,t.endIndex)}</mark
      >`),r=t.endIndex;return r<e.command.length&&i.push(e.command.slice(r)),c`<div class="exec-approval-command mono">${i}</div>`}function IW(e){return c`
    ${FW(e)}
    <div class="exec-approval-meta">
      ${PW(S(`execApproval.labels.host`),e.host)}
      ${PW(S(`execApproval.labels.agent`),e.agentId)}
      ${PW(S(`execApproval.labels.session`),e.sessionKey)}
      ${PW(S(`execApproval.labels.cwd`),e.cwd,{path:!0})}
      ${PW(S(`execApproval.labels.resolved`),e.resolvedPath,{path:!0})}
      ${PW(S(`execApproval.labels.security`),e.security)}
      ${PW(S(`execApproval.labels.ask`),e.ask)}
    </div>
  `}function LW(e){return c`
    ${e.pluginDescription?c`<pre class="exec-approval-command mono" style="white-space:pre-wrap">
${e.pluginDescription}</pre
        >`:d}
    <div class="exec-approval-meta">
      ${PW(S(`execApproval.labels.severity`),e.pluginSeverity)}
      ${PW(S(`execApproval.labels.plugin`),e.pluginId)}
      ${PW(S(`execApproval.labels.agent`),e.request.agentId)}
      ${PW(S(`execApproval.labels.session`),e.request.sessionKey)}
    </div>
  `}function RW(e){switch(e){case`allow-once`:return S(`execApproval.allowOnce`);case`allow-always`:return S(`execApproval.alwaysAllow`);case`deny`:return S(`execApproval.deny`)}return S(`execApproval.deny`)}function zW(e){switch(e){case`allow-once`:return`btn primary`;case`allow-always`:return`btn`;case`deny`:return`btn danger`}return`btn danger`}function BW(e){return e.request.allowedDecisions?.length?e.request.allowedDecisions:e.kind===`exec`&&e.request.ask===`always`?[`allow-once`,`deny`]:MW}function VW(e,t){return e.kind!==`exec`||t.includes(`allow-always`)?d:c`<div class="exec-approval-warning">${S(`execApproval.allowAlwaysUnavailable`)}</div>`}function HW(e){let t=e.execApprovalQueue[0];if(!t)return d;let n=t.request,r=t.expiresAtMs-Date.now(),i=r>0?S(`execApproval.expiresIn`,{time:NW(r)}):S(`execApproval.expired`),a=e.execApprovalQueue.length,o=t.kind===`plugin`,s=o?t.pluginTitle??S(`execApproval.pluginApprovalNeeded`):S(`execApproval.execApprovalNeeded`),l=BW(t);return c`
  ...
  `}function UW(e){let{pendingGatewayUrl:t}=e;if(!t)return d;let n=S(`channels.gatewayUrlConfirmation.title`),r=S(`channels.gatewayUrlConfirmation.subtitle`);return c`
    <openclaw-modal-dialog
      label=${n}
      description=${r}
  ...
  `}async function WW(e){try{await navigator.clipboard.writeText(e)}catch{}}function GW(e){let t=S(`overview.connection.copyCommand`);return c`
    <div
      ...
      @click=${async t=>{t.target?.closest(`.chat-copy-btn`)||await WW(e)}}
      @keydown=${async t=>{t.key!==`Enter`&&t.key!==` `||(t.preventDefault(),await WW(e))}}
    >
      <code>${e}</code>
      ${kM(e,t)}
    </div>
  `}var KW=new Set([M.AUTH_REQUIRED,M.AUTH_TOKEN_MISSING,M.AUTH_PASSWORD_MISSING,M.AUTH_TOKEN_NOT_CONFIGURED,M.AUTH_PASSWORD_NOT_CONFIGURED]),qW=new Set([...KW,M.AUTH_UNAUTHORIZED,M.AUTH_TOKEN_MISMATCH,M.AUTH_PASSWORD_MISMATCH,M.AUTH_DEVICE_TOKEN_MISMATCH,M.AUTH_RATE_LIMITED,M.AUTH_TAILSCALE_IDENTITY_MISSING,M.AUTH_TAILSCALE_PROXY_MISSING,M.AUTH_TAILSCALE_WHOIS_FAILED,M.AUTH_TAILSCALE_IDENTITY_MISMATCH]),JW=new Set([`BROWSER_WEBSOCKET_SECURITY_ERROR`,M.CONTROL_UI_DEVICE_IDENTITY_REQUIRED,M.DEVICE_IDENTITY_REQUIRED]);function YW(e,t,n){if(e||!t)return null;let r=Ge(t);return r?{kind:r.reason===`scope-upgrade`?`scope-upgrade-pending`:r.reason===`role-upgrade`?`role-upgrade-pending`:r.reason===`metadata-upgrade`?`metadata-upgrade-pending`:`pairing-required`,requestId:r.requestId??null}:n===M.PAIRING_REQUIRED?{kind:`pairing-required`,requestId:null}:null}function XW(e){return e.connected||!e.lastError?null:e.lastErrorCode?qW.has(e.lastErrorCode)?KW.has(e.lastErrorCode)?`required`:`failed`:null:w(e.lastError).includes(`unauthorized`)?!e.hasToken&&!e.hasPassword?`required`:`failed`:null}function ZW(e,t,n){if(e||!t)return!1;if(n)return JW.has(n);let r=w(t);return r.includes(`secure context`)||r.includes(`device identity required`)}function QW(e){return e.includes(`insecure-http`)?S(`login.failure.docsInsecure`):e.includes(`device-pairing`)?S(`login.failure.docsPairing`):S(`login.failure.docsAuth`)}function $W(e){return e.replace(/([?#&])(?:access_token|auth|deviceToken|password|refresh_token|token)=([^&#\s]+)/gi,`$1[redacted-credential]`).replace(/\bBearer\s+([A-Za-z0-9._~+/-]+=*)/gi,`Bearer [redacted]`).replace(/(["']?(?:access|accessToken|deviceToken|password|refresh|refreshToken|token)["']?\s*[:=]\s*)["']?[^"',\s}]+/gi,`$1[redacted]`)}function eG(e){let t=e.docsHref??`https://docs.openclaw.ai/web/dashboard`;return{kind:e.kind,title:S(e.titleKey,e.stepParams),summary:S(e.summaryKey,e.stepParams),steps:e.stepKeys.map(t=>S(t,e.stepParams)),docsHref:t,docsLabel:QW(t),rawError:$W(e.rawError)}}function tG(e){if(e.connected||!e.lastError)return null;let t=e.lastError,n=e.lastErrorCode??null,r=w(t),i=YW(!1,t,n);if(i)return eG({kind:`pairing-required`,rawError:t,docsHref:`https://docs.openclaw.ai/web/control-ui#device-pairing-first-connection`,titleKey:i.kind===`scope-upgrade-pending`?`login.failure.pairing.scopeTitle`:i.kind===`role-upgrade-pending`?`login.failure.pairing.roleTitle`:i.kind===`metadata-upgrade-pending`?`login.failure.pairing.metadataTitle`:`login.failure.pairing.title`,summaryKey:i.kind===`pairing-required`?`login.failure.pairing.summary`:`login.failure.pairing.upgradeSummary`,stepKeys:[`login.failure.pairing.stepList`,i.requestId?`login.failure.pairing.stepApproveId`:`login.failure.pairing.stepApprove`,`login.failure.pairing.stepReconnect`],stepParams:{requestId:i.requestId??``}});if(n===M.AUTH_RATE_LIMITED||r.includes(`too many failed authentication attempts`)||r.includes(`rate limit`))return eG({kind:`auth-rate-limited`,rawError:t,titleKey:`login.failure.rateLimited.title`,summaryKey:`login.failure.rateLimited.summary`,stepKeys:[`login.failure.rateLimited.stepStop`,`login.failure.rateLimited.stepWait`,`login.failure.rateLimited.stepCheckClients`]});if(ZW(!1,t,n))return eG({kind:`insecure-context`,rawError:t,docsHref:`https://docs.openclaw.ai/web/control-ui#insecure-http`,titleKey:`login.failure.insecure.title`,summaryKey:`login.failure.insecure.summary`,stepKeys:[`login.failure.insecure.stepHttps`,`login.failure.insecure.stepLocalCompat`,`login.failure.insecure.stepAvoidDisable`]});if(n===M.CONTROL_UI_ORIGIN_NOT_ALLOWED||r.includes(`origin not allowed`))return eG({kind:`origin-not-allowed`,rawError:t,docsHref:`https://docs.openclaw.ai/web/control-ui#debuggingtesting-dev-server--remote-gateway`,titleKey:`login.failure.origin.title`,summaryKey:`login.failure.origin.summary`,stepKeys:[`login.failure.origin.stepAllowedOrigins`,`login.failure.origin.stepFullOrigin`,`login.failure.origin.stepRestart`]});if(r.includes(`protocol mismatch`))return eG({kind:`protocol-mismatch`,rawError:t,docsHref:`https://docs.openclaw.ai/web/control-ui#debuggingtesting-dev-server--remote-gateway`,titleKey:`login.failure.protocol.title`,summaryKey:`login.failure.protocol.summary`,stepKeys:[`login.failure.protocol.stepDashboard`,`login.failure.protocol.stepDevUi`,`login.failure.protocol.stepRestart`]});let a=XW({connected:!1,lastError:t,lastErrorCode:n,hasToken:e.hasToken,hasPassword:e.hasPassword});return eG(a===`required`?{kind:`auth-required`,rawError:t,titleKey:`login.failure.authRequired.title`,summaryKey:`login.failure.authRequired.summary`,stepKeys:[`login.failure.authRequired.stepPaste`,`login.failure.authRequired.stepGenerate`,`login.failure.authRequired.stepConnect`]}:a===`failed`?{kind:`auth-failed`,rawError:t,titleKey:`login.failure.authFailed.title`,summaryKey:`login.failure.authFailed.summary`,stepKeys:[`login.failure.authFailed.stepDashboard`,`login.failure.authFailed.stepReplace`,`login.failure.authFailed.stepMode`]}:{kind:`network`,rawError:t,titleKey:`login.failure.network.title`,summaryKey:`login.failure.network.summary`,stepKeys:[`login.failure.network.stepGateway`,`login.failure.network.stepUrl`,`login.failure.network.stepDashboard`]})}function nG(e){return c`
    <div
  ...
  `}function rG(e){let t=to(Hi(e.basePath??``)),n=tG({connected:e.connected,lastError:e.lastError,lastErrorCode:e.lastErrorCode,hasToken:!!e.settings.token.trim(),hasPassword:!!e.password.trim()});return c`
      ...
      <div class="login-gate__card">
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${S(`overview.connection.step1`)}${GW(`openclaw gateway run`)}
            </li>
            <li>${S(`overview.connection.step2`)} ${GW(`openclaw dashboard`)}</li>
  ...
  `}function iG(e){return typeof e==`string`?e.trim().toLowerCase():``}var aG=new Set([`token`,`key`,`api_key`,`apikey`,`secret`,`access_token`,`auth_token`,`password`,`pass`,`passwd`,`auth`,`jwt`,`session`,`id_token`,`code`,`client_secret`,`app_secret`,`hook_token`,`refresh_token`,`signature`,`x_amz_signature`,`x_amz_security_token`,`private_key`,`credential`,`authorization`]),oG=/[\p{C}\p{Z}\u115F\u1160\u3164\uFFA0+]/gu;function sG(e){let t=e.replace(oG,``);try{return iG(decodeURIComponent(t).replace(oG,``)).replaceAll(`-`,`_`)}catch{return iG(t).replaceAll(`-`,`_`)}}function cG(e){let t=sG(e);return aG.has(t)}function lG(e){try{let t=new URL(e),n=!1;(t.username||t.password)&&(t.username=t.username?`***`:``,t.password=t.password?`***`:``,n=!0);for(let e of Array.from(t.searchParams.keys()))cG(e)&&(t.searchParams.set(e,`***`),n=!0);return n?t.toString():e}catch{return e}}function uG(e){let t=lG(e);return t===e?e.replace(/\/\/([^@/?#\s]+)@/g,`//***:***@`).replace(/([?&])([^=&]+)=([^&]*)/g,(e,t,n)=>cG(n)?`${t}${n}=***`:e):t}function dG(e){return typeof e==`object`&&e&&!Array.isArray(e)?e:null}function fG(e){return dG(dG(e.mcp)?.servers)??{}}function pG(e,t){let n=dG(t)??{},r=typeof n.url==`string`?n.url:``,i=typeof n.command==`string`?n.command:``,a=r?`http`:i?`stdio`:`invalid`,o=typeof n.auth==`string`?n.auth:null,s=r||i||`missing transport`,c=n.sslVerify===!1?`TLS verify off`:n.clientCert||n.clientKey?`mTLS`:null;return{name:e,enabled:n.enabled!==!1,transport:a,auth:o,launch:r?uG(s):s,toolFilter:!!n.toolFilter,parallel:n.supportsParallelToolCalls===!0,tls:c}}function mG(e){return/^[A-Za-z0-9._:/-]+$/.test(e)?e:`'${e.replaceAll(`'`,`'\\''`)}'`}function hG(e,t){let n=mG(t.name),r=`openclaw mcp probe ${n}`,i=`openclaw mcp login ${n}`;return c`
  ...
  `}function gG(e){let t=Object.entries(fG(e.configObject)).map(([e,t])=>pG(e,t)).toSorted((e,t)=>e.name.localeCompare(t.name)),n=t.filter(e=>e.enabled).length,r=t.filter(e=>e.auth===`oauth`).length,i=t.filter(e=>e.toolFilter).length,a=!e.configDirty||!e.connected||e.configApplying||e.configSaving;return c`
  ...
  `}function _G(e){return e===`error`?`danger`:e===`warning`?`warn`:``}function vG(e){return e in q?q[e]:q.radio}function yG(e){return e.items.length===0?d:c`
    <section class="card ov-attention">
      <div class="card-title">${S(`overview.attention.title`)}</div>
      <div class="ov-attention-list">
        ${e.items.map(e=>c`
            <div class="ov-attention-item ${_G(e.severity)}">
              <span class="ov-attention-icon">${vG(e.icon)}</span>
  ...
  `}function bG(e){let t=e.ts??null;return t?Ls(t):S(`common.na`)}function xG(e){if(!e)return S(`common.na`);let t=fl(e,{weekday:`short`});return t===S(`common.na`)?t:`${t}, ${dl(e)} (${Ls(e)})`}function SG(e){if(e.totalTokens==null)return S(`common.na`);let t=e.totalTokens??0,n=e.contextTokens??0;return n?`${t} / ${n}`:String(t)}function CG(e){if(e==null)return``;try{return JSON.stringify(e,null,2)}catch{return ul(e)}}function wG(e){let t=e.state??{},n=t.nextRunAtMs?dl(t.nextRunAtMs):S(`common.na`),r=t.lastRunAtMs?dl(t.lastRunAtMs):S(`common.na`);return`${sx(e)} · next ${n} · last ${r}`}function TG(e){let t=e.schedule;if(t.kind===`at`){let e=Date.parse(t.at);return Number.isFinite(e)?`At ${dl(e)}`:`At ${t.at}`}return t.kind===`every`?`Every ${Is(t.everyMs)}`:`Cron ${t.expr}${t.tz?` (${t.tz})`:``}`}function EG(e){let t=e.payload;if(t.kind===`systemEvent`)return`System: ${t.text}`;if(t.kind===`command`)return`Command: ${t.argv.join(` `)}`;let n=`Agent: ${t.message}`,r=e.delivery;if(r&&r.mode!==`none`){let e=r.mode===`webhook`?r.to?` (${r.to})`:``:r.channel||r.to?` (${r.channel??`last`}${r.to?` -> ${r.to}`:``})`:``;return`${n} · ${r.mode}${e}`}return n}var DG=/\d{3,}/g;function OG(e){return c`${f(e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(DG,e=>`<span class="blur-digits">${e}</span>`))}`}function kG(e,t){return c`
  ...
  `}function MG(e){if(!(e.usageResult!=null||e.sessionsResult!=null||e.skillsReport!=null))return jG();let t=e.usageResult?.totals,n=yl(t?.totalCost),r=bl(t?.totalTokens),i=t?String(e.usageResult?.aggregates?.messages?.total??0):`0`,a=e.sessionsResult?.count??null,o=e.skillsReport?.skills??[],s=o.filter(e=>!e.disabled).length,l=o.filter(e=>e.blockedByAllowlist).length,u=o.length,f=e.cronStatus?.enabled??null,p=e.cronStatus?.nextWakeAtMs??null,m=e.cronJobs.length,h=e.cronJobs.filter(e=>sx(e)===`error`).length,g=e.modelAuthStatus===null,_=(e.modelAuthStatus?.providers??[]).filter(ME),v=AG(bR(_)),y=f==null?S(`common.na`):f?`${m} jobs`:S(`common.disabled`),b=h>0?c`<span class="danger">${h} failed</span>`:p?S(`overview.stats.cronNext`,{time:xG(p)}):``,x=[{kind:`cost`,tab:`usage`,label:S(`overview.cards.cost`),value:n,hint:`${r} tokens · ${i} msgs`},{kind:`sessions`,tab:`sessions`,label:S(`overview.stats.sessions`),value:String(a??S(`common.na`)),hint:S(`overview.stats.sessionsHint`)},{kind:`skills`,tab:`skills`,label:S(`overview.cards.skills`),value:`${s}/${u}`,hint:l>0?`${l} blocked`:`${s} active`},{kind:`cron`,tab:`cron`,label:S(`overview.stats.cron`),value:y,hint:b}];if(v&&x.splice(1,0,v),g)x.push({kind:`auth`,tab:`overview`,label:S(`overview.cards.modelAuth`),value:S(`common.na`),hint:``});else if(_.length>0){let e=_.filter(e=>e.status===`expired`||e.status===`missing`).length,t=_.filter(e=>e.status===`expiring`).length,n=e>0?c`<span class="danger"
    ...
    <section class="ov-cards">${x.map(t=>kG(t,e.onNavigate))}</section>
    ...
    ${C.length>0?c`
        ...
        `:d}
  `}function NG(e){if(e.events.length===0)return d;let t=e.events.slice(0,20);return c`
        ...
        ${t.map(e=>c`
            <div class="ov-event-log-entry">
              ...
              ${e.payload?c`<span class="ov-event-log-payload muted"
                    >${CG(e.payload).slice(0,120)}</span
                  >`:d}
            </div>
          `)}
      </div>
    </details>
  `}var PG=`\x1B`,FG=RegExp(`${PG}\\]8;;.*?${PG}\\\\|${PG}\\]8;;${PG}\\\\`,`g`),IG=RegExp(`${PG}\\[[0-9;]*m`,`g`);function LG(e){return e.replace(FG,``).replace(IG,``)}function RG(e){if(e.lines.length===0)return d;let t=e.lines.slice(-50).map(e=>LG(e)).join(`
`);return c`
  ...
  `}var zG={"pairing-required":{titleKey:null,summaryKey:null},"scope-upgrade-pending":{titleKey:`overview.pairing.scopeUpgradeTitle`,summaryKey:`overview.pairing.scopeUpgradeSummary`},"role-upgrade-pending":{titleKey:`overview.pairing.roleUpgradeTitle`,summaryKey:`overview.pairing.roleUpgradeSummary`},"metadata-upgrade-pending":{titleKey:`overview.pairing.metadataUpgradeTitle`,summaryKey:`overview.pairing.metadataUpgradeSummary`}};function BG(e){let t=e.hello?.snapshot,n=t?.uptimeMs?Is(t.uptimeMs):S(`common.na`),r=e.hello?.policy?.tickIntervalMs,i=r?`${(r/1e3).toFixed(r%1e3==0?0:1)}s`:S(`common.na`),a=t?.authMode===`trusted-proxy`,o=(()=>{let t=YW(e.connected,e.lastError,e.lastErrorCode);if(!t)return null;let n=zG[t.kind];return c`
    ...
    `})(),s=(()=>{let t=XW({connected:e.connected,lastError:e.lastError,lastErrorCode:e.lastErrorCode,hasToken:!!e.settings.token.trim(),hasPassword:!!e.password.trim()});return t==null?null:t===`required`?c`
        <div class="muted" style="margin-top: 8px">
    ...
    `})(),l=e.connected||!e.lastError||!(typeof window<`u`)||window.isSecureContext||!ZW(e.connected,e.lastError,e.lastErrorCode)?null:c`
      <div class="muted" style="margin-top: 8px">
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${GW(`openclaw gateway run`)}
                  </li>
                  <li>
                    ${S(`overview.connection.step2`)} ${GW(`openclaw dashboard`)}
                  </li>
                  <li>${S(`overview.connection.step3`)}</li>
                  <li>
    ...
    ${MG({usageResult:e.usageResult,sessionsResult:e.sessionsResult,skillsReport:e.skillsReport,cronJobs:e.cronJobs,cronStatus:e.cronStatus,modelAuthStatus:e.modelAuthStatus,presenceCount:e.presenceCount,onNavigate:e.onNavigate})}
    ${yG({items:e.attentionItems})}

    <div class="ov-section-divider"></div>

    <div class="ov-bottom-grid">
      ${NG({events:e.eventLog})}
      ${RG({lines:e.overviewLogLines,onRefreshLogs:e.onRefreshLogs})}
    </div>
  `}var VG,HG=()=>VG?.();function UG(e){return(...t)=>{e(...t)}}var WG=`openclaw:control-ui:skill-workshop-mode:v1`,GG=`openclaw:control-ui:skill-workshop-current-chat-revisions:v1`;function KG(){try{return T()?.getItem(WG)===`board`?`board`:`today`}catch{return`today`}}function qG(){try{return T()?.getItem(GG)===`true`}catch{return!1}}function JG(e,t){e.skillWorkshopUseCurrentChatForRevisions=t;try{T()?.setItem(GG,String(t))}catch{}}function YG(e,t){if(e.skillWorkshopMode!==t){e.skillWorkshopMode=t;try{T()?.setItem(WG,t)}catch{}}}function XG(e){let t=S(`skillWorkshop.header.useCurrentChat`);return c`
    <div class="sw-header-controls">
      ...
      >
        <input
          ...
          @change=${t=>JG(e,t.currentTarget.checked)}
        />
  ...
  `}function ZG(e,t){let n=C(t);if(!n)return null;let r=e.sessionsResult?.sessions.find(e=>e.key===n);if(r)return r;for(let t of Object.values(e.chatAgentSessionRowsByAgent??{})){let e=t.find(e=>e.key===n);if(e)return e}return null}function QG(e){return!!(e&&!e.archived&&!e.hasActiveRun)}async function $G(e,t){C(e.sessionsResultAgentId)===t&&e.sessionsResult?.sessions.length||await H(e,{...Cv(e),agentId:t})}async function eK(e,t){if(e.skillWorkshopUseCurrentChatForRevisions)return C(e.sessionKey)??null;let n=L(t.origin?.agentId??oK(e));await $G(e,n);let r=ZG(e,t.origin?.sessionKey);return QG(r)?r.key:_v(e,{agentId:n,label:`Skill Workshop: ${t.slug||t.key}`.slice(0,80)},{...Cv(e),agentId:n})}async function tK(e,t,n){if(!e.client||!e.connected)throw Error(`Gateway is not connected.`);let r=await eK(e,n);if(!r)throw Error(e.sessionsError??`Could not prepare a Skill Workshop session.`);e.tab!==`chat`&&e.setTab(`chat`),e.sessionKey===r?await qg(e):await dB(e,r);let i=n.origin?.agentId?.trim();await e.handleSendChat(t,{restoreDraft:!0,skillWorkshopRevision:{proposalId:n.key,...i?{agentId:i}:{}}})}function nK(e){return Gi(e.tab)?c`
  ...
  `:d}function rK(e,t){return c`
    <section class="settings-workspace">
      ${nK(e)}
      <div class="settings-workspace__body">${t}</div>
    </section>
  `}function iK(e){return e.chatLoading||e.chatSending||!!e.chatRunId||e.chatStream!==null||e.chatQueue.length>0}function aK(e){let t=e.hello?.snapshot;return L(e.agentsList?.defaultId??t?.sessionDefaults?.defaultAgentId??`main`)}function oK(e){let t=F(e.sessionKey);if(t)return L(t.agentId);let n=C(e.sessionKey)?.toLowerCase();return L(n===`global`||n===`unknown`?e.assistantAgentId??aK(e):aK(e))}function sK(e,t,n){return tu(t.key,n,aK(e))}function cK(e){let t=oK(e),n=C(e.sessionKey)?.toLowerCase()!==`unknown`;return(e.sessionsResult?.sessions??[]).filter(r=>!r.archived&&r.kind!==`global`&&r.kind!==`unknown`&&r.kind!==`cron`&&!DR(r.key)&&!nu(r.key)&&!r.spawnedBy&&(!n||sK(e,r,t))).toSorted((e,t)=>(t.updatedAt??0)-(e.updatedAt??0)).slice(0,5)}function lK(e){let t=e.settings.navCollapsed,n=iK(e),r=t?[]:cK(e),i=!e.connected||e.sessionsLoading||n||!e.client,a=e.connected?n?`Finish the active run before creating a new session`:`New session`:`Connect to create a new session`;return c`
    <section class="sidebar-sessions ${t?`sidebar-sessions--collapsed`:``}">
      <button
        ...
        aria-label=${S(`chat.runControls.newSession`)}
        ?disabled=${i}
        @click=${async()=>{i||await pB(e,{source:`user`})&&e.setTab(`chat`)}}
      >
      ...
      <div class="sidebar-session-select ${t?`sidebar-session-select--collapsed`:``}">
        ${IR(e,uB,{compact:t,sessionSwitcherOnly:!0,surface:`sidebar`})}
      </div>
      ${t||r.length===0?d:c`
            <div
  ...
  `}function uK(e,t){let n=t.key===e.sessionKey,r=ER(t.key,t),i=t.updatedAt?Ls(t.updatedAt):`n/a`;return c`
    <a
      ...
      title=${`${r} · ${t.key}`}
      @click=${n=>{n.defaultPrevented||n.button!==0||n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||(n.preventDefault(),t.key!==e.sessionKey&&uB(e,t.key),e.setTab(`chat`))}}
    >
  ...
  `}var dK=yB(()=>b(()=>import(`./agents-DXW5I9Hu.js`),__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url),HG),fK=yB(()=>b(()=>import(`./activity-DVLaIW6l.js`),__vite__mapDeps([7,1,2]),import.meta.url),HG),pK=yB(()=>b(()=>import(`./channels-B_8sFhoG.js`),__vite__mapDeps([8,1,2,5]),import.meta.url),HG),mK=yB(()=>b(()=>import(`./cron-BwStiiMe.js`),__vite__mapDeps([9,1,2]),import.meta.url),HG),hK=yB(()=>b(()=>import(`./debug-Di5v5M3S.js`),__vite__mapDeps([10,1,2]),import.meta.url),HG),gK=yB(()=>b(()=>import(`./instances-Xv4bijbt.js`),__vite__mapDeps([11,1,2]),import.meta.url),HG),_K=yB(()=>b(()=>import(`./logs-DIj0cuot.js`),__vite__mapDeps([12,1,2]),import.meta.url),HG),vK=yB(()=>b(()=>import(`./nodes-0GW7Mus7.js`),__vite__mapDeps([13,1,2]),import.meta.url),HG),yK=yB(()=>b(()=>import(`./sessions-C5N2RB5S.js`),__vite__mapDeps([14,1,2]),import.meta.url),HG),bK=yB(()=>b(()=>import(`./skill-workshop-BJBD-vYF.js`),__vite__mapDeps([15,2]),import.meta.url),HG),xK=yB(()=>b(()=>import(`./skills-BdpjqgIi.js`),__vite__mapDeps([16,1,2,6]),import.meta.url),HG),SK=yB(()=>b(()=>import(`./usage-DrSXS5uy.js`),__vite__mapDeps([17,1,2]),import.meta.url),HG),CK=yB(()=>b(()=>import(`./workboard-B6Wkq2cc.js`),__vite__mapDeps([18,1,2]),import.meta.url),HG),wK=new WeakMap,TK=new WeakMap;function EK(e,t){let n=wK.get(e);if(n?.agentId===t)return n;let r={activeName:null,agentId:t,error:null,list:null,loading:!1,requestId:0};return wK.set(e,r),r}function DK(e){return pl(e,{hour:`numeric`,minute:`2-digit`},``)||null}function OK(e){if(!e?.phases)return null;let t;for(let n of Object.values(e.phases))!n.enabled||typeof n.nextRunAtMs!=`number`||(t===void 0||n.nextRunAtMs<t)&&(t=n.nextRunAtMs);return DK(t)}var kK=null,AK=`openclaw:control-ui:update-banner-dismissed:v1`,jK=[`off`,`minimal`,`low`,`medium`,`high`],MK=[`UTC`,`America/Los_Angeles`,`America/Denver`,`America/Chicago`,`America/New_York`,`Europe/London`,`Europe/Berlin`,`Asia/Tokyo`];function NK(e){return/^https?:\/\//i.test(e.trim())}function PK(e){return typeof e==`string`?e.trim():``}function FK(e){let t=new Set,n=[];for(let r of e){let e=r.trim();if(!e)continue;let i=e.toLowerCase();t.has(i)||(t.add(i),n.push(e))}return n}function IK(){try{let e=T()?.getItem(AK);if(!e)return null;let t=JSON.parse(e);return!t||typeof t.latestVersion!=`string`?null:{latestVersion:t.latestVersion,channel:typeof t.channel==`string`?t.channel:null,dismissedAtMs:typeof t.dismissedAtMs==`number`?t.dismissedAtMs:Date.now()}}catch{return null}}function LK(e){let t=IK();if(!t)return!1;let n=e,r=n&&typeof n.latestVersion==`string`?n.latestVersion:null,i=n&&typeof n.channel==`string`?n.channel:null;return!!(r&&t.latestVersion===r&&t.channel===i)}function RK(e){let t=e,n=t&&typeof t.latestVersion==`string`?t.latestVersion:null;if(!n)return;let r={latestVersion:n,channel:t&&typeof t.channel==`string`?t.channel:null,dismissedAtMs:Date.now()};try{T()?.setItem(AK,JSON.stringify(r))}catch{}}var zK=[`messages`,`broadcast`,`__notifications__`,`talk`,`audio`,`channels`],BK=[`__appearance__`,`ui`,`wizard`],VK=[`commands`,`hooks`,`bindings`,`cron`,`approvals`,`plugins`],HK=[`gateway`,`web`,`browser`,`nodeHost`,`canvasHost`,`discovery`,`media`,`acp`,`mcp`],UK=[`agents`,`models`,`skills`,`tools`,`memory`,`session`],WK=new Set([...zK,...BK,...VK,...HK,...UK]);function GK(e,t){return e&&WK.has(e)?{activeSection:null,activeSubsection:null}:{activeSection:e,activeSubsection:t}}function KK(e,t,n){return e&&!n.includes(e)?{activeSection:null,activeSubsection:null}:{activeSection:e,activeSubsection:t}}function qK(e,t,n){if(!e||typeof e!=`object`||Array.isArray(e))return 0;let r=e.properties;if(!r||typeof r!=`object`||Array.isArray(r))return 0;let i=t?.length?new Set(t):null,a=n?.length?new Set(n):null;return Object.keys(r).filter(e=>!(i&&!i.has(e)||a?.has(e))).length}function JK(e,t,n,r){let i=B(),a=r();return ih(e,t,{...n,durationMs:V(B()-i)}),a}function YK(e){return n([e.sessionKey,e.connected,e.client,e.onboarding,e.chatManualRefreshInFlight,e.chatLoading,e.chatSending,e.chatStream,e.chatRunId,e.chatMobileControlsOpen,e.sessionsHideCron??!0,e.sessionsResult,e.sessionsShowArchived,e.agentsList,e.chatModelOverrides,e.chatModelSwitchPromises,e.chatModelsLoading,e.chatModelCatalog,e.settings.chatShowThinking,e.settings.chatShowToolCalls,e.settings.chatAutoScroll,e.chatSessionPickerOpen,e.chatSessionPickerSurface,e.chatSessionPickerQuery,e.chatSessionPickerAppliedQuery,e.chatSessionPickerLoading,e.chatSessionPickerError,e.chatSessionPickerResult,e.sessionSwitchNotice?.id??null,e.sessionSwitchNotice?.text??null,e.sessionSwitchFlashKey,g.getLocale()],()=>cB(e))}function XK(e){let t=e.agentsList?.agents??[],n=F(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`,r=t.find(e=>e.id===n)?.identity,i=r?.avatarUrl??r?.avatar;if(i&&Qa(i))return i}function ZK(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e.ui;if(!t||typeof t!=`object`||Array.isArray(t))return null;let n=t.assistant;return!n||typeof n!=`object`||Array.isArray(n)?null:C(n.avatar)??null}function QK(e,t){let n=Hi(e??``),r=encodeURIComponent(t);return n?`${n}/avatar/${r}`:`/avatar/${r}`}var $K=[{id:`telegram`,label:`Telegram`},{id:`discord`,label:`Discord`},{id:`slack`,label:`Slack`},{id:`whatsapp`,label:`WhatsApp`},{id:`signal`,label:`Signal`},{id:`imessage`,label:`iMessage`}];function eq(e){let t=e.trim();return t?t.split(/[-_]+/).filter(Boolean).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `):`Unknown`}function tq(e){let t=e.configForm??e.configSnapshot?.config;if(!t||typeof t!=`object`)return[];let n=`channels`in t&&t.channels&&typeof t.channels==`object`?t.channels:{},r=Object.keys(n).filter(e=>e.trim().length>0),i=r.length>0?r.toSorted((e,t)=>e.localeCompare(t)):$K.map(({id:e})=>e),a=new Map($K.map(({id:e,label:t})=>[e,t])),o=[];for(let e of i){let t=n[e],r=typeof t==`object`&&!!t&&Object.keys(t).length>0;o.push({id:e,label:a.get(e)??eq(e),connected:r,detail:r?`Configured`:void 0})}return o}function nq(e){let t=e.configForm??e.configSnapshot?.config;if(!t||typeof t!=`object`)return 0;let n=t.mcp;if(!n||typeof n!=`object`)return 0;let r=`servers`in n&&n.servers&&typeof n.servers==`object`?n.servers:{};return Object.keys(r).length}function rq(e){let t=e.configForm??e.configSnapshot?.config;if(!t||typeof t!=`object`)return{gatewayAuth:`unknown`,execPolicy:`unknown`,deviceAuth:!1,browserEnabled:!0,toolProfile:`full`};let n=t,r=`gateway`in n&&n.gateway&&typeof n.gateway==`object`?n.gateway:null,i=r&&`auth`in r&&r.auth&&typeof r.auth==`object`?r.auth:null,a=`unknown`;i&&(a=(typeof i.mode==`string`?i.mode.trim():``)||(i.password?`password`:i.token?`token`:i.trustedProxy?`trusted-proxy`:`none`));let o=`allowlist`,s=`full`,c=n.tools;if(c&&typeof c==`object`){let e=c.profile;if(typeof e==`string`){let t=e.trim();t&&(s=t)}let t=c.exec;if(t&&typeof t==`object`){let e=t.security;if(typeof e==`string`){let t=e.trim();t&&(o=t)}}}let l=!0,u=`browser`in n&&n.browser&&typeof n.browser==`object`?n.browser:null;u&&typeof u.enabled==`boolean`&&(l=u.enabled);let d=!0;return r&&(`controlUi`in r&&r.controlUi&&typeof r.controlUi==`object`?r.controlUi:null)?.dangerouslyDisableDeviceAuth===!0&&(d=!1),{gatewayAuth:a,execPolicy:o,deviceAuth:d,browserEnabled:l,toolProfile:s}}function iq(e){return e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey)}function aq(e,t){return vU({open:e.cronQuickCreateOpen,step:e.cronQuickCreateStep,draft:e.cronQuickCreateDraft??cU(),onDraftChange:n=>{e.cronQuickCreateDraft={...e.cronQuickCreateDraft??cU(),...n},t?.()},onStepChange:n=>{e.cronQuickCreateStep=n,t?.()},onCreate:()=>{let n=uU(e.cronQuickCreateDraft??cU());e.cronEditingJobId=null,e.cronForm={...ub,...n},t?.(),(async()=>{if(!await Mx(e)){t?.();return}e.cronQuickCreateOpen=!1,e.cronQuickCreateStep=`what`,e.cronQuickCreateDraft=null,t?.()})()},onAdvancedCreate:()=>{let n=uU(e.cronQuickCreateDraft??cU());e.cronEditingJobId=null,e.cronForm=ux({...ub,...n}),e.cronFieldErrors=dx(e.cronForm),e.cronQuickCreateOpen=!1,e.cronQuickCreateStep=`what`,e.cronQuickCreateDraft=null,e.cronFormCollapsed=!1,t?.()},onCancel:()=>{e.cronQuickCreateOpen=!1,e.cronQuickCreateStep=`what`,e.cronQuickCreateDraft=null,t?.()}})}function oq(e,t){return/\.(?:md|markdown|mdx)$/i.test(e)?t:`# ${e}\n\n\`\`\`${e.match(/\.([a-z0-9_-]+)$/i)?.[1]?.toLowerCase()??``}\n${t}\n\`\`\``}function sq(e){let t=e,n=typeof t.requestUpdate==`function`?()=>t.requestUpdate?.():void 0;if(VG=n,!e.connected)return c` ${rG(e)} ${UW(e)} `;let r=e.presenceEntries.length,i=e.sessionsResult?.count??null,a=e.cronStatus?.nextWakeAtMs??null,o=e.connected?null:S(`chat.disconnected`),s=e.tab===`chat`,l=!s&&e.lastError!==e.chatError?e.lastError:null,u=e.lastError,f=s&&(e.onboarding||e.chatHeaderControlsHidden),p=e.navDrawerOpen&&!e.onboarding,h=e.settings.navCollapsed&&!p,g=Jz(e),_=e.onboarding?!1:e.settings.chatShowThinking,v=e.onboarding?!0:e.settings.chatShowToolCalls,y=C(fs().avatar)??null,b=XK(e),x=y?`data`:e.chatAvatarStatus??e.assistantAvatarStatus??null,ee=y?null:e.chatAvatarReason??e.assistantAvatarReason??null,w=x===`none`&&ee===`missing`,T=y??(w?null:e.assistantAvatar),te=y??e.chatAvatarUrl??(w?null:b??null),ne=y?`data`:e.assistantAvatarStatus??e.chatAvatarStatus??null,E=y?null:e.assistantAvatarReason??e.chatAvatarReason??null,re=y??e.assistantAvatarSource??e.chatAvatarSource??null,D=ne===`none`&&E===`missing`,ie=y??(D||ne===`local`?null:e.assistantAvatar),ae=y??(ne===`local`&&e.assistantAgentId?QK(e.basePath,e.assistantAgentId):e.chatAvatarUrl??(D?null:b??null)),oe=e.configForm??e.configSnapshot?.config,se=fS(oe),ce=e.dreamingStatus?.enabled??se.enabled,O=OK(e.dreamingStatus),le=Hz(e),ue=Lz(e,e.sessionKey),k=()=>{e.selectedAgentId=ue},de=e.dreamingStatusLoading||e.dreamingModeSaving,fe=e.dreamingStatusLoading||e.dreamDiaryLoading,pe=()=>{(async()=>{k(),await nr(e),await Promise.all([DS(e),OS(e),kS(e),AS(e)])})()},me=async t=>{if(!e.client||!e.connected)return null;let n=await e.client.request(`wiki.get`,{lookup:t,fromLine:1,lineCount:5e3}),r=typeof n?.title==`string`&&n.title.trim()?n.title.trim():t,i=typeof n?.path==`string`&&n.path.trim()?n.path.trim():t,a=typeof n?.content==`string`&&n.content.length>0?n.content:`No wiki content available.`,o=typeof n?.updatedAt==`string`&&n.updatedAt.trim()?n.updatedAt.trim():void 0,s=typeof n?.totalLines==`number`&&Number.isFinite(n.totalLines)?Math.max(0,Math.floor(n.totalLines)):void 0,c=n?.truncated===!0;return{title:r,path:i,content:a,...s===void 0?{}:{totalLines:s},...c?{truncated:c}:{},...o?{updatedAt:o}:{}}},he=t=>{e.dreamingModeSaving||e.dreamingRestartConfirmLoading||e.dreamingRestartConfirmOpen||ce===t||(e.dreamingPendingEnabled=t,e.dreamingRestartConfirmOpen=!0,e.dreamingStatusError=null)},ge=()=>{e.dreamingRestartConfirmLoading||(e.dreamingRestartConfirmOpen=!1,e.dreamingPendingEnabled=null,e.dreamingStatusError=null)},_e=()=>{let t=e.dreamingPendingEnabled;t==null||e.dreamingRestartConfirmLoading||(async()=>{e.dreamingRestartConfirmLoading=!0,e.dreamingStatusError=null;try{if(!await HS(e,t)){e.dreamingStatusError||=S(`dreaming.restartConfirmation.failed`);return}await nr(e),await DS(e),e.dreamingRestartConfirmOpen=!1,e.dreamingPendingEnabled=null}finally{e.dreamingRestartConfirmLoading=!1}})()},ve=Hi(e.basePath??``),ye=()=>e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??null,A=ye(),be=C(e.sessionKey)?.toLowerCase(),Se=be===`global`?null:eu(e.sessionKey),Ce=Nv(e,e.sessionKey).agentId,we=L(e.assistantAgentId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??`main`),Te=()=>{let t=C(e.sessionKey)?.toLowerCase(),n=t===`global`?null:eu(e.sessionKey),r=Nv(e,e.sessionKey).agentId;return t===`global`?r??we:n??r??we},Ee=be===`global`?Ce??we:Se??Ce??we,De=!!(A&&A===Ee),j=EK(e,Ee),Oe=()=>Te()===Ee?EK(e,Ee):null,ke=()=>e.configForm??e.configSnapshot?.config,M=e=>Er(ke(),e),Ae=t=>Dr(e,t),je=(e,t)=>{let n=t?Ae(e):M(e);return n>=0?[`agents`,`list`,n,`tools`]:null},Me=e=>{let t=ke()?.agents?.list,n=Array.isArray(t)?t[e]?.model:void 0;return{basePath:[`agents`,`list`,e,`model`],existing:n}},Ne=bo(new Set([...e.agentsList?.agents?.map(e=>e.id.trim())??[],...e.cronJobs.map(e=>typeof e.agentId==`string`?e.agentId.trim():``).filter(Boolean)].filter(Boolean))),Pe=bo(new Set([...e.cronModelSuggestions,...xo(oe),...e.cronJobs.map(e=>{let t=ax(e);return t?.kind!==`agentTurn`||typeof t.model!=`string`?``:t.model.trim()}).filter(Boolean)].filter(Boolean))),Fe=yx(e),Ie=e.cronForm.deliveryChannel&&e.cronForm.deliveryChannel.trim()?e.cronForm.deliveryChannel.trim():`last`,Le=e.cronJobs.map(e=>PK(e.delivery?.to)).filter(Boolean),Re=(Ie===`last`?Object.values(e.channelsSnapshot?.channelAccounts??{}).flat():e.channelsSnapshot?.channelAccounts?.[Ie]??[]).flatMap(e=>[PK(e.accountId),PK(e.name)]).filter(Boolean),ze=FK([...Le,...Re]),Be=FK(Re),Ve=e.cronForm.deliveryMode===`webhook`?ze.filter(e=>NK(e)):ze,He={raw:e.configRaw,originalRaw:e.configRawOriginal,valid:e.configValid,issues:e.configIssues,loading:e.configLoading,saving:e.configSaving,applying:e.configApplying,updating:e.updateRunning,connected:e.connected,schema:e.configSchema,schemaLoading:e.configSchemaLoading,uiHints:e.configUiHints,formValue:e.configForm,originalValue:e.configFormOriginal,onRawChange:t=>{xr(e,t)},onRequestUpdate:n,onFormPatch:(t,n)=>br(e,t,n),onReload:()=>void nr(e,{discardPendingChanges:!0}),onReset:()=>Cr(e),onSave:()=>void pr(e),onApply:()=>void mr(e),onUpdate:()=>void hr(e),onOpenFile:()=>void kr(e),version:e.hello?.server?.version??``,theme:e.theme,themeMode:e.themeMode,setTheme:(t,n)=>e.setTheme(t,n),setThemeMode:(t,n)=>e.setThemeMode(t,n),hasCustomTheme:!!e.settings.customTheme,customThemeLabel:e.settings.customTheme?.label??null,customThemeSourceUrl:e.settings.customTheme?.sourceUrl??null,customThemeImportUrl:e.customThemeImportUrl,customThemeImportBusy:e.customThemeImportBusy,customThemeImportMessage:e.customThemeImportMessage,customThemeImportExpanded:e.customThemeImportExpanded,customThemeImportFocusToken:e.customThemeImportFocusToken,onCustomThemeImportUrlChange:t=>e.setCustomThemeImportUrl(t),onOpenCustomThemeImport:()=>e.openCustomThemeImport(),onImportCustomTheme:()=>void e.importCustomTheme(),onClearCustomTheme:()=>e.clearCustomTheme(),borderRadius:e.settings.borderRadius,setBorderRadius:t=>e.setBorderRadius(t),textScale:e.settings.textScale??100,setTextScale:t=>e.setTextScale(t),gatewayUrl:e.settings.gatewayUrl,assistantName:e.assistantName,configPath:e.configSnapshot?.path??null,rawAvailable:typeof e.configSnapshot?.raw==`string`||!!e.configSnapshot?.config||!!e.configForm},Ue=t=>{let n=t.includeSections?.[0]??null,r=t.activeSection??n,i=t.showRootTab??!t.includeSections?.length;return JK(e,`config`,{tab:e.tab,formMode:t.formMode,activeSection:r,activeSubsection:t.activeSubsection,schemaSectionCount:qK(He.schema,t.includeSections,t.excludeSections),hasSearch:!!t.searchQuery?.trim()},()=>aU({...He,includeVirtualSections:!1,...t,activeSection:r,showRootTab:i}))},We=GK(e.configActiveSection,e.configActiveSubsection),Ge=KK(e.communicationsActiveSection,e.communicationsActiveSubsection,zK),Ke=KK(e.appearanceActiveSection,e.appearanceActiveSubsection,BK),qe=KK(e.automationActiveSection,e.automationActiveSubsection,VK),Je=KK(e.infrastructureActiveSection,e.infrastructureActiveSubsection,HK),Ye=KK(e.aiAgentsActiveSection,e.aiAgentsActiveSubsection,UK),Xe=()=>{switch(e.tab){case`config`:if(e.configSettingsMode===`quick`){let t=e.configForm??e.configSnapshot?.config??{},r=y??ZK(t),i=t.agents?.defaults??{},a=iq(e),o=typeof a?.model==`string`?a.model:typeof i.model==`string`?i.model:`default`,s=typeof a?.thinkingLevel==`string`?a.thinkingLevel:typeof i.thinkingLevel==`string`?i.thinkingLevel:`off`,c=typeof a?.fastMode==`boolean`?a.fastMode:i.fastMode===!0;return FV({currentModel:o,thinkingLevel:s,fastMode:c,onModelChange:()=>{e.configSettingsMode=`advanced`,e.aiAgentsActiveSection=`models`,e.setTab(`aiAgents`)},onThinkingChange:t=>{gv(e,e.sessionKey,{thinkingLevel:t}).then(()=>n?.())},onFastModeToggle:()=>{gv(e,e.sessionKey,{fastMode:!c}).then(()=>n?.())},channels:tq(e),onChannelConfigure:()=>{e.setTab(`channels`)},automation:{cronJobCount:e.cronJobs?.length??0,skillCount:e.skillsReport?.skills?.length??0,mcpServerCount:nq(e)},onManageCron:()=>{e.setTab(`cron`)},onBrowseSkills:()=>{e.setTab(`skills`)},onConfigureMcp:()=>{e.setTab(`mcp`)},security:rq(e),onSecurityConfigure:()=>{e.configSettingsMode=`advanced`,e.configActiveSection=`auth`,n?.()},onBrowserEnabledToggle:t=>{br(e,[`browser`,`enabled`],t),n?.()},onToolProfileChange:t=>{br(e,[`tools`,`profile`],t),n?.()},theme:e.theme,themeMode:e.themeMode,hasCustomTheme:!!e.settings.customTheme,customThemeLabel:e.settings.customTheme?.label??null,borderRadius:e.settings.borderRadius,textScale:e.settings.textScale??100,setTheme:(t,n)=>e.setTheme(t,n),onOpenCustomThemeImport:()=>{e.setTab(`appearance`),e.appearanceFormMode=`form`,e.appearanceSearchQuery=``,e.appearanceActiveSection=`__appearance__`,e.appearanceActiveSubsection=null,e.openCustomThemeImport(),n?.()},setThemeMode:(t,n)=>e.setThemeMode(t,n),setBorderRadius:t=>e.setBorderRadius(t),setTextScale:t=>e.setTextScale(t),userAvatar:e.userAvatar??null,onUserAvatarChange:t=>e.applyLocalUserIdentity?.({avatar:t}),assistantAvatar:ie,assistantAvatarUrl:ae,assistantAvatarSource:re,assistantAvatarStatus:ne,assistantAvatarReason:E,assistantAvatarOverride:r,assistantAvatarUploadBusy:e.assistantAvatarUploadBusy,assistantAvatarUploadError:e.assistantAvatarUploadError,onAssistantAvatarOverrideChange:t=>{DI(e,t),e.chatAvatarUrl=t,e.chatAvatarSource=t,e.chatAvatarStatus=`data`,e.chatAvatarReason=null,e.assistantAvatarUploadError=null,n?.()},onAssistantAvatarClearOverride:()=>{DI(e,null),e.chatAvatarUrl=null,e.chatAvatarSource=null,e.chatAvatarStatus=null,e.chatAvatarReason=null,e.assistantAvatarUploadError=null,e.loadAssistantIdentity?.().finally(()=>n?.()),n?.()},basePath:e.basePath??``,configObject:t,savedConfigObject:e.configSnapshot?.config??{},configDirty:e.configFormDirty,configSaving:e.configSaving,configApplying:e.configApplying,configReady:!!e.configSnapshot?.hash,onSelectPreset:t=>{let r=tV(t);r&&(Sr(e,r.patch),n?.())},onResetConfig:()=>Cr(e),onSaveConfig:()=>void pr(e),onApplyConfig:()=>void mr(e),onAdvancedSettings:()=>{e.configSettingsMode=`advanced`,n?.()},connected:e.connected,gatewayUrl:e.settings.gatewayUrl,assistantName:e.assistantName,version:e.hello?.server?.version??``})}return Ue({formMode:e.configFormMode,searchQuery:e.configSearchQuery,activeSection:We.activeSection,activeSubsection:We.activeSubsection,onFormModeChange:t=>e.configFormMode=t,onSearchChange:t=>e.configSearchQuery=t,onSectionChange:t=>{e.configActiveSection=t,e.configActiveSubsection=null},onSubsectionChange:t=>e.configActiveSubsection=t,showModeToggle:!0,settingsLayout:`accordion`,onBackToQuick:()=>{e.configSettingsMode=`quick`,n?.()},excludeSections:[...zK,...VK,...HK,...UK,`ui`,`wizard`]});case`channels`:return xB(pK,t=>t.renderChannels({connected:e.connected,loading:e.channelsLoading,snapshot:e.channelsSnapshot,lastError:e.channelsError,lastSuccessAt:e.channelsLastSuccess,whatsappMessage:e.whatsappLoginMessage,whatsappQrDataUrl:e.whatsappLoginQrDataUrl,whatsappConnected:e.whatsappLoginConnected,whatsappBusy:e.whatsappBusy,configSchema:e.configSchema,configSchemaLoading:e.configSchemaLoading,configForm:e.configForm,configUiHints:e.configUiHints,configSaving:e.configSaving,configFormDirty:e.configFormDirty,nostrProfileFormState:e.nostrProfileFormState,nostrProfileAccountId:e.nostrProfileAccountId,onRefresh:t=>void on(e,t),onWhatsAppStart:t=>void e.handleWhatsAppStart(t),onWhatsAppWait:()=>void e.handleWhatsAppWait(),onWhatsAppLogout:()=>void e.handleWhatsAppLogout(),onConfigPatch:(t,n)=>br(e,t,n),onConfigSave:()=>void e.handleChannelConfigSave(),onConfigReload:()=>void e.handleChannelConfigReload(),onNostrProfileEdit:(t,n)=>e.handleNostrProfileEdit(t,n),onNostrProfileCancel:()=>e.handleNostrProfileCancel(),onNostrProfileFieldChange:(t,n)=>e.handleNostrProfileFieldChange(t,n),onNostrProfileSave:()=>void e.handleNostrProfileSave(),onNostrProfileImport:()=>void e.handleNostrProfileImport(),onNostrProfileToggleAdvanced:()=>e.handleNostrProfileToggleAdvanced()}));case`communications`:return Ue({formMode:e.communicationsFormMode,searchQuery:e.communicationsSearchQuery,activeSection:Ge.activeSection,activeSubsection:Ge.activeSubsection,onFormModeChange:t=>e.communicationsFormMode=t,onSearchChange:t=>e.communicationsSearchQuery=t,onSectionChange:t=>{e.communicationsActiveSection=t,e.communicationsActiveSubsection=null},onSubsectionChange:t=>e.communicationsActiveSubsection=t,navRootLabel:`Communication`,includeSections:[...zK],includeVirtualSections:!0,webPush:{supported:e.webPushSupported,permission:e.webPushPermission,subscribed:e.webPushSubscribed,loading:e.webPushLoading},onWebPushSubscribe:()=>void e.handleWebPushSubscribe(),onWebPushUnsubscribe:()=>void e.handleWebPushUnsubscribe(),onWebPushTest:()=>void e.handleWebPushTest()});case`appearance`:return Ue({formMode:e.appearanceFormMode,searchQuery:e.appearanceSearchQuery,activeSection:Ke.activeSection,activeSubsection:Ke.activeSubsection,onFormModeChange:t=>e.appearanceFormMode=t,onSearchChange:t=>e.appearanceSearchQuery=t,onSectionChange:t=>{e.appearanceActiveSection=t,e.appearanceActiveSubsection=null},onSubsectionChange:t=>e.appearanceActiveSubsection=t,navRootLabel:S(`tabs.appearance`),includeSections:[...BK],includeVirtualSections:!0});case`automation`:return Ue({formMode:e.automationFormMode,searchQuery:e.automationSearchQuery,activeSection:qe.activeSection,activeSubsection:qe.activeSubsection,onFormModeChange:t=>e.automationFormMode=t,onSearchChange:t=>e.automationSearchQuery=t,onSectionChange:t=>{e.automationActiveSection=t,e.automationActiveSubsection=null},onSubsectionChange:t=>e.automationActiveSubsection=t,navRootLabel:`Automation`,includeSections:[...VK]});case`mcp`:return gG({configObject:e.configForm??(e.configSnapshot?.config||{}),configDirty:e.configFormDirty,configSaving:e.configSaving,configApplying:e.configApplying,connected:e.connected,onSaveConfig:()=>void pr(e),onApplyConfig:()=>void mr(e),onServerEnabledChange:(t,r)=>{Tr(e,t,r),n?.()},editor:Ue({formMode:`form`,searchQuery:``,activeSection:`mcp`,activeSubsection:null,onFormModeChange:()=>void 0,onSearchChange:()=>void 0,onSectionChange:()=>{e.infrastructureActiveSection=`mcp`,e.infrastructureActiveSubsection=null},onSubsectionChange:t=>e.infrastructureActiveSubsection=t,navRootLabel:`MCP`,includeSections:[`mcp`]})});case`infrastructure`:return Ue({formMode:e.infrastructureFormMode,searchQuery:e.infrastructureSearchQuery,activeSection:Je.activeSection,activeSubsection:Je.activeSubsection,onFormModeChange:t=>e.infrastructureFormMode=t,onSearchChange:t=>e.infrastructureSearchQuery=t,onSectionChange:t=>{e.infrastructureActiveSection=t,e.infrastructureActiveSubsection=null},onSubsectionChange:t=>e.infrastructureActiveSubsection=t,navRootLabel:`Infrastructure`,includeSections:[...HK]});case`aiAgents`:return Ue({formMode:e.aiAgentsFormMode,searchQuery:e.aiAgentsSearchQuery,activeSection:Ye.activeSection,activeSubsection:Ye.activeSubsection,onFormModeChange:t=>e.aiAgentsFormMode=t,onSearchChange:t=>e.aiAgentsSearchQuery=t,onSectionChange:t=>{e.aiAgentsActiveSection=t,e.aiAgentsActiveSubsection=null},onSubsectionChange:t=>e.aiAgentsActiveSubsection=t,navRootLabel:`AI & Agents`,includeSections:[...UK]});default:return d}},Ze=t=>{if(t)switch(e.agentsPanel){case`files`:Vb(e,t);return;case`skills`:Kb(e,t);return;case`tools`:Xb(e,t),ex(e);case`overview`:case`channels`:case`cron`:}},Qe=t=>{if(t===`channels`){on(e,!1);return}t===`cron`&&e.loadCron()},$e=(t=!1)=>{e.agentFilesList=null,e.agentFilesError=null,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},t&&(e.agentFilesLoading=!1)},et=()=>{$e(!0),e.agentSkillsReport=null,e.agentSkillsError=null,e.agentSkillsAgentId=null,e.toolsCatalogResult=null,e.toolsCatalogError=null,e.toolsCatalogLoading=!1,Qb(e)};s&&e.connected&&e.agentsList&&!j.loading&&!j.error&&j.list?.agentId!==Ee&&nt();let tt=()=>{nt({force:!0})};function nt(t){if(!e.client||!e.connected||j.loading)return;let r=j.requestId+1;j.requestId=r,j.loading=!0,j.error=null,t?.force&&(j.list=null);let i=j;(async()=>{try{let t=await e.client?.request(`agents.files.list`,{agentId:Ee}),n=Oe();if(n!==i||n.requestId!==r)return;n.list=t??null,n.activeName&&!t?.files.some(e=>e.name===n.activeName)&&(n.activeName=null)}catch(e){let t=Oe();t===i&&t.requestId===r&&(t.error=String(e))}finally{let e=Oe();e===i&&e.requestId===r&&(e.loading=!1),n?.()}})()}let rt=t=>{j.activeName=t;let r={agentId:Ee,id:(TK.get(e)?.id??0)+1,name:t,sessionKey:e.sessionKey};TK.set(e,r);let i=()=>{let n=TK.get(e),i=Oe();return n?.id===r.id&&n.agentId===Te()&&n.name===t&&n.sessionKey===e.sessionKey&&i?.activeName===t};(async()=>{if(!(!e.client||!e.connected)){j.error=null;try{let r=(await e.client.request(`agents.files.get`,{agentId:Ee,name:t}))?.file?.content;if(typeof r!=`string`){i()&&(j.error=`Failed to load ${t}`,n?.());return}if(!i())return;e.handleOpenSidebar({kind:`markdown`,content:oq(t,r),rawText:r})}catch(e){i()&&(j.error=String(e))}finally{n?.()}}})()};return c`
    ${$B({open:e.paletteOpen,query:e.paletteQuery,activeIndex:e.paletteActiveIndex,onOpen:()=>{Gy(e).finally(n)},onToggle:()=>{e.paletteOpen=!e.paletteOpen},onQueryChange:t=>{e.paletteQuery=t},onActiveIndexChange:t=>{e.paletteActiveIndex=t},onNavigate:t=>{e.setTab(t)},onSlashCommand:t=>{e.setTab(`chat`),e.handleChatDraftChange(t.endsWith(` `)?t:`${t} `)}})}
    <div
    ...
    >
      ...
      >
        <div class="topnav-shell">
          ...
          <div class="topnav-shell__actions">
            ...
            <div class="topbar-status">${_B(e)}</div>
          </div>
        </div>
      </header>
      <div class="shell-nav">
          ...
          <div class="sidebar-shell">
                ...
                ${Li.map(t=>{let n=e.settings.navGroupsCollapsed[t.label]??!1,r=h||!n;return c`
                    <section class="nav-section ${r?``:`nav-section--collapsed`}">
                      ...
                      <div class="nav-section__items">
                        ${t.tabs.map(t=>rB(e,t,{collapsed:h}))}
                      </div>
                    </section>
                  `})}
              </nav>
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                ...
                <div class="sidebar-mode-switch">${_B(e)}</div>
      ...
      >
        ...
        ${e.updateAvailable&&e.updateAvailable.latestVersion!==e.updateAvailable.currentVersion&&!LK(e.updateAvailable)?c`<div class="update-banner callout danger" role="alert">
              ...
              <button
                ...
                @click=${()=>{RK(e.updateAvailable),e.updateAvailable=null}}
              >
                ${q.x}
              </button>
            </div>`:d}
