...
export { PluginApprovalResolutions, type PluginApprovalResolution, type PluginHookBeforeToolCallResult, } from "./hook-before-tool-call-result.js";
...
/** @deprecated Use gateway_stop. */
 | "deactivate" | "gateway_start" | "gateway_stop" | "heartbeat_prompt_contribution" | "cron_changed" | "before_dispatch" | "reply_dispatch" | "before_install" | "before_agent_run" | "resolve_exec_env";
...
export declare const DEPRECATED_PLUGIN_HOOKS: {
...
export declare const DEPRECATED_PLUGIN_HOOK_NAMES: DeprecatedPluginHookName[];
export declare const isDeprecatedPluginHookName: (hookName: PluginHookName) => hookName is DeprecatedPluginHookName;
