...
export declare function resolveWorkspaceAttestationPath(dir: string): string;
...
export declare function isWorkspaceAttestationMarker(attestationPath: string): Promise<boolean>;
