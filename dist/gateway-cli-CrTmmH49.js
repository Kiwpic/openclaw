...
import { t as addGatewayRunCommand } from "./run-command-BMjwjP4A.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-Ymyl87dB.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-DrcBxFvb.js"));
...
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-w0jrQZyq.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-Crx4XQNo.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-CgUqF14k.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-DeYcdw7F.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-BgfxK2kI.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayTransportErrorJson } = await import("./call-D4Oi2dnm.js");
