...
import { D as formatStoppedCronSessionDiagnosticFields, E as resolveStuckSessionRecoveryRef, O as resolveCronSessionDiagnosticContext, T as formatRecoveryOutcome } from "./diagnostic-BtIx0uw8.js";
...
import { _ as resolveActiveEmbeddedRunSessionId, c as isEmbeddedAgentRunHandleActive, g as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, h as resolveActiveEmbeddedRunHandleSessionId, s as isEmbeddedAgentRunActive, t as abortAndDrainEmbeddedAgentRun, v as resolveActiveEmbeddedRunSessionIdBySessionFile } from "./runs-D-3TCr__.js";
import { m as resetCommandLane, o as getCommandLaneSnapshot } from "./command-queue-DRcO14pX.js";
...
async function recoverStuckDiagnosticSession(params) {
	...
	try {
		...
		const released = sessionLane && (queuedCount > 0 || !activeSessionId || !aborted || !drained) ? resetCommandLane(sessionLane) : 0;
