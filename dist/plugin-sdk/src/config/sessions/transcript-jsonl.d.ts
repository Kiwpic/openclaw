...
export declare function writeJsonlEntriesSync(filePath: string, entries: readonly unknown[]): void;
export declare function appendJsonlEntrySync(filePath: string, entry: unknown): void;
export declare function appendJsonlEntriesSync(filePath: string, entries: readonly unknown[]): void;
export declare function writeJsonlEntry(filePath: string, entry: unknown, options?: WriteJsonlFileOptions): Promise<void>;
export declare function writeJsonlLines(filePath: string, lines: readonly string[], options?: WriteJsonlFileOptions): Promise<void>;
