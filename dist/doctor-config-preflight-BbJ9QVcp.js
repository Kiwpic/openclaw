...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CXv-CSA-.js";
import { n as formatConfigIssueLines } from "./issue-format-CwCoGNbt.js";
import { t as note } from "./note-BRSJp0UF.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CmJu4_N7.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-DA18Qi7m.js";
...
function loadDoctorStateMigrations() {
	doctorStateMigrationsPromise ??= import("./doctor-state-migrations-DBUaJ2af.js");
	return doctorStateMigrationsPromise;
}
function loadDoctorCron() {
	doctorCronPromise ??= import("./cron-CpkEgwXe.js");
