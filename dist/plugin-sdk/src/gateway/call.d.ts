...
export declare function buildGatewayProbeConnectionDetails(opts?: Pick<CallGatewayBaseOptions, "config" | "configPath" | "password" | "tlsFingerprint" | "token" | "url">): Promise<GatewayProbeConnectionDetails>;
