...
export declare function detectUnsafeExecControlShellCommand(command: string): UnsafeExecControlShellCommandKind | null;
export declare function rejectUnsafeExecControlShellCommand(command: string): void;
export {};
