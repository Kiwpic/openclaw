...
import { r as stripInboundMetadata, t as extractInboundSenderLabel } from "./strip-inbound-meta-BHmOsIBM.js";
...
async function readSessionMessageByIdAsync(sessionId, storePath, sessionFile, messageId) {
	const filePath = findExistingTranscriptPath(sessionId, storePath, sessionFile);
	if (!filePath) return {
		oversized: false,
		found: false
...
//#endregion
export { stripMessageIdHints as C, stripEnvelope as S, stripEnvelopeFromMessage as _, readRecentSessionMessagesWithStatsAsync as a, extractToolCallNames as b, readSessionMessageByIdAsync as c, readSessionMessagesAsync as d, readSessionPreviewItemsFromTranscript as f, readSessionTranscriptIndex as g, visitSessionMessagesAsync as h, readRecentSessionMessagesAsync as i, readSessionMessageCountAsync as l, readSessionTitleFieldsFromTranscriptAsync as m, capArrayByJsonBytes as n, readRecentSessionTranscriptLines as o, readSessionTitleFieldsFromTranscript as p, readLatestRecentSessionUsageFromTranscriptAsync as r, readRecentSessionUsageFromTranscript as s, attachOpenClawTranscriptMeta as t, readSessionMessages as u, stripEnvelopeFromMessages as v, stripInternalMetadataForDisplay as x, countToolResults as y };
