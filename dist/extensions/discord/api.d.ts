...
import { mt as DiscordExecApprovalConfig } from "../../types.channels-ClE80MLB.js";
import { kr as AgentToolResult } from "../../index-CFFuyfQR.js";
import { C as OpenClawPluginApi } from "../../types-Cqh78_VH.js";
import { s as ChannelOutboundPayloadHint } from "../../outbound.types-Bnwv5ftu.js";
import { P as ChannelStatusIssue, m as ChannelGroupContext, r as ChannelAccountSnapshot, y as ChannelMessageActionContext } from "../../types.core-FIbwi2ME.js";
import { r as ReplyPayload } from "../../reply-payload-DK8c1ZQN.js";
import { t as RetryConfig } from "../../retry-iCQJ-qpp.js";
import { i as resolveOpenProviderRuntimeGroupPolicy } from "../../runtime-group-policy-DEj6LNUz.js";
import { n as DiscordTokenResolution, t as DiscordCredentialStatus } from "../../token-DXZKnuNP.js";
import { n as inspectDiscordAccount, t as InspectedDiscordAccount } from "../../account-inspect-B6Pc26jM.js";
import { a as mergeDiscordAccountConfig, c as resolveDiscordAccountConfig, i as listEnabledDiscordAccounts, l as resolveDiscordMaxLinesPerMessage, n as createDiscordActionGate, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount, t as ResolvedDiscordAccount } from "../../accounts-uNJlOEuo.js";
import { a as fetchDiscordApplicationId, c as probeDiscord, i as DiscordProbe, l as resolveDiscordPrivilegedIntentsFromFlags, n as DiscordPrivilegedIntentStatus, o as fetchDiscordApplicationSummary, r as DiscordPrivilegedIntentsSummary, s as parseApplicationIdFromToken, t as DiscordApplicationSummary } from "../../probe-BrBSZqAj.js";
import { t as discordPlugin } from "../../channel-Dp_b06UZ.js";
import { t as discordSetupPlugin } from "../../channel.setup-sPuEyb6n.js";
import { f as ThreadBindingTargetKind } from "../../thread-bindings.manager-DHKDVTWr.js";
import { a as ComponentData } from "../../components.modal-CUfa8vPj.js";
import { A as parseDiscordComponentCustomIdForInteraction, C as DiscordModalFieldSpec, D as buildDiscordComponentCustomId, E as DISCORD_MODAL_CUSTOM_ID_KEY, M as parseDiscordModalCustomIdForInteraction, O as buildDiscordModalCustomId, S as DiscordModalFieldDefinition, T as DISCORD_COMPONENT_CUSTOM_ID_KEY, _ as DiscordComponentSectionAccessory, a as DISCORD_COMPONENT_ATTACHMENT_PREFIX, b as DiscordComponentSelectType, c as buildDiscordComponentMessage, d as DiscordComponentBuildResult, f as DiscordComponentButtonSpec, g as DiscordComponentModalFieldType, h as DiscordComponentMessageSpec, i as createDiscordFormModal, j as parseDiscordModalCustomId, k as parseDiscordComponentCustomId, l as buildDiscordComponentMessageFlags, m as DiscordComponentEntry, n as buildDiscordInteractiveComponents, o as readDiscordComponentSpec, p as DiscordComponentButtonStyle, r as DiscordFormModal, s as resolveDiscordComponentAttachmentName, t as formatDiscordComponentEventText, u as DiscordComponentBlock, v as DiscordComponentSelectOption, w as DiscordModalSpec, x as DiscordModalEntry, y as DiscordComponentSelectSpec } from "../../components-D0Klxro0.js";
...
import { n as DiscordInteractiveHandlerRegistration, t as DiscordInteractiveHandlerContext } from "../../interactive-dispatch-BLOKvthh.js";
...
import { t as collectDiscordSecurityAuditFindings } from "../../security-audit-B1e-oKiR.js";
...
type Ctx = Pick<ChannelMessageActionContext, "action" | "params" | "cfg" | "accountId" | "requesterSenderId" | "toolContext" | "mediaLocalRoots" | "mediaReadFile">;
