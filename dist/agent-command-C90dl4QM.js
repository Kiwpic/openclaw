...
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-CXv-CSA-.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-lR114wAI.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-DwdMzQDc.js";
import { g as resolveConfiguredModelRef, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as resolveModelRefFromString } from "./model-selection-shared-BS5V4jxN.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-BQo-ebsO.js";
import { a as normalizeModelRef, i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-DhdmnkKq.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-DEDx_Sg4.js";
...
import { W as createTrajectoryRuntimeRecorder, t as resolveAvailableAgentHarnessPolicy } from "./selection-0ubkfL9A.js";
import { s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-zRIg7Qcw.js";
...
import { f as LiveSessionModelSwitchError, o as runWithModelFallback } from "./model-fallback-DwaMlvP2.js";
import { n as resolveSession } from "./session-Djb9WIN-.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-DNuP1bjj.js";
...
import "./live-model-switch-CqhNLn3U.js";
import { t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-BCqcRHqv.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-jjfLuHim.js";
import { t as resolveFastModeState } from "./fast-mode-BcRGlFO-.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-DLjk7Iua.js";
import { t as NodeRegistry } from "./node-registry-DzMBNLUj.js";
import { r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-GBEltbZ2.js";
import { n as applyVerboseOverride } from "./level-overrides-DqCKUtai.js";
import { a as resolveInternalEventTranscriptBody, i as resolveAcpPromptBody, n as persistSessionEntry$1, r as prependInternalEventContext, t as resolveAgentRunContext } from "./run-context-B-KUm4_T.js";
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-Zaq78mGa.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-oGzRVrss.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-C8JQTB0e.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-BhWWWnqO.js"), import("./session-snapshot-Ccc5Frqg.js")]);
	return {
...
async function prepareAgentCommandExecution(opts, runtime) {
	...
	const timeoutSecondsRaw = opts.timeout !== void 0 ? parseStrictNonNegativeInteger(opts.timeout) ?? NaN : isSubagentLane ? 0 : void 0;
