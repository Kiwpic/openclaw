...
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-BAN0um2B.js";
import { i as DEFAULT_RELAYS } from "./setup-adapter-CuDMdT4K.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta) => {
					...
					const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-_t6H9h_y.js");
