...
import { f as updateSessionStoreEntry } from "./store-DzYHq4iO.js";
...
import { a as resolveProviderAuthProfileId } from "./provider-hook-runtime-C7AtTsg4.js";
import { y as prepareProviderRuntimeAuth } from "./provider-runtime-oCQkMgyo.js";
import "./auth-profiles-CGOKTLgm.js";
import { n as markAuthProfileSuccess } from "./profiles-BazhXMAV.js";
import { o as isProfileInCooldown } from "./usage-state-glPP7WfI.js";
import { i as resolveAuthProfileOrder, r as resolveAuthProfileEligibility } from "./order-DwdMzQDc.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-DR43yAQ0.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-mTlOTEjH.js";
...
import { a as getApiKeyForModel, g as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-DpNqptyV.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CuUvHfKt.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-DMfgKfRY.js";
import "./runs-D-3TCr__.js";
...
import { i as enqueueCommandInLane } from "./command-queue-DRcO14pX.js";
import { C as parseImageDimensionError, a as extractObservedOverflowTokenCount, f as isCompactionFailureError, h as isFailoverErrorMessage, l as isAuthAssistantError, m as isFailoverAssistantError, n as classifyFailoverReason, o as formatAssistantErrorText, s as formatUserFacingAssistantErrorText, u as isBillingAssistantError, v as isLikelyContextOverflowError, w as parseImageSizeError, y as isRateLimitAssistantError } from "./errors-Ccbyhi_E.js";
import { a as describeFailoverError, i as coerceToFailoverError, t as FailoverError, u as resolveFailoverStatus } from "./failover-error-_eAyLqsc.js";
import { a as hasReplyPayloadContent } from "./payload-CZlThETZ.js";
import { A as resolveAckExecutionFastPathInstruction, B as shouldRetryMissingAssistantTurn, D as shouldWarnEmbeddedRunStageSummary, E as formatEmbeddedRunStageSummary, F as resolvePlanningOnlyRetryLimit, H as createEmbeddedRunReplayState, I as resolveReasoningOnlyRetryInstruction, L as resolveReplayInvalidFlag, M as resolveEmptyResponseRetryInstruction, N as resolveIncompleteTurnPayloadText, O as STRICT_AGENTIC_BLOCKED_TEXT, P as resolvePlanningOnlyRetryInstruction, R as resolveRunLivenessState, T as createEmbeddedRunStageTracker, U as observeReplayMetadata, V as shouldTreatEmptyAssistantReplyAsSilent, _ as resolveRateLimitProfileRotationLimit, a as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, b as createUsageAccumulator, c as buildUsageAgentMetaFields, d as resolveActiveErrorContext, f as resolveFinalAssistantRawText, g as resolveOverloadProfileRotationLimit, h as resolveOverloadFailoverBackoffMs, i as RUNTIME_AUTH_REFRESH_MARGIN_MS, j as resolveAttemptReplayMetadata, k as extractPlanningOnlyPlanDetails, l as createCompactionDiagId, m as resolveMaxRunRetryIterations, n as runAgentHarnessAttempt, o as RUNTIME_AUTH_REFRESH_RETRY_MS, p as resolveFinalAssistantVisibleText, r as selectAgentHarness, s as buildErrorAgentMeta, u as isAssistantForModelRef, v as resolveReportedModelRef, w as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, x as mergeUsageIntoAccumulator, y as scrubAnthropicRefusalMagic, z as resolveSilentToolResultReplyPayload } from "./selection-0ubkfL9A.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-D6-_RNEN.js";
import { d as isStrictAgenticExecutionContractActive } from "./openclaw-tools-BFlkALY6.js";
...
import { n as rotateTranscriptFileAfterCompaction, r as shouldRotateCompactionTranscript, s as normalizeContextTokenBudget } from "./compaction-successor-transcript-DbUtRjMq.js";
import "./tool-split-Dk-MhPCX.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-DFOzKbeo.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-LHDaKYjp.js";
import { l as hasMessagingToolDeliveryEvidence, u as hasOutboundDeliveryEvidence } from "./subagent-announce-delivery-yTNzAlPI.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { i as pickFallbackThinkingLevel, s as normalizeTextForComparison } from "./embedded-agent-helpers-G3j0fJ4G.js";
import { P as formatToolAggregate } from "./streaming-_TVeMLGC.js";
import { d as parseReplyDirectives } from "./payloads-CzWGlJOf.js";
import { c as suspendSession, d as shouldSuppressRawErrorConsoleSuffix, f as LiveSessionModelSwitchError, l as buildApiErrorObservationFields, m as shouldAllowCooldownProbeForReason, s as resolveSessionSuspensionReason } from "./model-fallback-DwaMlvP2.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-Djb9WIN-.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./embedded-agent-utils-Dh5wqbFv.js";
import { n as resolveModelAsync } from "./model-4LLgQCGB.js";
import { t as ensureContextEnginesInitialized } from "./init-ChytE7lh.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-Brt9cNnr.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-W6xrR3Zx.js";
import { a as resolveLiveToolResultMaxChars, c as truncateOversizedToolResultsInSession, o as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-Dw5R17G3.js";
import { c as resolveCompactionTimeoutMs, o as compactContextEngineWithSafetyTimeout, s as compactWithSafetyTimeout } from "./tool-result-middleware-CVtX6OWT.js";
import "./extra-params-ISoDsLI9.js";
import { m as resolveContextEngineCapabilities, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-D6HptzAr.js";
import { c as runContextEngineMaintenance } from "./context-engine-lifecycle-Bzcyp5Cu.js";
...
import "./sandbox-info-DoZIz4Wl.js";
import { n as runAgentCleanupStep } from "./attempt.tool-run-context-pYtFOfCr.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-z1RK0Cot.js";
...
import { n as isRecoverableNativeHarnessBindingFailure, t as maybeCompactAgentHarnessSession } from "./compaction-9u7aSN6d.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-DgRYrSu-.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-BPd3uzlP.js";
...
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-CqhNLn3U.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-5NAHihB4.js";
import { r as buildAgentRuntimePlan } from "./build-HbqgqRIJ.js";
