...
import { d as supportsClaudeNativeMaxEffort, f as supportsClaudeNativeXhighEffort, l as resolveClaudeNativeThinkingLevelMap, u as supportsClaudeAdaptiveThinking } from "./src-DfTQY7TS.js";
import { A as resolveProviderStreamFn } from "./provider-runtime-oCQkMgyo.js";
...
import { r as getModelProviderRequestTransport } from "./provider-request-config-DR43yAQ0.js";
import { c as calculateCost, i as usesClaudeFable5MessagesContract, l as clampThinkingLevel } from "./sanitize-unicode-DFl3mYG_.js";
import { c as registerApiProvider, o as getApiProvider } from "./stream-Dt0UwlYc.js";
...
function normalizeAnthropicToolChoice(model, toolChoice) {
	if (usesClaudeFable5MessagesContract(model) && (toolChoice === "any" || typeof toolChoice === "object" && toolChoice.type === "tool")) return { type: "auto" };
