...
import { B as MemoryProviderStatus, G as MemorySyncProgressUpdate, H as MemorySearchManager, W as MemorySearchRuntimeDebug } from "./memory-state-BZqiOnIw.js";
import { c as MemoryEmbeddingProviderRuntime, o as MemoryEmbeddingProviderCreateOptions, r as MemoryEmbeddingProvider } from "./memory-embedding-providers-BuedbqHK.js";
import { a as ResolvedMemorySearchConfig } from "./openclaw-runtime-rKGzAX09.js";
import { m as EmbeddingInput } from "./internal-BdqTjAl0.js";
import { n as MemorySearchResult, r as MemorySource, t as MemoryEmbeddingProbeResult } from "./memory-core-host-engine-storage-Cj1Bdzr_.js";
...
declare abstract class MemoryManagerEmbeddingOps extends MemoryManagerSyncOps {
  ...
  protected embedQueryWithRetry(text: string): Promise<number[]>;
