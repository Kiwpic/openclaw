...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-BGjbn7rV.js";
import { a as resetModelCatalogCache } from "./model-catalog-DEDx_Sg4.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { a as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-KXrVFVfz.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-l2wqkwLz.js";
...
import { r as resetDirectoryCache } from "./target-resolver-D3Ka6KyE.js";
...
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-yrujTRBh.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan--mY5DZhD.js";
...
import { t as buildGatewayCronService } from "./server-cron-C4yvj49W.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-Dymh4plB.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-CMX8DoO_.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-B_bEiZAC.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-D5xqOlm7.js"), import("./gmail-watcher-lifecycle-Bn_lzKfQ.js")]);
