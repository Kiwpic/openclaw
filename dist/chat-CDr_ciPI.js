...
import { l as measureDiagnosticsTimelineSpan, s as emitDiagnosticsTimelineEvent, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-CYLb0UbD.js";
...
import { o as resolveMirroredTranscriptText, s as appendSessionTranscriptMessage } from "./transcript-CNbfynAP.js";
...
import { a as getSessionDefaults, b as resolveSessionModelRef, h as resolveGatewayModelSupportsImages, l as loadGatewaySessionRow, o as listAgentsForGateway, p as resolveDeletedAgentIdFromSessionKey, t as buildGatewaySessionInfo, u as loadSessionEntry } from "./session-utils-iCb24fTG.js";
...
import { t as dispatchInboundMessage } from "./dispatch-CNbUR-jJ.js";
import { r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-i7CbvCTl.js";
...
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-CzWGlJOf.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-C9Ho1mOs.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CPMLXKqB.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BaGUSr1m.js";
import { s as augmentChatHistoryWithCliSessionImports } from "./attempt-execution.helpers-BWB4U4vm.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-DVWERBHw.js";
import { n as createReplyDispatcher } from "./reply-dispatcher.types-BWyU165k.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-F2bAzr1v.js";
import { a as isChatStopCommandText, c as resolveInFlightRunSnapshot, i as boundInFlightRunSnapshotForChatHistory, l as updateChatRunProvider, o as registerChatAbortController, t as abortChatRunById } from "./chat-abort-Bsn-k7Jg.js";
...
import { n as modelCatalogBrowseRequiresFullDiscovery } from "./model-catalog-browse-hHQ8B_i-.js";
import { i as projectChatDisplayMessage, n as augmentChatHistoryWithCanvasBlocks, o as projectRecentChatDisplayMessages, r as dropPreSessionStartAnnouncePairs, s as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-CJeRkRph.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-I_IdX3pC.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-zCXATF7W.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-DwnN0PAz.js";
import { r as resolveSessionHistoryTailReadOptions } from "./session-history-state-Ct7ab-KY.js";
import { n as setGatewayDedupeEntry } from "./agent-wait-dedupe-DpNf_sSt.js";
...
async function buildChatMetadataResult(params) {
	const [{ buildModelsListResult }, { buildCommandsListResult }] = await Promise.all([import("./models-list-result-4by14wGd.js"), import("./commands-list-result-CBYnDOtg.js")]);
...
async function buildChatStartupMetadataResult(params) {
	...
	try {
		const { buildModelsListResult } = await import("./models-list-result-4by14wGd.js");
