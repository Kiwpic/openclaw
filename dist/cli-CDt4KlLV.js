...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-CUq1DXF-.js";
import { n as matrixSetupAdapter } from "./setup-core-WFqANNNa.js";
import { t as withResolvedActionClient } from "./client-xH0L8vld.js";
import { r as resolveMatrixAuthContext } from "./config-Baz-wy70.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-D2RtSb7P.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-ItzqvxNK.js");
