...
import { n as discoverConfigSecretTargets } from "./target-registry-DYDxPbo_.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CXv-CSA-.js";
...
import { r as normalizeTalkSection } from "./talk-CgnqIqtK.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CmJu4_N7.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-CzI2SQve.js";
...
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BbJ9QVcp.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BIsoSuZq.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-B-aujj4k.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DG5ctgMU.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-8ZEJEb02.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-VSxR915m.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CcJUJDUq.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-ccw7Xz1t.js");
