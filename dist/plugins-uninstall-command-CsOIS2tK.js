...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { buildPluginSnapshotReport } = await import("./status-CREI3laH.js");
	...
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-fDFk8ocY.js");
