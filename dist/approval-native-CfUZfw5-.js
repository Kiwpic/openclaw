...
import { a as buildApprovalReactionPendingContentForRequest } from "./approval-reaction-runtime-D3t2Oluc.js";
...
const signalApprovalCapability = createChannelApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DoU1YpBF.js")).signalApprovalNativeRuntime
	})
});
