...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-CKLBu9l0.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-DvdVXsZT.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-z5ESRXqd.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-CenBBJgZ.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-D81Cl9FU.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-CpPieL0E.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-19c8VXvN.js");
			...
			const { statusCommand } = await import("./status-C0mR0z31.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-D9P2C3Gp.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-N_wX-Q-W.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-Bed60sMM.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-odeISCbt.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-CmurM3xg.js");
