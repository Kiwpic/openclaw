...
import "./reply-pipeline-CWeNMHM9.js";
...
const loadChannelMessageRuntimeModule = async () => {
	channelMessageRuntimeModulePromise ??= import("./runtime-COBGTfMM.js");
...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-BtwXmy9Z.js")).deliverInboundReplyWithMessageSendContext(...args);
};
