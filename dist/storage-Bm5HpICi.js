...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasFlatLegacyStorageFile || hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-CsYsw6h-.js") : null;
...
async function migrateLegacyIdbSnapshotToSqlite(params) {
	...
	const { readLegacyMatrixIdbSnapshotState } = await import("./idb-persistence-Dth7YdWS.js");
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-CsYsw6h-.js");
