...
import { t as registerAgentTurnCommand } from "./register.agent-turn-Cv-32MHg.js";
//#region src/cli/program/register.agent.ts
let agentsBindModulePromise;
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-B0Uk2gqQ.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-B7JqUaeJ.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-D0-FyHnO.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-C-L0C-V6.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-z5ESRXqd.js")).agentsListCommand;
}
