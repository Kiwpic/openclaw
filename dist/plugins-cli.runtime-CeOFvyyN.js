...
const loadPluginsStatus = createModuleLoader(() => import("./status-CREI3laH.js"));
const loadPluginsCommandHelpers = createModuleLoader(() => import("./plugins-command-helpers-DgmAqYwx.js"));
...
async function runPluginsEnableCommand(idInput) {
	...
	const { enablePluginInConfig } = await import("./enable-CSIY-Ypn.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-CfVfZWb1.js");
