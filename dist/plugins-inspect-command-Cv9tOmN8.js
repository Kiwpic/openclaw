...
import { u as quietPluginJsonLogger } from "./plugins-command-helpers-D53wbFrP.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-CREI3laH.js");
