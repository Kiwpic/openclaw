...
import { a as asRecord$2 } from "../../record-coerce-DHZ4bFlT.js";
...
import "../../gateway-runtime-BM7hl7d4.js";
import { n as callGatewayFromCli } from "../../gateway-rpc-DMbE--EK.js";
import "../../channel-actions-BOfvC-Gl.js";
import { n as getRealtimeTranscriptionProvider, r as listRealtimeTranscriptionProviders } from "../../provider-registry-BcfNU5S-.js";
import "../../realtime-transcription-D3L2sSee.js";
import { A as buildRealtimeVoiceAgentConsultWorkingResponse, F as resolveRealtimeVoiceAgentConsultTools, H as createTalkSessionController, I as resolveRealtimeVoiceAgentConsultToolsAllow, Q as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, T as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, W as recordTalkObservabilityEvent, Z as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, a as recordRealtimeVoiceBridgeEvent, c as resolveConfiguredRealtimeVoiceProvider, i as isLikelyRealtimeVoiceAssistantEchoTranscript, n as getRealtimeVoiceBridgeEventHealth, o as recordRealtimeVoiceTranscript, r as getRealtimeVoiceTranscriptHealth, s as createRealtimeVoiceBridgeSession, t as extendRealtimeVoiceOutputEchoSuppression } from "../../session-log-runtime-C2B4BXL-.js";
import { c as consultRealtimeVoiceAgent, i as resamplePcm, l as createRealtimeVoiceOutputActivityTracker, n as mulawToPcm, s as createRealtimeVoiceAgentTalkbackQueue, t as convertPcmToMulaw8k } from "../../realtime-voice-DybiCBl8.js";
import { a as isSameMeetUrlForReuse, c as resolveChromeNode, f as endGoogleMeetActiveConference, g as fetchLatestGoogleMeetConferenceRecord, h as fetchGoogleMeetSpace, i as callBrowserProxyOnNode, l as resolveChromeNodeInfo, m as fetchGoogleMeetAttendance, n as isGoogleMeetBrowserManualActionError, o as normalizeMeetUrlForReuse, p as fetchGoogleMeetArtifacts, r as asBrowserTabs, s as readBrowserTab, t as createMeetWithBrowserProxyOnNode, u as buildGoogleMeetPreflightReport } from "../../chrome-create-DXU9m9bo.js";
import { a as buildGoogleMeetCalendarDayWindow, i as resolveGoogleMeetGatewayOperationTimeoutMs, n as DEFAULT_GOOGLE_MEET_AUDIO_OUTPUT_COMMAND, o as findGoogleMeetCalendarEvent, r as resolveGoogleMeetConfig, s as listGoogleMeetCalendarEvents, t as DEFAULT_GOOGLE_MEET_AUDIO_INPUT_COMMAND } from "../../config-UmxE20Af.js";
...
function getVoiceCallWebhookExposureCheck(voiceCallConfig) {
	...
	const tunnel = asRecord$2(voiceCallConfig.tunnel);
	const tailscale = asRecord$2(voiceCallConfig.tailscale);
...
function getGoogleMeetSetupStatus(config, options) {
	...
	const fullConfig = asRecord$2(options?.fullConfig);
	...
	const pluginEntries = asRecord$2(asRecord$2(fullConfig.plugins).entries);
	const pluginAllow = asRecord$2(fullConfig.plugins).allow;
	const voiceCallEntry = asRecord$2(pluginEntries["voice-call"]);
	const voiceCallConfig = asRecord$2(voiceCallEntry.config);
	const voiceCallTwilioConfig = asRecord$2(voiceCallConfig.twilio);
...
const loadGoogleMeetCreateModule = async () => {
	googleMeetCreateModulePromise ??= import("../../create-C92X1KrS.js");
	return await googleMeetCreateModulePromise;
};
const loadGoogleMeetCliModule = async () => {
	googleMeetCliModulePromise ??= import("../../cli-C4_M0Rq-.js");
...
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-D1Q_PS0d.js");
