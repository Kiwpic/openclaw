...
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-CYLb0UbD.js";
...
import { b as createCodeModeNamespaceRuntime, x as describeCodeModeNamespacesForPrompt, y as createCodeModeApiVirtualFiles } from "./registry-grOnBAqi.js";
...
import { d as listImportedRuntimePluginIds, o as getActivePluginRegistry } from "./runtime-Dew8HF52.js";
...
import { c as runQuotaSuspensionMaintenance, f as updateSessionStoreEntry } from "./store-DzYHq4iO.js";
...
import { c as bindOwnedSessionTranscriptWrites, l as withOwnedSessionTranscriptWrites } from "./transcript-CNbfynAP.js";
...
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-C7AtTsg4.js";
import { G as transformProviderSystemPrompt, M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms } from "./provider-runtime-oCQkMgyo.js";
...
import { o as normalizeProviderId$1 } from "./model-selection-normalize-DhdmnkKq.js";
...
import { U as isTerminalTaskStatus } from "./task-registry-B1KL0Xsw.js";
import { C as promoteStandalonePlainTextToolCallMessage, S as extractStandalonePlainTextToolCallText, T as scrubOverCapPlainTextToolCallMessage, w as normalizePlainTextToolCallStreamEvents } from "./provider-stream-shared-Bes9sdRY.js";
...
import { C as parseExecApprovalResultText } from "./sanitize-user-facing-text-DMfgKfRY.js";
...
import { b as updateActiveEmbeddedRunSessionFile, d as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, w as resolveEmbeddedSessionFileKey, x as updateActiveEmbeddedRunSnapshot, y as setActiveEmbeddedRun } from "./runs-D-3TCr__.js";
...
import { d as isCloudCodeAssistFormatError, n as classifyFailoverReason, s as formatUserFacingAssistantErrorText } from "./errors-Ccbyhi_E.js";
...
import { c as isTimeoutError } from "./failover-error-_eAyLqsc.js";
...
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-D-d_mc6d.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./agent-tools.policy-B3Eio6Uv.js";
import { r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-D7t6OqMj.js";
...
import { T as isEmbeddedMode, f as isStrictAgenticSupportedProviderModel, p as stripProviderPrefix } from "./openclaw-tools-BFlkALY6.js";
...
import { f as sanitizeTransportPayloadText, h as supportsModelTools, m as buildGuardedModelFetch, u as mergeTransportHeaders } from "./openai-transport-stream-CX3a_I9l.js";
import { t as log$2 } from "./logger-B8odRltZ.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-Du_t3XSu.js";
...
import { a as buildCodeSpanIndex, o as createInlineCodeState } from "./openai-completions-6D8V5-Zo.js";
...
import { i as getPluginToolMeta } from "./tools-BaaKSVxk.js";
import { u as resolveSkillsPromptForRun } from "./workspace-Dq9vIZ3f.js";
import { n as resolveSandboxSkillRuntimeInputs, r as resolveEmbeddedRunSkillEntries, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-BnL0myTH.js";
...
import { A as resolveChannelMessageToolHints, M as resolveChannelReactionGuidance, S as markCodeModeControlTool, k as listChannelSupportedActions, v as CODE_MODE_EXEC_TOOL_NAME, x as isCodeModeControlTool, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-BPFMBnJm.js";
...
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-CDxr0h8j.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { c as hasCommittedMessagingToolDeliveryEvidence, f as hasAcceptedSessionSpawn, l as hasMessagingToolDeliveryEvidence, p as normalizeAcceptedSessionSpawnResult, y as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-yTNzAlPI.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ByaJGDhT.js";
import { b as resolveBootstrapTotalMaxChars, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-G3j0fJ4G.js";
import { P as formatToolAggregate } from "./streaming-_TVeMLGC.js";
import { d as parseReplyDirectives } from "./payloads-CzWGlJOf.js";
import { d as shouldSuppressRawErrorConsoleSuffix, l as buildApiErrorObservationFields, p as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-DwaMlvP2.js";
import { a as extractThinkingFromTaggedStream, c as inferToolMetaFromArgs, d as sanitizeAssistantVisibleStreamText, i as extractAssistantVisibleText, l as isAssistantMessage, n as extractAssistantText, o as extractThinkingFromTaggedText, r as extractAssistantThinking, t as THINKING_TAG_SCAN_RE, u as promoteThinkingTagsToBlocks } from "./embedded-agent-utils-Dh5wqbFv.js";
...
import { t as registerProviderStreamForModel } from "./provider-stream-Dv6C9obF.js";
import { b as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-Qzmg2mta.js";
import { n as buildSubagentList } from "./subagent-list-DvtOhUhA.js";
import { a as listControlledSubagentRuns } from "./subagent-control-BsUNkZme.js";
import { o as resolveSandboxContext } from "./sandbox-C9Ho1mOs.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context-Brt9cNnr.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-BvOgdHYC.js";
...
import { a as extractToolResultMediaArtifact, c as isToolResultError, d as sanitizeToolResult, i as extractToolErrorMessage, l as isToolResultTimedOut, n as extractMessagingToolSend, o as extractToolResultText, r as extractToolErrorCode, s as filterToolResultMediaUrls, t as buildToolLifecycleErrorResult, u as sanitizeToolArgs } from "./embedded-agent-subscribe.tools-CEPdDj64.js";
...
import { n as runAgentEndSideEffects } from "./agent-end-side-effects-WwVua5nX.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-8V0-OMtV.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-D7lz794_.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-CgoPXbOu.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-BPhN0WMe.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, l as truncateOversizedToolResultsInSessionManager, s as truncateOversizedToolResultsInMessages } from "./tool-result-truncation-Dw5R17G3.js";
...
import { c as resolveCompactionTimeoutMs, d as shouldAllowProviderOwnedThinkingReplay, u as resolveTranscriptPolicy } from "./tool-result-middleware-CVtX6OWT.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-ISoDsLI9.js";
...
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-Bzcyp5Cu.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-CqRptWZQ.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-DoZIz4Wl.js";
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, n as runAgentCleanupStep, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-pYtFOfCr.js";
...
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-A-KM63lP.js";
...
import { t as detectAndLoadPromptImages } from "./images-gq_8kqko.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-q5bSgEXX.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./agent-tools.before-tool-call-Cv1A9P84.js"));
...
//#endregion
export { resolveAckExecutionFastPathInstruction as A, shouldRetryMissingAssistantTurn as B, timestampOptsFromConfig as C, shouldWarnEmbeddedRunStageSummary as D, formatEmbeddedRunStageSummary as E, resolvePlanningOnlyRetryLimit as F, createEmbeddedRunReplayState as H, resolveReasoningOnlyRetryInstruction as I, resolveReplayInvalidFlag as L, resolveEmptyResponseRetryInstruction as M, resolveIncompleteTurnPayloadText as N, STRICT_AGENTIC_BLOCKED_TEXT as O, resolvePlanningOnlyRetryInstruction as P, resolveRunLivenessState as R, injectTimestamp as S, createEmbeddedRunStageTracker as T, observeReplayMetadata as U, shouldTreatEmptyAssistantReplyAsSilent as V, createTrajectoryRuntimeRecorder as W, resolveRateLimitProfileRotationLimit as _, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as a, createUsageAccumulator as b, buildUsageAgentMetaFields as c, resolveActiveErrorContext as d, resolveFinalAssistantRawText as f, resolveOverloadProfileRotationLimit as g, resolveOverloadFailoverBackoffMs as h, RUNTIME_AUTH_REFRESH_MARGIN_MS as i, resolveAttemptReplayMetadata as j, extractPlanningOnlyPlanDetails as k, createCompactionDiagId as l, resolveMaxRunRetryIterations as m, runAgentHarnessAttempt as n, RUNTIME_AUTH_REFRESH_RETRY_MS as o, resolveFinalAssistantVisibleText as p, selectAgentHarness as r, buildErrorAgentMeta as s, resolveAvailableAgentHarnessPolicy as t, isAssistantForModelRef as u, resolveReportedModelRef as v, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as w, mergeUsageIntoAccumulator as x, scrubAnthropicRefusalMagic as y, resolveSilentToolResultReplyPayload as z };
