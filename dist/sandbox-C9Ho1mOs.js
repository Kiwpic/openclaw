...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
			import("./workspace-BGRCrref.js"),
			import("./remote-BhWWWnqO.js"),
			import("./exec-defaults-C8JQTB0e.js")
		]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BMrm12xI.js")).maybePruneSandboxes(cfg);
