import { kt as AuthConfig } from "./types.openclaw-C8mNEQ_D.js";
import { d as SecretInput } from "./types.secrets-rAcqRhcN.js";
import { a as ModelApi, m as ModelProviderDeclarationConfig } from "./types.models-C7xuGz22.js";
...
declare function partitionFoundryDeployments<T extends {
  name: string;
  modelName?: string;
...
//#endregion
export { resolveFoundryModelCapabilities as A, isFoundryProviderApi as C, requiresFoundryMaxCompletionTokens as D, partitionFoundryDeployments as E, usesFoundryResponsesByDefault as F, supportsFoundryImageInput as M, supportsFoundryReasoningContent as N, resolveConfiguredModelNameHint as O, supportsFoundryReasoningEffort as P, isFoundryMaiImageModel as S, normalizeFoundryEndpoint as T, applyFoundryProviderConfig as _, COGNITIVE_SERVICES_RESOURCE as a, extractFoundryEndpoint as b, DEFAULT_GPT5_API as c, FoundrySelection as d, MAI_DEFAULT_IMAGE_MODEL as f, applyFoundryProfileBinding as g, TOKEN_REFRESH_MARGIN_MS as h, AzDeploymentSummary as i, resolveFoundryTargetProfileId as j, resolveFoundryApi as k, FoundryProviderApi as l, PROVIDER_ID as m, AzAccount as n, CachedTokenEntry as o, MAI_IMAGE_MODELS as p, AzCognitiveAccount as r, DEFAULT_API as s, AzAccessToken as t, FoundryResourceOption as u, buildFoundryAuthResult as v, listConfiguredFoundryProfileIds as w, isAnthropicFoundryDeployment as x, buildFoundryProviderBaseUrl as y };