...
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-Blh2RSS6.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B9a4Fa-V.js";
...
import { t as requireValidConfigFileSnapshot } from "./config-validation-FQj0Mpec.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-TMAJotdR.js";
import { t as channelsListCommand } from "./list-CvPhm9QJ.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-U2upkmXF.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CVgn4uM6.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-Cvu6OkZY.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-Dl00PdZ9.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DtEhym76.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-DrjgP9tQ.js");
