...
//#endregion
export { resolveExecApprovalsPath as $, isExecApprovalDecisionAllowed as A, splitCommandChain as At, normalizeExecTarget as B, resolveApprovalAuditTrustPath as Bt, SystemRunApprovalPlan as C, analyzeArgvCommand as Ct, ensureExecApprovals as D, buildSafeShellCommand as Dt, commandRequiresSecurityAuditSuppressionApproval as E, buildSafeBinsShellCommand as Et, normalizeExecApprovals as F, ExecutableResolution as Ft, requestExecApprovalViaSocket as G, resolveExecutionTargetResolution as Gt, readExecApprovalsSnapshot as H, resolveCommandResolutionFromArgv as Ht, normalizeExecAsk as I, matchAllowlist as It, resolveAllowAlwaysPatternCoverage as J, resolvePolicyTargetCandidatePath as Jt, requireValidExecTarget as K, resolveExecutionTargetTrustPath as Kt, normalizeExecHost as L, parseExecArgvToken as Lt, maxAsk as M, windowsEscapeArg as Mt, mergeExecApprovalsSocketDefaults as N, CommandResolution as Nt, hasDurableExecApproval as O, isWindowsPlatform as Ot, minSecurity as P, ExecArgvToken as Pt, resolveExecApprovalsFromFile as Q, normalizeExecMode as R, resolveAllowlistCandidatePath as Rt, SystemRunApprovalFileOperand as S, ShellChainPart as St, addDurableCommandApproval as T, buildEnforcedShellCommand as Tt, recordAllowlistMatchesUse as U, resolveExecutableTrustPath as Ut, persistAllowAlwaysPatterns as V, resolveCommandResolution as Vt, recordAllowlistUse as W, resolveExecutionTargetCandidatePath as Wt, resolveExecApprovalRequestAllowedDecisions as X, resolvePolicyTargetTrustPath as Xt, resolveExecApprovalAllowedDecisions as Y, resolvePolicyTargetResolution as Yt, resolveExecApprovals as Z, ExecAllowlistEntry as Zt, ExecHost as _, resolveSafeBins as _t, ExecApprovalCommandSpan as a, saveExecApprovals as at, ExecTarget as b, ExecCommandSegment as bt, ExecApprovalRequestPayload as c, ExecAllowlistEvaluation as ct, ExecApprovalsDefaultOverrides as d, evaluateExecAllowlist as dt, resolveExecApprovalsSocketPath as et, ExecApprovalsDefaults as f, evaluateShellAllowlist as ft, ExecAsk as g, resolveAllowAlwaysPatterns as gt, ExecApprovalsSnapshot as h, resolveAllowAlwaysPatternEntries as ht, EXEC_TARGET_VALUES as i, restoreExecApprovalsSnapshot as it, loadExecApprovals as j, splitCommandChainWithOperators as jt, hasNodeCommandAllowAlwaysMarker as k, resolvePlannedSegmentArgv as kt, ExecApprovalResolved as l, ExecSegmentSatisfiedBy as lt, ExecApprovalsResolved as m, normalizeSafeBins as mt, DEFAULT_EXEC_APPROVAL_DECISIONS as n, resolveExecModePolicy as nt, ExecApprovalDecision as o, AllowAlwaysPattern as ot, ExecApprovalsFile as p, isSafeBinUsage as pt, requiresExecApproval as q, resolvePolicyAllowlistCandidatePath as qt, DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as r, resolveExecPolicyForMode as rt, ExecApprovalRequest as s, ExecAllowlistAnalysis as st, DEFAULT_EXEC_APPROVAL_ASK_FALLBACK as t, resolveExecModeFromPolicy as tt, ExecApprovalsAgent as u, SkillBinTrustEntry as ut, ExecMode as v, CommandExplanationSummary as vt, addAllowlistEntry as w, analyzeShellCommand as wt, SystemRunApprovalBinding as x, ShellChainOperator as xt, ExecSecurity as y, ExecCommandAnalysis as yt, normalizeExecSecurity as z, resolveApprovalAuditCandidatePath as zt };