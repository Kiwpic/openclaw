...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-DpCWgRNU.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-Ct3CquyG.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CQtFV9Fn.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-Bti5MTHp.js";
...
import { u as resolveApprovalRequestRecipientConnIds } from "./approval-shared-DbbJvUQt.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-Dnp9jdE6.js");
