...
import { C as describeBotFrameworkServiceUrlHost, D as resolveMSTeamsSdkCloudOptions, O as validateMSTeamsProactiveServiceUrlBoundary, T as normalizeBotFrameworkServiceUrl, _ as readAccessToken, b as loadMSTeamsSdkWithAuth, h as resolveMSTeamsCredentials, m as loadDelegatedTokens, w as isAllowedBotFrameworkServiceUrl, x as buildUserAgent, y as createMSTeamsTokenProvider } from "./graph-users-B4D92fwi.js";
import { c as createMSTeamsHttpError } from "./oauth.token-BNG1g0td.js";
import { i as resolveMSTeamsRouteConfig, r as resolveMSTeamsReplyPolicy } from "./policy-uOgnNXmY.js";
...
async function loadMSTeamsApiModule() {
	apiModulePromise ??= import("./dist-BWKvYkUt.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
