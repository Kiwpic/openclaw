...
export type OpenClawSkillSecurityVerdictItem = Omit<ClawHubSkillSecurityVerdictItem, "decision" | "error" | "security"> & {
    registry: string;
    decision: string;
...
export declare function projectClawHubVerdictItem(item: ClawHubSkillSecurityVerdictItem, registry: string): OpenClawSkillSecurityVerdictItem;
