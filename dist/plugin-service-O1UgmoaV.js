...
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DPwj_3TH.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-CvhpANLW.js";
...
import { t as describeImageFile } from "./runtime-D9r31fl8.js";
import "./param-readers-HkqGooLN.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-tt4NcGdm.js";
import { n as withTimeout } from "./sdk-security-runtime-u-A7c_wk.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-9ns7gU4j.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-C5ihx6Jw.js";
import "./sdk-setup-tools-J6Mh4pY9.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-bMX9-uLn.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-DSRQQSaD.js";
import { r as getBrowserProfileCapabilities } from "./target-id-DxYwTzJ3.js";
import { n as normalizeBrowserScreenshot } from "./routes-BBVXf97o.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-G7DDgnho.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-BvfjkSgh.js");
