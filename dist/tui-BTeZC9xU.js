...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-lR114wAI.js";
...
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-dbXIl_Ht.js";
...
import { f as isAuthErrorMessage } from "./sanitize-user-facing-text-DMfgKfRY.js";
import { n as formatTokenCount } from "./usage-format-B9m2Vgli.js";
import { n as classifyFailoverReason } from "./errors-Ccbyhi_E.js";
...
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-BNb49gLz.js";
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-R-0mAIwD.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-DSiADDA1.js");
