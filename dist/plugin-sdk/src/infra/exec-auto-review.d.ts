...
export type ExecAutoReviewer = (input: ExecAutoReviewInput) => Promise<ExecAutoReviewDecision> | ExecAutoReviewDecision;
/**
 ...
 */
export declare const defaultExecAutoReviewer: ExecAutoReviewer;
