...
import { F as asResolvedSourceConfig, I as asRuntimeConfig, o as parseConfigJson5, p as readSourceConfigBestEffort, q as createPreUpdateConfigSnapshot, u as readConfigFileSnapshot } from "./io-CXv-CSA-.js";
...
import { r as mutateConfigFileWithRetry } from "./config-DA9SoGs3.js";
...
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-B4zd6gBl.js";
import { n as runDaemonInstall } from "./install-QYeHboSE.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-Dnko_rq-.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-BuT7FSvi.js";
...
import { u as trimLogTail } from "./restart-sentinel-B6-R4GF_.js";
...
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-SG-DIb7D.js";
...
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-C2Aj6fP-.js";
...
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-MM7zZBiJ.js";
import { t as doctorCommand } from "./doctor-IiZIabPu.js";
...
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-BJxPl0vl.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-CBOm1hTB.js";
...
async function gatewayServiceCommandUsesRoot(params) {
	...
	const serviceRoot = (await summarizeGatewayServiceLayout(await resolveGatewayService().readCommand(params.env ?? process.env).catch(() => null)))?.packageRoot;
	...
	if (params.shouldRestart) {
		...
		try {
			...
			if (refreshedGatewayAlreadyHealthy || restartInitiated || restarted && expectedGatewayVersion !== void 0) {
				if (!await verifyRestartedGateway(expectedGatewayVersion, { requireRunningService: updatedInstallRestartNeedsServiceRootProof })) {
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-IAq0la6S.js");
