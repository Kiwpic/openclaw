...
import { p as normalizeThinkLevel } from "./thinking-lR114wAI.js";
...
import { h as randomIdempotencyKey, o as callGateway } from "./call-meOygazM.js";
...
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-BuYkRAV1.js";
import { D as registerMemoryEmbeddingProvider, T as listMemoryEmbeddingProviders } from "./registry-grOnBAqi.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Dz9iVzmE.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-Djb9WIN-.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-DGQ3p_L1.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-DNuP1bjj.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-BxVNoCn9.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-BE9T4GS1.js";
import "./tts-DY8zcDiv.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CJVTRf1f.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-iutZpb-G.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-C1cPqBxE.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DecEOTjE.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-BMhgpq_-.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-BoOZ4b0w.js";
...
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-D9r31fl8.js";
...
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DcDDnphG.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-DSoQ6ibs.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-D81Cl9FU.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DLKWeZlB.js");
