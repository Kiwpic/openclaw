...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-k0qAWL7B.js";
...
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CXv-CSA-.js";
import { t as ConfigMutationConflictError } from "./config-DA9SoGs3.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-BcWvsPrC.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B4zd6gBl.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-SG-DIb7D.js";
...
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DZVxOFbb.js";
import { n as applyAuthChoice } from "./auth-choice-CWn-uiP_.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-2L0ykiKP.js";
import { i as setupChannels } from "./onboard-channels-CHeOX3-G.js";
...
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-MQtjFPZA.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-6n-dUuVW.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CjrsffUO.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CuFe-icU.js";
...
import { i as healthCommand } from "./health-CtIK9rVQ.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CR1cvSuP.js";
import { t as setupSkills } from "./onboard-skills-Di51ol9D.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-Dmr8vXRA.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-C6hhIMdg.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DA5h-TIp.js");
