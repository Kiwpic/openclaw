...
export declare const SKILL_WORKSHOP_SCHEMA: "openclaw.skill-workshop.proposal.v1";
export declare const SKILL_WORKSHOP_MANIFEST_SCHEMA: "openclaw.skill-workshop.proposals-manifest.v1";
export declare const SKILL_WORKSHOP_ROLLBACK_SCHEMA: "openclaw.skill-workshop.rollback.v1";
