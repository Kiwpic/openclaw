...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Dhb0Quro.js";
import { t as resolveMemoryCoreNowMs } from "../../time-DhPCijtC.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-BHwO0y3b.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-C7zqJ3UM.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-Cu0cogIS.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-BzR1_D4B.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-XSvCTvOl.js");
