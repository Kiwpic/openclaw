...
export declare function enableTailscaleServe(port: number, exec?: typeof runExec, serviceName?: string): Promise<void>;
...
export declare function disableTailscaleServe(exec?: typeof runExec, serviceName?: string): Promise<void>;
