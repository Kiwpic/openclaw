...
export declare function normalizeExecMode(value?: string | null): ExecMode | null;
export declare function resolveExecModeFromPolicy(params: {
    security: ExecSecurity;
    ask: ExecAsk;
}): ExecMode;
export declare function resolveExecPolicyForMode(mode: ExecMode): {
    security: ExecSecurity;
    ask: ExecAsk;
    autoReview: boolean;
};
export declare function resolveExecModePolicy(params: {
    mode?: ExecMode | null;
    security: ExecSecurity;
    ask: ExecAsk;
}): {
...
export declare function commandRequiresSecurityAuditSuppressionApproval(params: {
    command: string;
    cwd?: string;
...
export declare function hasNodeCommandAllowAlwaysMarker(params: {
    allowlist?: readonly ExecAllowlistEntry[];
    commandText?: string | null;
}): boolean;
...
export declare function resolveAllowAlwaysPatternCoverage(params: {
