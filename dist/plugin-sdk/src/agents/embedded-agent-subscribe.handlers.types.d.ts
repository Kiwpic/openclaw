...
import type { BlockReplyChunking, SubscribeEmbeddedAgentSessionParams } from "./embedded-agent-subscribe.types.js";
...
export type EmbeddedAgentSubscribeContext = {
    ...
    emitAssistantStreamData: (data: AssistantStreamData, options?: {
        emitPartialReply?: boolean;
    }) => void;
 ...
 */
type ToolHandlerParams = Pick<SubscribeEmbeddedAgentSessionParams, "runId" | "onBlockReplyFlush" | "onAgentEvent" | "onExecutionPhase" | "onHeartbeatToolResponse" | "onToolResult" | "sessionKey" | "sessionId" | "agentId" | "toolResultFormat" | "toolProgressDetail">;
type ToolHandlerState = Pick<EmbeddedAgentSubscribeState, "toolMetaById" | "toolMetas" | "acceptedSessionSpawns" | "toolSummaryById" | "execLiveUpdateStateById" | "itemActiveIds" | "itemStartedCount" | "itemCompletedCount" | "lastToolError" | "pendingMessagingTargets" | "pendingMessagingTexts" | "pendingMessagingMediaUrls" | "pendingToolMediaUrls" | "pendingToolAudioAsVoice" | "pendingToolTrustedLocalMedia" | "deterministicApprovalPromptPending" | "hadDeterministicSideEffect" | "replayState" | "messagingToolSentTexts" | "messagingToolSentTextsNormalized" | "messagingToolSentMediaUrls" | "messagingToolSourceReplyPayloads" | "messagingToolSentTargets" | "heartbeatToolResponse" | "successfulCronAdds" | "deterministicApprovalPromptSent" | "toolExecutionSinceLastBlockReply">;
...
export type EmbeddedAgentSubscribeEvent = AgentSessionEvent | {
    type: string;
    [k: string]: unknown;
} | {
    type: "message_start";
