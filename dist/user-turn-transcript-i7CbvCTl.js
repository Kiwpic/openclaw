...
import { O as resolveProviderReasoningOutputModeWithPlugin } from "./provider-runtime-oCQkMgyo.js";
...
async function persistUserTurnTranscript(params) {
	...
	if (!message) return;
	const { resolveSessionTranscriptFile } = await import("./transcript-Pd60VgmC.js");
