...
import { b as resolveGroupSessionKey, d as updateSessionStore } from "./store-DzYHq4iO.js";
...
import { h as isCliProvider, u as resolvePersistedOverrideModelRef } from "./model-selection-Dz9iVzmE.js";
import { i as isMissingProviderAuthError } from "./model-auth-runtime-shared-ZF0jyHxm.js";
import "./model-auth-DpNqptyV.js";
import { _ as isRateLimitErrorMessage, d as sanitizeUserFacingText, h as isOverloadedErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, m as isBillingErrorMessage, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DMfgKfRY.js";
...
import { f as logSessionTurnCreated } from "./diagnostic-BtIx0uw8.js";
...
import { f as isCompactionFailureError, p as isContextOverflowError, v as isLikelyContextOverflowError, x as isTransientHttpError } from "./errors-Ccbyhi_E.js";
import { o as isFailoverError } from "./failover-error-_eAyLqsc.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-D-VMfpYI.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-D7t6OqMj.js";
import { d as stripHeartbeatToken } from "./heartbeat-CicGJ6Bb.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-BHZuC4xd.js";
import "./embedded-agent-helpers-G3j0fJ4G.js";
import { d as parseReplyDirectives } from "./payloads-CzWGlJOf.js";
import { f as LiveSessionModelSwitchError, o as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DwaMlvP2.js";
import { n as clearCliSession, r as getCliSessionBinding } from "./cli-session-BRIQqAiH.js";
...
import { a as resolveCurrentTurnImages, i as isReplyProfilerEnabled, o as resolveSilentReplyPolicy } from "./effective-reply-route-DQ42Lqu5.js";
import { r as formatAuthProfileFailureMessage, t as runEmbeddedAgent } from "./embedded-agent-By5cyB3q.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-DgRYrSu-.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-HbqgqRIJ.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-B7Vm1c1G.js";
import { n as runCliAgent } from "./cli-runner-CBkl-ul0.js";
...
async function runCliAgentWithLifecycle(params) {
	...
	try {
		const rawResult = await runCliAgent({
			...params.runParams,
			classifyCommentaryText: params.runParams.classifyCommentaryText ?? Boolean(params.onCommentaryText),
				...
				if (isCliProvider(cliExecutionProvider, runtimeConfig)) {
					...
					const result = await agentTurnTiming.measure("cli_run", () => runCliAgentWithLifecycle({
						...
						runParams: {
							...
							provider: cliExecutionProvider,
							model,
							classifyCommentaryText: params.opts?.commentaryProgressEnabled !== void 0,
							thinkLevel: params.followupRun.run.thinkLevel,
...
//#endregion
export { resolveRunAfterAutoFallbackPrimaryProbeRecheck as a, normalizeReplyPayloadDirectives as c, readCompactionHookMessages as d, shouldNotifyUserAboutCompaction as f, runCliAgentWithLifecycle as h, buildPreflightCompactionFailureText as i, createCompactionHookNoticePayload as l, keepCliSessionBindingOnlyWhenReused as m, resolveReplyTurnKind as n, resolveSessionRuntimeOverrideForProvider as o, clearDroppedCliSessionBinding as p, buildKnownAgentRunFailureReplyPayload as r, runAgentTurnWithFallback as s, admitReplyTurn as t, createCompactionNoticePayload as u };
