...
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-BD-DE_39.js");
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-BYmThkHp.js");
const loadHealthCheckRegistryModule = async () => await import("./health-check-registry-D4TYIWd8.js");
const loadModelCatalogModule = async () => await import("./model-catalog-DGRb8Y-3.js");
const loadModelSelectionModule = async () => await import("./model-selection-CwuSqmPu.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores, maybeRepairCanonicalApiKeyFieldAlias } = await import("./doctor-auth-flat-profiles-BKaU-EJ_.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-BpAiIMCe.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-DLrJr0xG.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-B6CEMD6Z.js");
	const { buildGatewayConnectionDetails } = await import("./call-D4Oi2dnm.js");
	const { note } = await loadNoteModule();
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-BYlvDsTP.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-DBUaJ2af.js");
	const { note } = await loadNoteModule();
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	if (!ctx.prompter.shouldRepair) return;
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-BKfpJZkn.js");
	const { note } = await loadNoteModule();
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-DlE0s_94.js");
	const { note } = await loadNoteModule();
...
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./doctor-cron-jJIjSsMO.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-YImDrXBV.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-BnlNa0NY.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-C_Z4tDb3.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-DH3bklLd.js");
	const { noteSecurityWarnings } = await import("./doctor-security-BQe599L1.js");
...
async function runToolResultCapHealth(ctx) {
	...
	const { buildToolResultCapDoctorAdvice } = await import("./doctor-tool-result-cap-advice-D7UnU7PD.js");
	const { note } = await loadNoteModule();
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-C-8IUI4S.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	if (ctx.cfg.gateway?.mode !== "remote") try {
		const { gatherDaemonStatus } = await import("./status.gather-DeYcdw7F.js");
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-E3iLcl-I.js");
	noteWorkspaceStatus(ctx.cfg, { pluginVersionDrift });
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-B0gvEnog.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-DiLycKDc.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-BRtkAARo.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-C79JlKjG.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-BB_3aL_D.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-CNG84JDU.js");
...
async function runWriteConfigHealth(ctx) {
	...
	const { logConfigUpdated } = await import("./logging-CZ3Wcvjp.js");
