...
import type { UnifiedModelCatalogEntry, UnifiedModelCatalogKind } from "@openclaw/model-catalog-core/model-catalog-types";
 ...
 */
export type ProviderResolvedUsageAuth = ProviderUsageAuthToken | {
    handled: true;
};
/**
 ...
 */
export declare const AGENT_PROMPT_SURFACE_KINDS: readonly ["openclaw_main", 
/** @deprecated Use openclaw_main. */
"pi_main", "codex_app_server", "cli_backend", "acp_backend", "subagent"];
