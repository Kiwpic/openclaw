...
import { i as createChatChannelPlugin } from "./core-BhIxMyLt.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-D597g2To.js";
import "./channel-api-_pvHxxap.js";
import { t as parseDiscordTarget } from "./target-parsing-CxulEx_f.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-V49rp2Jt.js";
...
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-CSy6JHjc.js";
import { t as getDiscordApprovalCapability } from "./approval-native--GG1-US5.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-SkumqA6Z.js";
import { t as discordMessageActions$1 } from "./channel-actions-DGE483DV.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-LwFFXgXY.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-w9FeaeRD.js";
import { n as discordOutbound } from "./outbound-adapter-BOVTIYgT.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-B3ZZ9X-P.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-DJm_8Zc4.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-U7rngrqv.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-0ZqVMq_W.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-PaL_QcuU.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-DXnwvKAm.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CFt1s8Nn.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-Vw8XyFmS.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BcSoyV6v.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-6aRE_mau.js");
