import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-DUhtREkw.js";
import { r as loadCrestodianOverview } from "./overview--xHRbW35.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CJS39U3H.js")).planCrestodianCommand)({
		input,
		overview
	});
