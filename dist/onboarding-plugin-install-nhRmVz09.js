...
import { a as installPluginFromNpmSpec, i as installPluginFromNpmPackArchive } from "./install-DOM4e7pX.js";
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-DyjUzIsF.js";
...
async function installPluginFromClawHubSpecWithProgress(params) {
	...
	try {
		const { installPluginFromClawHub } = await import("./clawhub-C4PjMZSa.js");
