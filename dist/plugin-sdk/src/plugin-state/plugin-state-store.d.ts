...
export { closePluginStateDatabase, closePluginStateSqliteStore, countPluginStateLiveEntries, isPluginStateDatabaseOpen, MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, probePluginStateStore, setMaxPluginStateEntriesPerPluginForTests, sweepExpiredPluginStateEntries, } from "./plugin-state-store.sqlite.js";
