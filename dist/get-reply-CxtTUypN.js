...
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CYLb0UbD.js";
...
import { d as normalizeElevatedLevel, f as normalizeReasoningLevel, g as normalizeVerboseLevel, m as normalizeTraceLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels, u as isSessionDefaultDirectiveValue } from "./thinking-lR114wAI.js";
...
import { D as resolveMaintenanceConfigFromInput, V as resolveSessionStoreEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-Dck9nI8T.js";
...
import { b as resolveGroupSessionKey, d as updateSessionStore, g as deriveSessionMetaPatch } from "./store-DzYHq4iO.js";
...
import { a as hasTerminalMainSessionTranscriptNewerThanRegistry, c as resolveSessionLifecycleTimestamps } from "./sessions-COdZNDyn.js";
...
import { d as resolveAndPersistSessionFile } from "./transcript-CNbfynAP.js";
import { y as resolveModelRefFromString } from "./model-selection-shared-BS5V4jxN.js";
...
import { r as normalizeCommandBody } from "./commands-registry-normalize-B4jUxmCy.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-DbuDKGYT.js";
import { t as hasControlCommand } from "./command-detection-BD-CcDHK.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-D_CFr9uJ.js";
...
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-DRcO14pX.js";
...
import { a as resolvePersistedUserTurnText, n as buildPersistedUserTurnMediaInputsFromFields, o as isReasoningTagProvider, r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-i7CbvCTl.js";
import { u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-Bf36JLIh.js";
import "./agent-bundle-mcp-tools-issXSg8w.js";
import { x as normalizeExecTarget } from "./exec-approvals-BFMHE7LP.js";
import "./delivery-context-DNxwKU0n.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun } from "./subagent-spawn-plan-zRIg7Qcw.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { d as extractQueueDirective, f as skipDirectiveArgPrefix, p as takeDirectiveToken, t as resolveQueueSettings } from "./queue-Rmgc_0-w.js";
...
import { r as getCliSessionBinding } from "./cli-session-BRIQqAiH.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DoZIz4Wl.js";
...
import { a as resolveCurrentTurnImages, r as createReplyTimingTracker, s as resolveSilentReplySettings, t as isSystemEventProvider } from "./effective-reply-route-DQ42Lqu5.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-WwwKNKFP.js";
...
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-BNb49gLz.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CZRiumop.js";
...
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-Bh30-A02.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-DPNzNoLr.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-Dhjbn_VO.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-tSDOZ3iw.js";
...
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-Bb8S2H7i.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DHgPtGLW.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-CfCyVUKL.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DLjk7Iua.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-ZWWDGCKa.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-DAvV-hUQ.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-Diqj7Gf3.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-CdSnLqhW.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-DNfBxDb9.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-Bk-DWmbs.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-x_DHiPAU.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-ot-DRj_a.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-COBGTfMM.js");
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { applySessionStoreEntryPatch } = await import("./sessions-EuU7R-K3.js");
