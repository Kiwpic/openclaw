...
}): Promise<import("@openclaw/agent-core").AgentMessage[] | null | undefined>;
...
}): Promise<import("./types.js").ProviderResolvedUsageAuth | undefined>;
...
export declare function classifyProviderFailoverReasonWithPlugin(params: {
    ...
    env?: NodeJS.ProcessEnv;
    context: ProviderFailoverErrorContext;
}): import("../agents/embedded-agent-helpers.ts").FailoverReason | undefined;
