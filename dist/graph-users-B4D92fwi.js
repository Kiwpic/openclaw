...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-BNG1g0td.js";
...
async function loadSdkModules() {
	sdkAppPromise ??= Promise.all([import("./dist-DigJm-Hw.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BWKvYkUt.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
		App: apps.App,
