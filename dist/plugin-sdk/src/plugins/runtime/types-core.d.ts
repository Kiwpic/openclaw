...
type RuntimeRunEmbeddedAgent = (params: import("../../agents/embedded-agent-runner/run/params.js").RunEmbeddedAgentParams) => Promise<import("../../agents/embedded-agent-runner/types.js").EmbeddedAgentRunResult>;
...
export type PluginRuntimeCore = {
    ...
    state: {
        ...
        openSyncKeyedStore: <T>(options: import("../../plugin-state/plugin-state-store.types.js").OpenKeyedStoreOptions) => import("../../plugin-state/plugin-state-store.types.js").PluginStateSyncKeyedStore<T>;
        openChannelIngressQueue: <TPayload, TMetadata = unknown, TCompletedMetadata = unknown>(options?: Omit<import("../../channels/message/ingress-queue.js").CreateChannelIngressQueueOptions, "channelId">) => import("../../channels/message/ingress-queue.js").ChannelIngressQueue<TPayload, TMetadata, TCompletedMetadata>;
    };
    tasks: {
