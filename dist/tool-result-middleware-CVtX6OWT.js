...
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-C7AtTsg4.js";
import { o as normalizeProviderId } from "./model-selection-normalize-DhdmnkKq.js";
import "./model-selection-Dz9iVzmE.js";
import { gt as generateSummary$1 } from "./sessions-Bn7snuGC.js";
import { a as buildStageSplitPlan, i as buildOversizedFallbackPlan, l as sanitizeCompactionMessages, o as buildSummaryChunks, r as buildHistoryPrunePlan, s as computeAdaptiveChunkRatio } from "./compaction-planning-eGyg6UK_.js";
import { c as isTimeoutError } from "./failover-error-_eAyLqsc.js";
import { n as retryAsync } from "./retry-BSIArBBz.js";
import { f as isGoogleModelApi } from "./embedded-agent-helpers-G3j0fJ4G.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-De_qPheH.js");
