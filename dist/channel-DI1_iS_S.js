...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-BhIxMyLt.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BVQy3Hdg.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-Dsbe7C0q.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-DGmM3dk9.js";
import { n as createFeishuSendReceipt } from "./send-result-DILmTuaa.js";
...
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-gRQV2j8m.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-C6Xyc4fh.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BZ_kSof8.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-B13YjCV0.js");
